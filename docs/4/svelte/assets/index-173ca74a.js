...
"${e}" should be "${e.replace(/#.*$/,"#")}".`),Sb(e)}function xb(e){return typeof e=="string"||e&&typeof e=="object"}function om(e){return typeof e=="string"||typeof e=="symbol"}const wn={path:"/",name:void 0,params:{},query:{},hash:"",fullPath:"/",matched:[],meta:{},redirectedFrom:void 0},im=Symbol("navigation failure");var lu;(function(e){e[e.aborted=4]="aborted",e[e.cancelled=8]="cancelled",e[e.duplicated=16]="duplicated"})(lu||(lu={}));const kb={[1]({location:e,currentLocation:t}){return`No match for
 ${JSON.stringify(e)}${t?`
while being at
`+JSON.stringify(t):""}`},[2]({from:e,to:t}){return`Redirected from "${e.fullPath}" to "${zb(t)}" via a navigation guard.`},[4]({from:e,to:t}){return`Navigation aborted from "${e.fullPath}" to "${t.fullPath}" via a navigation guard.`},[8]({from:e,to:t}){return`Navigation cancelled from "${e.fullPath}" to "${t.fullPath}" with a new navigation.`},[16]({from:e,to:t}){return`Avoided redundant navigation to current location: "${e.fullPath}".`}};function Ro(e,t){return Ke(new Error(kb[e](t)),{type:e,[im]:!0},t)}function rn(e,t){return e instanceof Error&&im in e&&(t==null||!!(e.type&t))}const $b=["params","query","hash"];function zb(e){if(typeof e=="string")return e;if("path"in e)return e.path;const t={};for(const n of $b)n in e&&(t[n]=e[n]);return JSON.stringify(t,null,2)}const ru="[^/]+?",Ib={sensitive:!1,strict:!1,start:!0,end:!0},Cb=/[.+*?^${}()[\]/\\]/g;function Tb(e,t){const n=Ke({},Ib,t),i=[];let s=n.start?"^":"";const a=[];for(const d of e){const p=d.length?[]:[90];n.strict&&!d.length&&(s+="/");for(let m=0;m<d.length;m++){const f=d[m];let h=40+(n.sensitive?.25:0);if(f.type===0)m||(s+="/"),s+=f.value.replace(Cb,"\\$&"),h+=40;else if(f.type===1){const{value:v,repeatable:S,optional:x,regexp:k}=f;a.push({name:v,repeatable:S,optional:x});const C=k||ru;if(C!==ru){h+=10;try{new RegExp(`(${C})`)}catch(K){throw new Error(`Invalid custom RegExp for param "${v}" (${C}): `+K.message)}}let b=S?`((?:${C})(?:/(?:${C}))*)`:`(${C})`;m||(b=x&&d.length<2?`(?:/${b})`:"/"+b),x&&(b+="?"),s+=b,h+=20,x&&(h+=-8),S&&(h+=-20),C===".*"&&(h+=-50)}p.push(h)}i.push(p)}if(n.strict&&n.end){const d=i.length-1;i[d][i[d].length-1]+=.7000000000000001}n.strict||(s+="/?"),n.end?s+="$":n.strict&&(s+="(?:/|$)");const l=new RegExp(s,n.sensitive?"":"i");function r(d){const p=d.match(l),m={};if(!p)return null;for(let f=1;f<p.length;f++){const h=p[f]||"",v=a[f-1];m[v.name]=h&&v.repeatable?h.split("/"):h}return m}function u(d){let p="",m=!1;for(const f of e){(!m||!p.endsWith("/"))&&(p+="/"),m=!1;for(const h of f)if(h.type===0)p+=h.value;else if(h.type===1){const{value:v,repeatable:S,optional:x}=h,k=v in d?d[v]:"";if(Tt(k)&&!S)throw new Error(`Provided param "${v}" is an array but it is not repeatable (* or + modifiers)`);const C=Tt(k)?k.join("/"):k;if(!C)if(x)f.length<2&&(p.endsWith("/")?p=p.slice(0,-1):m=!0);else throw new Error(`Missing required param "${v}"`);p+=C}}return p||"/"}return{re:l,score:i,keys:a,parse:r,stringify:u}}function Eb(e,t){let n=0;for(;n<e.length&&n<t.length;){const i=t[n]-e[n];if(i)return i;n++}return e.length<t.length?e.length===1&&e[0]===40+40?-1:1:e.length>t.length?t.length===1&&t[0]===40+40?1:-1:0}function Ob(e,t){let n=0;const i=e.score,s=t.score;for(;n<i.length&&n<s.length;){const a=Eb(i[n],s[n]);if(a)return a;n++}if(Math.abs(s.length-i.length)===1){if(cu(i))return 1;if(cu(s))return-1}return s.length-i.length}function cu(e){const t=e[e.length-1];return e.length>0&&t[t.length-1]<0}const Mb={type:0,value:""},Ab=/[a-zA-Z0-9_]/;function Pb(e){if(!e)return[[]];if(e==="/")return[[Mb]];if(!e.startsWith("/"))throw new Error(`Route paths should start with a "/": "${e}" should be "/${e}".`);function t(h){throw new Error(`ERR (${n})/"${d}": ${h}`)}let n=0,i=n;const s=[];let a;function l(){a&&s.push(a),a=[]}let r=0,u,d="",p="";function m(){d&&(n===0?a.push({type:0,value:d}):n===1||n===2||n===3?(a.length>1&&(u==="*"||u==="+")&&t(`A repeatable param (${d}) must be alone in its segment. eg: '/:ids+.`),a.push({type:1,value:d,regexp:p,repeatable:u==="*"||u==="+",optional:u==="*"||u==="?"})):t("Invalid state to consume buffer"),d="")}function f(){d+=u}for(;r<e.length;){if(u=e[r++],u==="\\"&&n!==2){i=n,n=4;continue}switch(n){case 0:u==="/"?(d&&m(),l()):u===":"?(m(),n=1):f();break;case 4:f(),n=i;break;case 1:u==="("?n=2:Ab.test(u)?f():(m(),n=0,u!=="*"&&u!=="?"&&u!=="+"&&r--);break;case 2:u===")"?p[p.length-1]=="\\"?p=p.slice(0,-1)+u:n=3:p+=u;break;case 3:m(),n=0,u!=="*"&&u!=="?"&&u!=="+"&&r--,p="";break;default:t("Unknown state");break}}return n===2&&t(`Unfinished custom RegExp for param "${d}"`),m(),l(),s}function Kb(e,t,n){const i=Tb(Pb(e.path),n);{const a=new Set;for(const l of i.keys)a.has(l.name)&&Te(`Found duplicated params with name "${l.name}" for path "${e.path}". Only the last one will be available on "$route.params".`),a.add(l.name)}const s=Ke(i,{record:e,parent:t,children:[],alias:[]});return t&&!s.record.aliasOf==!t.record.aliasOf&&t.children.push(s),s}function Lb(e,t){const n=[],i=new Map;t=pu({strict:!1,end:!0,sensitive:!1},t);function s(p){return i.get(p)}function a(p,m,f){const h=!f,v=Rb(p);Db(v,m),v.aliasOf=f&&f.record;const S=pu(t,p),x=[v];if("alias"in p){const b=typeof p.alias=="string"?[p.alias]:p.alias;for(const K of b)x.push(Ke({},v,{components:f?f.record.components:v.components,path:K,aliasOf:f?f.record:v}))}let k,C;for(const b of x){const{path:K}=b;if(m&&K[0]!=="/"){const A=m.record.path,R=A[A.length-1]==="/"?"":"/";b.path=m.record.path+(K&&R+K)}if(b.path==="*")throw new Error(`Catch all routes ("*") must now be defined using a param with a custom regexp.
See more at https://next.router.vuejs.org/guide/migration/#removed-star-or-catch-all-routes.`);if(k=Kb(b,m,S),m&&K[0]==="/"&&qb(k,m),f?(f.alias.push(k),Nb(f,k)):(C=C||k,C!==k&&C.alias.push(k),h&&p.name&&!du(k)&&l(p.name)),v.children){const A=v.children;for(let R=0;R<A.length;R++)a(A[R],k,f&&f.children[R])}f=f||k,(k.record.components&&Object.keys(k.record.components).length||k.record.name||k.record.redirect)&&u(k)}return C?()=>{l(C)}:hi}function l(p){if(om(p)){const m=i.get(p);m&&(i.delete(p),n.splice(n.indexOf(m),1),m.children.forEach(l),m.alias.forEach(l))}else{const m=n.indexOf(p);m>-1&&(n.splice(m,1),p.record.name&&i.delete(p.record.name),p.children.forEach(l),p.alias.forEach(l))}}function r(){return n}function u(p){let m=0;for(;m<n.length&&Ob(p,n[m])>=0&&(p.record.path!==n[m].record.path||!sm(p,n[m]));)m++;n.splice(m,0,p),p.record.name&&!du(p)&&i.set(p.record.name,p)}function d(p,m){let f,h={},v,S;if("name"in p&&p.name){if(f=i.get(p.name),!f)throw Ro(1,{location:p});{const C=Object.keys(p.params||{}).filter(b=>!f.keys.find(K=>K.name===b));C.length&&Te(`Discarded invalid param(s) "${C.join('", "')}" when navigating. See https://github.com/vuejs/router/blob/main/packages/router/CHANGELOG.md#414-2022-08-22 for more details.`)}S=f.record.name,h=Ke(uu(m.params,f.keys.filter(C=>!C.optional).map(C=>C.name)),p.params&&uu(p.params,f.keys.map(C=>C.name))),v=f.stringify(h)}else if("path"in p)v=p.path,v.startsWith("/")||Te(`The Matcher cannot resolve relative paths but received "${v}". Unless you directly called \`matcher.resolve("${v}")\`, this is probably a bug in vue-router. Please open an issue at https://new-issue.vuejs.org/?repo=vuejs/router.`),f=n.find(C=>C.re.test(v)),f&&(h=f.parse(v),S=f.record.name);else{if(f=m.name?i.get(m.name):n.find(C=>C.re.test(m.path)),!f)throw Ro(1,{location:p,currentLocation:m});S=f.record.name,h=Ke({},m.params,p.params),v=f.stringify(h)}const x=[];let k=f;for(;k;)x.unshift(k.record),k=k.parent;return{name:S,path:v,params:h,matched:x,meta:Wb(x)}}return e.forEach(p=>a(p)),{addRoute:a,resolve:d,removeRoute:l,getRoutes:r,getRecordMatcher:s}}function uu(e,t){const n={};for(const i of t)i in e&&(n[i]=e[i]);return n}function Rb(e){return{path:e.path,redirect:e.redirect,name:e.name,meta:e.meta||{},aliasOf:void 0,beforeEnter:e.beforeEnter,props:Hb(e),children:e.children||[],instances:{},leaveGuards:new Set,updateGuards:new Set,enterCallbacks:{},components:"components"in e?e.components||null:e.component&&{default:e.component}}}function Hb(e){const t={},n=e.props||!1;if("component"in e)t.default=n;else for(const i in e.components)t[i]=typeof n=="boolean"?n:n[i];return t}function du(e){for(;e;){if(e.record.aliasOf)return!0;e=e.parent}return!1}function Wb(e){return e.reduce((t,n)=>Ke(t,n.meta),{})}function pu(e,t){const n={};for(const i in e)n[i]=i in t?t[i]:e[i];return n}function kl(e,t){return e.name===t.name&&e.optional===t.optional&&e.repeatable===t.repeatable}function Nb(e,t){for(const n of e.keys)if(!n.optional&&!t.keys.find(kl.bind(null,n)))return Te(`Alias "${t.record.path}" and the original record: "${e.record.path}" must have the exact same param named "${n.name}"`);for(const n of t.keys)if(!n.optional&&!e.keys.find(kl.bind(null,n)))return Te(`Alias "${t.record.path}" and the original record: "${e.record.path}" must have the exact same param named "${n.name}"`)}function Db(e,t){t&&t.record.name&&!e.name&&!e.path&&Te(`The route named "${String(t.record.name)}" has a child without a name and an empty path. Using that name won't render the empty path child so you probably want to move the name to the child instead. If this is intentional, add a name to the child route to remove the warning.`)}function qb(e,t){for(const n of t.keys)if(!e.keys.find(kl.bind(null,n)))return Te(`Absolute path "${e.record.path}" must have the exact same param named "${n.name}" as its parent "${t.record.path}".`)}function sm(e,t){return t.children.some(n=>n===e||sm(e,n))}const am=/#/g,Fb=/&/g,jb=/\//g,Vb=/=/g,Bb=/\?/g,lm=/\+/g,Ub=/%5B/g,Jb=/%5D/g,rm=/%5E/g,Qb=/%60/g,cm=/%7B/g,Yb=/%7C/g,um=/%7D/g,Zb=/%20/g;function kr(e){return encodeURI(""+e).replace(Yb,"|").replace(Ub,"[").replace(Jb,"]")}function Gb(e){return kr(e).replace(cm,"{").replace(um,"}").replace(rm,"^")}function $l(e){return kr(e).replace(lm,"%2B").replace(Zb,"+").replace(am,"%23").replace(Fb,"%26").replace(Qb,"`").replace(cm,"{").replace(um,"}").replace(rm,"^")}function Xb(e){return $l(e).replace(Vb,"%3D")}function ey(e){return kr(e).replace(am,"%23").replace(Bb,"%3F")}function ty(e){return e==null?"":ey(e).replace(jb,"%2F")}function Oi(e){try{return decodeURIComponent(""+e)}catch{Te(`Error decoding "${e}". Using original value`)}return""+e}function ny(e){const t={};if(e===""||e==="?")return t;const i=(e[0]==="?"?e.slice(1):e).split("&");for(let s=0;s<i.length;++s){const a=i[s].replace(lm," "),l=a.indexOf("="),r=Oi(l<0?a:a.slice(0,l)),u=l<0?null:Oi(a.slice(l+1));if(r in t){let d=t[r];Tt(d)||(d=t[r]=[d]),d.push(u)}else t[r]=u}return t}function mu(e){let t="";for(let n in e){const i=e[n];if(n=Xb(n),i==null){i!==void 0&&(t+=(t.length?"&":"")+n);continue}(Tt(i)?i.map(a=>a&&$l(a)):[i&&$l(i)]).forEach(a=>{a!==void 0&&(t+=(t.length?"&":"")+n,a!=null&&(t+="="+a))})}return t}function oy(e){const t={};for(const n in e){const i=e[n];i!==void 0&&(t[n]=Tt(i)?i.map(s=>s==null?null:""+s):i==null?i:""+i)}return t}const iy=Symbol("router view location matched"),fu=Symbol("router view depth"),$r=Symbol("router"),dm=Symbol("route location"),zl=Symbol("router view location");function Zo(){let e=[];function t(i){return e.push(i),()=>{const s=e.indexOf(i);s>-1&&e.splice(s,1)}}function n(){e=[]}return{add:t,list:()=>e,reset:n}}function zn(e,t,n,i,s){const a=i&&(i.enterCallbacks[s]=i.enterCallbacks[s]||[]);return()=>new Promise((l,r)=>{const u=m=>{m===!1?r(Ro(4,{from:n,to:t})):m instanceof Error?r(m):xb(m)?r(Ro(2,{from:t,to:m})):(a&&i.enterCallbacks[s]===a&&typeof m=="function"&&a.push(m),l())},d=e.call(i&&i.instances[s],t,n,sy(u,t,n));let p=Promise.resolve(d);if(e.length<3&&(p=p.then(u)),e.length>2){const m=`The "next" callback was never called inside of ${e.name?'"'+e.name+'"':""}:
${e.toString()}
. If you are returning a value instead of calling "next", make sure to remove the "next" parameter from your function.`;if(typeof d=="object"&&"then"in d)p=p.then(f=>u._called?f:(Te(m),Promise.reject(new Error("Invalid navigation guard"))));else if(d!==void 0&&!u._called){Te(m),r(new Error("Invalid navigation guard"));return}}p.catch(m=>r(m))})}function sy(e,t,n){let i=0;return function(){i++===1&&Te(`The "next" callback was called more than once in one navigation guard when going from "${n.fullPath}" to "${t.fullPath}". It should be called exactly one time in each navigation guard. This will fail in production.`),e._called=!0,i===1&&e.apply(null,arguments)}}function Aa(e,t,n,i){const s=[];for(const a of e){!a.components&&!a.children.length&&Te(`Record with path "${a.path}" is either missing a "component(s)" or "children" property.`);for(const l in a.components){let r=a.components[l];{if(!r||typeof r!="object"&&typeof r!="function")throw Te(`Component "${l}" in record with path "${a.path}" is not a valid component. Received "${String(r)}".`),new Error("Invalid route component");if("then"in r){Te(`Component "${l}" in record with path "${a.path}" is a Promise instead of a function that returns a Promise. Did you write "import('./MyPage.vue')" instead of "() => import('./MyPage.vue')" ? This will break in production if not fixed.`);const u=r;r=()=>u}else r.__asyncLoader&&!r.__warnedDefineAsync&&(r.__warnedDefineAsync=!0,Te(`Component "${l}" in record with path "${a.path}" is defined using "defineAsyncComponent()". Write "() => import('./MyPage.vue')" instead of "defineAsyncComponent(() => import('./MyPage.vue'))".`))}if(!(t!=="beforeRouteEnter"&&!a.instances[l]))if(ay(r)){const d=(r.__vccOpts||r)[t];d&&s.push(zn(d,n,i,a,l))}else{let u=r();"catch"in u||(Te(`Component "${l}" in record with path "${a.path}" is a function that does not return a Promise. If you were passing a functional component, make sure to add a "displayName" to the component. This will break in production if not fixed.`),u=Promise.resolve(u)),s.push(()=>u.then(d=>{if(!d)return Promise.reject(new Error(`Couldn't resolve component "${l}" at "${a.path}"`));const p=sb(d)?d.default:d;a.components[l]=p;const f=(p.__vccOpts||p)[t];return f&&zn(f,n,i,a,l)()}))}}}return s}function ay(e){return typeof e=="object"||"displayName"in e||"props"in e||"__vccOpts"in e}function hu(e){const t=$($r),n=$(dm),i=N(()=>t.resolve(L(e.to))),s=N(()=>{const{matched:u}=i.value,{length:d}=u,p=u[d-1],m=n.matched;if(!p||!m.length)return-1;const f=m.findIndex(Nn.bind(null,p));if(f>-1)return f;const h=vu(u[d-2]);return d>1&&vu(p)===h&&m[m.length-1].path!==h?m.findIndex(Nn.bind(null,u[d-2])):f}),a=N(()=>s.value>-1&&uy(n.params,i.value.params)),l=N(()=>s.value>-1&&s.value===n.matched.length-1&&tm(n.params,i.value.params));function r(u={}){return cy(u)?t[L(e.replace)?"replace":"push"](L(e.to)).catch(hi):Promise.resolve()}if(mn){const u=wt();if(u){const d={route:i.value,isActive:a.value,isExactActive:l.value};u.__vrl_devtools=u.__vrl_devtools||[],u.__vrl_devtools.push(d),yo(()=>{d.route=i.value,d.isActive=a.value,d.isExactActive=l.value},{flush:"post"})}}return{route:i,href:N(()=>i.value.href),isActive:a,isExactActive:l,navigate:r}}const ly=Pe({name:"RouterLink",compatConfig:{MODE:3},props:{to:{type:[String,Object],required:!0},replace:Boolean,activeClass:String,exactActiveClass:String,custom:Boolean,ariaCurrentValue:{type:String,default:"page"}},useLink:hu,setup(e,{slots:t}){const n=je(hu(e)),{options:i}=$($r),s=N(()=>({[_u(e.activeClass,i.linkActiveClass,"router-link-active")]:n.isActive,[_u(e.exactActiveClass,i.linkExactActiveClass,"router-link-exact-active")]:n.isExactActive}));return()=>{const a=t.default&&t.default(n);return e.custom?a:St("a",{"aria-current":n.isExactActive?e.ariaCurrentValue:null,href:n.href,onClick:n.navigate,class:s.value},a)}}}),ry=ly;function cy(e){if(!(e.metaKey||e.altKey||e.ctrlKey||e.shiftKey)&&!e.defaultPrevented&&!(e.button!==void 0&&e.button!==0)){if(e.currentTarget&&e.currentTarget.getAttribute){const t=e.currentTarget.getAttribute("target");if(/\b_blank\b/i.test(t))return}return e.preventDefault&&e.preventDefault(),!0}}function uy(e,t){for(const n in t){const i=t[n],s=e[n];if(typeof i=="string"){if(i!==s)return!1}else if(!Tt(s)||s.length!==i.length||i.some((a,l)=>a!==s[l]))return!1}return!0}function vu(e){return e?e.aliasOf?e.aliasOf.path:e.path:""}const _u=(e,t,n)=>e??t??n,dy=Pe({name:"RouterView",inheritAttrs:!1,props:{name:{type:String,default:"default"},route:Object},compatConfig:{MODE:3},setup(e,{attrs:t,slots:n}){my();const i=$(zl),s=N(()=>e.route||i.value),a=$(fu,0),l=N(()=>{let d=L(a);const{matched:p}=s.value;let m;for(;(m=p[d])&&!m.components;)d++;return d}),r=N(()=>s.value.matched[l.value]);zt(fu,N(()=>l.value+1)),zt(iy,r),zt(zl,s);const u=Z();return ge(()=>[u.value,r.value,e.name],([d,p,m],[f,h,v])=>{p&&(p.instances[m]=d,h&&h!==p&&d&&d===f&&(p.leaveGuards.size||(p.leaveGuards=h.leaveGuards),p.updateGuards.size||(p.updateGuards=h.updateGuards))),d&&p&&(!h||!Nn(p,h)||!f)&&(p.enterCallbacks[m]||[]).forEach(S=>S(d))},{flush:"post"}),()=>{const d=s.value,p=e.name,m=r.value,f=m&&m.components[p];if(!f)return gu(n.default,{Component:f,route:d});const h=m.props[p],v=h?h===!0?d.params:typeof h=="function"?h(d):h:null,x=St(f,Ke({},v,t,{onVnodeUnmounted:k=>{k.component.isUnmounted&&(m.instances[p]=null)},ref:u}));if(mn&&x.ref){const k={depth:l.value,name:m.name,path:m.path,meta:m.meta};(Tt(x.ref)?x.ref.map(b=>b.i):[x.ref.i]).forEach(b=>{b.__vrv_devtools=k})}return gu(n.default,{Component:x,route:d})||x}}});function gu(e,t){if(!e)return null;const n=e(t);return n.length===1?n[0]:n}const py=dy;function my(){const e=wt(),t=e.parent&&e.parent.type.name,n=e.parent&&e.parent.subTree&&e.parent.subTree.type;if(t&&(t==="KeepAlive"||t.includes("Transition"))&&typeof n=="object"&&n.name==="RouterView"){const i=t==="KeepAlive"?"keep-alive":"transition";Te(`<router-view> can no longer be used directly inside <transition> or <keep-alive>.
...
</router-view>`)}}function Go(e,t){const n=Ke({},e,{matched:e.matched.map(i=>wy(i,["instances","children","aliasOf"]))});return{_custom:{type:null,readOnly:!0,display:e.fullPath,tooltip:t,value:n}}}function us(e){return{_custom:{display:e}}}let fy=0;function hy(e,t,n){if(t.__hasDevtools)return;t.__hasDevtools=!0;const i=fy++;ib({id:"org.vuejs.router"+(i?"."+i:""),label:"Vue Router",packageName:"vue-router",homepage:"https://router.vuejs.org",logo:"https://router.vuejs.org/logo.png",componentStateTypes:["Routing"],app:e},s=>{typeof s.now!="function"&&console.warn("[Vue Router]: You seem to be using an outdated version of Vue Devtools. Are you still using the Beta release instead of the stable one? You can find the links at https://devtools.vuejs.org/guide/installation.html."),s.on.inspectComponent((p,m)=>{p.instanceData&&p.instanceData.state.push({type:"Routing",key:"$route",editable:!1,value:Go(t.currentRoute.value,"Current Route")})}),s.on.visitComponentTree(({treeNode:p,componentInstance:m})=>{if(m.__vrv_devtools){const f=m.__vrv_devtools;p.tags.push({label:(f.name?`${f.name.toString()}: `:"")+f.path,textColor:0,tooltip:"This component is rendered by &lt;router-view&gt;",backgroundColor:pm})}Tt(m.__vrl_devtools)&&(m.__devtoolsApi=s,m.__vrl_devtools.forEach(f=>{let h=hm,v="";f.isExactActive?(h=fm,v="This is exactly active"):f.isActive&&(h=mm,v="This link is active"),p.tags.push({label:f.route.path,textColor:0,tooltip:v,backgroundColor:h})}))}),ge(t.currentRoute,()=>{u(),s.notifyComponentUpdate(),s.sendInspectorTree(r),s.sendInspectorState(r)});const a="router:navigations:"+i;s.addTimelineLayer({id:a,label:`Router${i?" "+i:""} Navigations`,color:4237508}),t.onError((p,m)=>{s.addTimelineEvent({layerId:a,event:{title:"Error during Navigation",subtitle:m.fullPath,logType:"error",time:s.now(),data:{error:p},groupId:m.meta.__navigationId}})});let l=0;t.beforeEach((p,m)=>{const f={guard:us("beforeEach"),from:Go(m,"Current Location during this navigation"),to:Go(p,"Target location")};Object.defineProperty(p.meta,"__navigationId",{value:l++}),s.addTimelineEvent({layerId:a,event:{time:s.now(),title:"Start of navigation",subtitle:p.fullPath,data:f,groupId:p.meta.__navigationId}})}),t.afterEach((p,m,f)=>{const h={guard:us("afterEach")};f?(h.failure={_custom:{type:Error,readOnly:!0,display:f?f.message:"",tooltip:"Navigation Failure",value:f}},h.status=us("❌")):h.status=us("✅"),h.from=Go(m,"Current Location during this navigation"),h.to=Go(p,"Target location"),s.addTimelineEvent({layerId:a,event:{title:"End of navigation",subtitle:p.fullPath,time:s.now(),data:h,logType:f?"warning":"default",groupId:p.meta.__navigationId}})});const r="router-inspector:"+i;s.addInspector({id:r,label:"Routes"+(i?" "+i:""),icon:"book",treeFilterPlaceholder:"Search routes"});function u(){if(!d)return;const p=d;let m=n.getRoutes().filter(f=>!f.parent);m.forEach(gm),p.filter&&(m=m.filter(f=>Il(f,p.filter.toLowerCase()))),m.forEach(f=>_m(f,t.currentRoute.value)),p.rootNodes=m.map(vm)}let d;s.on.getInspectorTree(p=>{d=p,p.app===e&&p.inspectorId===r&&u()}),s.on.getInspectorState(p=>{if(p.app===e&&p.inspectorId===r){const f=n.getRoutes().find(h=>h.record.__vd_id===p.nodeId);f&&(p.state={options:_y(f)})}}),s.sendInspectorTree(r),s.sendInspectorState(r)})}function vy(e){return e.optional?e.repeatable?"*":"?":e.repeatable?"+":""}function _y(e){const{record:t}=e,n=[{editable:!1,key:"path",value:t.path}];return t.name!=null&&n.push({editable:!1,key:"name",value:t.name}),n.push({editable:!1,key:"regexp",value:e.re}),e.keys.length&&n.push({editable:!1,key:"keys",value:{_custom:{type:null,readOnly:!0,display:e.keys.map(i=>`${i.name}${vy(i)}`).join(" "),tooltip:"Param keys",value:e.keys}}}),t.redirect!=null&&n.push({editable:!1,key:"redirect",value:t.redirect}),e.alias.length&&n.push({editable:!1,key:"aliases",value:e.alias.map(i=>i.record.path)}),Object.keys(e.record.meta).length&&n.push({editable:!1,key:"meta",value:e.record.meta}),n.push({key:"score",editable:!1,value:{_custom:{type:null,readOnly:!0,display:e.score.map(i=>i.join(", ")).join(" | "),tooltip:"Score used to sort routes",value:e.score}}}),n}const pm=15485081,mm=2450411,fm=8702998,gy=2282478,hm=16486972,by=6710886;function vm(e){const t=[],{record:n}=e;n.name!=null&&t.push({label:String(n.name),textColor:0,backgroundColor:gy}),n.aliasOf&&t.push({label:"alias",textColor:0,backgroundColor:hm}),e.__vd_match&&t.push({label:"matches",textColor:0,backgroundColor:pm}),e.__vd_exactActive&&t.push({label:"exact",textColor:0,backgroundColor:fm}),e.__vd_active&&t.push({label:"active",textColor:0,backgroundColor:mm}),n.redirect&&t.push({label:typeof n.redirect=="string"?`redirect: ${n.redirect}`:"redirects",textColor:16777215,backgroundColor:by});let i=n.__vd_id;return i==null&&(i=String(yy++),n.__vd_id=i),{id:i,label:n.path,tags:t,children:e.children.map(vm)}}let yy=0;const Sy=/^\/(.*)\/([a-z]*)$/;function _m(e,t){const n=t.matched.length&&Nn(t.matched[t.matched.length-1],e.record);e.__vd_exactActive=e.__vd_active=n,n||(e.__vd_active=t.matched.some(i=>Nn(i,e.record))),e.children.forEach(i=>_m(i,t))}function gm(e){e.__vd_match=!1,e.children.forEach(gm)}function Il(e,t){const n=String(e.re).match(Sy);if(e.__vd_match=!1,!n||n.length<3)return!1;if(new RegExp(n[1].replace(/\$$/,""),n[2]).test(t))return e.children.forEach(l=>Il(l,t)),e.record.path!=="/"||t==="/"?(e.__vd_match=e.re.test(t),!0):!1;const s=e.record.path.toLowerCase(),a=Oi(s);return!t.startsWith("/")&&(a.includes(t)||s.includes(t))||a.startsWith(t)||s.startsWith(t)||e.record.name&&String(e.record.name).includes(t)?!0:e.children.some(l=>Il(l,t))}function wy(e,t){const n={};for(const i in e)t.includes(i)||(n[i]=e[i]);return n}function xy(e){const t=Lb(e.routes,e),n=e.parseQuery||ny,i=e.stringifyQuery||mu,s=e.history;if(!s)throw new Error('Provide the "history" option when calling "createRouter()": https://next.router.vuejs.org/api/#history.');const a=Zo(),l=Zo(),r=Zo(),u=sn(wn);let d=wn;mn&&e.scrollBehavior&&"scrollRestoration"in history&&(history.scrollRestoration="manual");const p=Oa.bind(null,H=>""+H),m=Oa.bind(null,ty),f=Oa.bind(null,Oi);function h(H,X){let te,oe;return om(H)?(te=t.getRecordMatcher(H),oe=X):oe=H,t.addRoute(oe,te)}function v(H){const X=t.getRecordMatcher(H);X?t.removeRoute(X):Te(`Cannot remove non-existent route "${String(H)}"`)}function S(){return t.getRoutes().map(H=>H.record)}function x(H){return!!t.getRecordMatcher(H)}function k(H,X){if(X=Ke({},X||u.value),typeof H=="string"){const y=Ma(n,H,X.path),P=t.resolve({path:y.path},X),q=s.createHref(y.fullPath);return q.startsWith("//")?Te(`Location "${H}" resolved to "${q}". A resolved location cannot start with multiple slashes.`):P.matched.length||Te(`No match found for location with path "${H}"`),Ke(y,P,{params:f(P.params),hash:Oi(y.hash),redirectedFrom:void 0,href:q})}let te;if("path"in H)"params"in H&&!("name"in H)&&Object.keys(H.params).length&&Te(`Path "${H.path}" was passed with params but they will be ignored. Use a named route alongside params instead.`),te=Ke({},H,{path:Ma(n,H.path,X.path).path});else{const y=Ke({},H.params);for(const P in y)y[P]==null&&delete y[P];te=Ke({},H,{params:m(y)}),X.params=m(X.params)}const oe=t.resolve(te,X),ke=H.hash||"";ke&&!ke.startsWith("#")&&Te(`A \`hash\` should always start with the character "#". Replace "${ke}" with "#${ke}".`),oe.params=p(f(oe.params));const He=rb(i,Ke({},H,{hash:Gb(ke),path:oe.path})),_=s.createHref(He);return _.startsWith("//")?Te(`Location "${H}" resolved to "${_}". A resolved location cannot start with multiple slashes.`):oe.matched.length||Te(`No match found for location with path "${"path"in H?H.path:H}"`),Ke({fullPath:He,hash:ke,query:i===mu?oy(H.query):H.query||{}},oe,{redirectedFrom:void 0,href:_})}function C(H){return typeof H=="string"?Ma(n,H,u.value.path):Ke({},H)}function b(H,X){if(d!==H)return Ro(8,{from:X,to:H})}function K(H){return F(H)}function A(H){return K(Ke(C(H),{replace:!0}))}function R(H){const X=H.matched[H.matched.length-1];if(X&&X.redirect){const{redirect:te}=X;let oe=typeof te=="function"?te(H):te;if(typeof oe=="string"&&(oe=oe.includes("?")||oe.includes("#")?oe=C(oe):{path:oe},oe.params={}),!("path"in oe)&&!("name"in oe))throw Te(`Invalid redirect found:
${JSON.stringify(oe,null,2)}
 when navigating to "${H.fullPath}". A redirect must contain a name or path. This will break in production.`),new Error("Invalid redirect");return Ke({query:H.query,hash:H.hash,params:"path"in oe?{}:H.params},oe)}}function F(H,X){const te=d=k(H),oe=u.value,ke=H.state,He=H.force,_=H.replace===!0,y=R(te);if(y)return F(Ke(C(y),{state:typeof y=="object"?Ke({},ke,y.state):ke,force:He,replace:_}),X||te);const P=te;P.redirectedFrom=X;let q;return!He&&ou(i,oe,te)&&(q=Ro(16,{to:P,from:oe}),Et(oe,oe,!0,!1)),(q?Promise.resolve(q):se(P,oe)).catch(D=>rn(D)?rn(D,2)?D:Le(D):ce(D,P,oe)).then(D=>{if(D){if(rn(D,2))return ou(i,k(D.to),P)&&X&&(X._count=X._count?X._count+1:1)>30?(Te(`Detected a possibly infinite redirection in a navigation guard when going from "${oe.fullPath}" to "${P.fullPath}". Aborting to avoid a Stack Overflow.
 Are you always returning a new location within a navigation guard? That would lead to this error. Only return when redirecting or aborting, that should fix this. This might break in production if not fixed.`),Promise.reject(new Error("Infinite redirect in navigation guard"))):F(Ke({replace:_},C(D.to),{state:typeof D.to=="object"?Ke({},ke,D.to.state):ke,force:He}),X||P)}else D=G(P,oe,!0,_,ke);return de(P,oe,D),D})}function W(H,X){const te=b(H,X);return te?Promise.reject(te):Promise.resolve()}function U(H){const X=Qt.values().next().value;return X&&typeof X.runWithContext=="function"?X.runWithContext(H):H()}function se(H,X){let te;const[oe,ke,He]=ky(H,X);te=Aa(oe.reverse(),"beforeRouteLeave",H,X);for(const y of oe)y.leaveGuards.forEach(P=>{te.push(zn(P,H,X))});const _=W.bind(null,H,X);return te.push(_),Ot(te).then(()=>{te=[];for(const y of a.list())te.push(zn(y,H,X));return te.push(_),Ot(te)}).then(()=>{te=Aa(ke,"beforeRouteUpdate",H,X);for(const y of ke)y.updateGuards.forEach(P=>{te.push(zn(P,H,X))});return te.push(_),Ot(te)}).then(()=>{te=[];for(const y of H.matched)if(y.beforeEnter&&!X.matched.includes(y))if(Tt(y.beforeEnter))for(const P of y.beforeEnter)te.push(zn(P,H,X));else te.push(zn(y.beforeEnter,H,X));return te.push(_),Ot(te)}).then(()=>(H.matched.forEach(y=>y.enterCallbacks={}),te=Aa(He,"beforeRouteEnter",H,X),te.push(_),Ot(te))).then(()=>{te=[];for(const y of l.list())te.push(zn(y,H,X));return te.push(_),Ot(te)}).catch(y=>rn(y,8)?y:Promise.reject(y))}function de(H,X,te){for(const oe of r.list())U(()=>oe(H,X,te))}function G(H,X,te,oe,ke){const He=b(H,X);if(He)return He;const _=X===wn,y=mn?history.state:{};te&&(oe||_?s.replace(H.fullPath,Ke({scroll:_&&y&&y.scroll},ke)):s.push(H.fullPath,ke)),u.value=H,Et(H,X,te,_),Le()}let _e;function be(){_e||(_e=s.listen((H,X,te)=>{if(!Fn.listening)return;const oe=k(H),ke=R(oe);if(ke){F(Ke(ke,{replace:!0}),oe).catch(hi);return}d=oe;const He=u.value;mn&&vb(su(He.fullPath,te.delta),pa()),se(oe,He).catch(_=>rn(_,12)?_:rn(_,2)?(F(_.to,oe).then(y=>{rn(y,20)&&!te.delta&&te.type===Ei.pop&&s.go(-1,!1)}).catch(hi),Promise.reject()):(te.delta&&s.go(-te.delta,!1),ce(_,oe,He))).then(_=>{_=_||G(oe,He,!1),_&&(te.delta&&!rn(_,8)?s.go(-te.delta,!1):te.type===Ei.pop&&rn(_,20)&&s.go(-1,!1)),de(oe,He,_)}).catch(hi)}))}let we=Zo(),Re=Zo(),ne;function ce(H,X,te){Le(H);const oe=Re.list();return oe.length?oe.forEach(ke=>ke(H,X,te)):(Te("uncaught error during route navigation:"),console.error(H)),Promise.reject(H)}function $e(){return ne&&u.value!==wn?Promise.resolve():new Promise((H,X)=>{we.add([H,X])})}function Le(H){return ne||(ne=!H,be(),we.list().forEach(([X,te])=>H?te(H):X()),we.reset()),H}function Et(H,X,te,oe){const{scrollBehavior:ke}=e;if(!mn||!ke)return Promise.resolve();const He=!te&&_b(su(H.fullPath,0))||(oe||!te)&&history.state&&history.state.scroll||null;return it().then(()=>ke(H,X,He)).then(_=>_&&hb(_)).catch(_=>ce(_,H,X))}const nt=H=>s.go(H);let ht;const Qt=new Set,Fn={currentRoute:u,listening:!0,addRoute:h,removeRoute:v,hasRoute:x,getRoutes:S,resolve:k,options:e,push:K,replace:A,go:nt,back:()=>nt(-1),forward:()=>nt(1),beforeEach:a.add,beforeResolve:l.add,afterEach:r.add,onError:Re.add,isReady:$e,install(H){const X=this;H.component("RouterLink",ry),H.component("RouterView",py),H.config.globalProperties.$router=X,Object.defineProperty(H.config.globalProperties,"$route",{enumerable:!0,get:()=>L(u)}),mn&&!ht&&u.value===wn&&(ht=!0,K(s.location).catch(ke=>{Te("Unexpected error when starting the router:",ke)}));const te={};for(const ke in wn)te[ke]=N(()=>u.value[ke]);H.provide($r,X),H.provide(dm,je(te)),H.provide(zl,u);const oe=H.unmount;Qt.add(H),H.unmount=function(){Qt.delete(H),Qt.size<1&&(d=wn,_e&&_e(),_e=null,u.value=wn,ht=!1,ne=!1),oe()},mn&&hy(H,X,t)}};function Ot(H){return H.reduce((X,te)=>X.then(()=>U(te)),Promise.resolve())}return Fn}function ky(e,t){const n=[],i=[],s=[],a=Math.max(t.matched.length,e.matched.length);for(let l=0;l<a;l++){const r=t.matched[l];r&&(e.matched.find(d=>Nn(d,r))?i.push(r):n.push(r));const u=e.matched[l];u&&(t.matched.find(d=>Nn(d,u))||s.push(u))}return[n,i,s]}const Pa=Z(!1),_i=Z(!1),Eo=Z(!1),$y=Z(!0),Cl=f0({xs:460,...m0}),ho=Y0(),bm=q0(),zy=N(()=>ho.height.value-ho.width.value/On>180),ym=N0(Ut?document.body:null),Pn=u0(),Iy=N(()=>{var e,t;return["INPUT","TEXTAREA"].includes(((e=Pn.value)==null?void 0:e.tagName)||"")||((t=Pn.value)==null?void 0:t.classList.contains("CodeMirror-code"))}),Cy=N(()=>{var e;return["BUTTON","A"].includes(((e=Pn.value)==null?void 0:e.tagName)||"")});Jt("slidev-camera","default");Jt("slidev-mic","default");const bs=Jt("slidev-scale",0),ut=Jt("slidev-show-overview",!1),Ka=Jt("slidev-presenter-cursor",!0),bu=Jt("slidev-show-editor",!1);Jt("slidev-editor-width",Ut?window.innerWidth*.4:100);const Sm=Yp(ut);function yu(e,t,n,i=s=>s){return e*i(.5-t*(.5-n))}function Ty(e){return[-e[0],-e[1]]}function qt(e,t){return[e[0]+t[0],e[1]+t[1]]}function Pt(e,t){return[e[0]-t[0],e[1]-t[1]]}function Dt(e,t){return[e[0]*t,e[1]*t]}function Ey(e,t){return[e[0]/t,e[1]/t]}function Xo(e){return[e[1],-e[0]]}function Su(e,t){return e[0]*t[0]+e[1]*t[1]}function Oy(e,t){return e[0]===t[0]&&e[1]===t[1]}function My(e){return Math.hypot(e[0],e[1])}function Ay(e){return e[0]*e[0]+e[1]*e[1]}function wu(e,t){return Ay(Pt(e,t))}function wm(e){return Ey(e,My(e))}function Py(e,t){return Math.hypot(e[1]-t[1],e[0]-t[0])}function ei(e,t,n){let i=Math.sin(n),s=Math.cos(n),a=e[0]-t[0],l=e[1]-t[1],r=a*s-l*i,u=a*i+l*s;return[r+t[0],u+t[1]]}function Tl(e,t,n){return qt(e,Dt(Pt(t,e),n))}function xu(e,t,n){return qt(e,Dt(t,n))}var{min:Io,PI:Ky}=Math,ku=.275,ti=Ky+1e-4;function Ly(e,t={}){let{size:n=16,smoothing:i=.5,thinning:s=.5,simulatePressure:a=!0,easing:l=ne=>ne,start:r={},end:u={},last:d=!1}=t,{cap:p=!0,easing:m=ne=>ne*(2-ne)}=r,{cap:f=!0,easing:h=ne=>--ne*ne*ne+1}=u;if(e.length===0||n<=0)return[];let v=e[e.length-1].runningLength,S=r.taper===!1?0:r.taper===!0?Math.max(n,v):r.taper,x=u.taper===!1?0:u.taper===!0?Math.max(n,v):u.taper,k=Math.pow(n*i,2),C=[],b=[],K=e.slice(0,10).reduce((ne,ce)=>{let $e=ce.pressure;if(a){let Le=Io(1,ce.distance/n),Et=Io(1,1-Le);$e=Io(1,ne+(Et-ne)*(Le*ku))}return(ne+$e)/2},e[0].pressure),A=yu(n,s,e[e.length-1].pressure,l),R,F=e[0].vector,W=e[0].point,U=W,se=W,de=U,G=!1;for(let ne=0;ne<e.length;ne++){let{pressure:ce}=e[ne],{point:$e,vector:Le,distance:Et,runningLength:nt}=e[ne];if(ne<e.length-1&&v-nt<3)continue;if(s){if(a){let oe=Io(1,Et/n),ke=Io(1,1-oe);ce=Io(1,K+(ke-K)*(oe*ku))}A=yu(n,s,ce,l)}else A=n/2;R===void 0&&(R=A);let ht=nt<S?m(nt/S):1,Qt=v-nt<x?h((v-nt)/x):1;A=Math.max(.01,A*Math.min(ht,Qt));let Fn=(ne<e.length-1?e[ne+1]:e[ne]).vector,Ot=ne<e.length-1?Su(Le,Fn):1,H=Su(Le,F)<0&&!G,X=Ot!==null&&Ot<0;if(H||X){let oe=Dt(Xo(F),A);for(let ke=1/13,He=0;He<=1;He+=ke)se=ei(Pt($e,oe),$e,ti*He),C.push(se),de=ei(qt($e,oe),$e,ti*-He),b.push(de);W=se,U=de,X&&(G=!0);continue}if(G=!1,ne===e.length-1){let oe=Dt(Xo(Le),A);C.push(Pt($e,oe)),b.push(qt($e,oe));continue}let te=Dt(Xo(Tl(Fn,Le,Ot)),A);se=Pt($e,te),(ne<=1||wu(W,se)>k)&&(C.push(se),W=se),de=qt($e,te),(ne<=1||wu(U,de)>k)&&(b.push(de),U=de),K=ce,F=Le}let _e=e[0].point.slice(0,2),be=e.length>1?e[e.length-1].point.slice(0,2):qt(e[0].point,[1,1]),we=[],Re=[];if(e.length===1){if(!(S||x)||d){let ne=xu(_e,wm(Xo(Pt(_e,be))),-(R||A)),ce=[];for(let $e=1/13,Le=$e;Le<=1;Le+=$e)ce.push(ei(ne,_e,ti*2*Le));return ce}}else{if(!(S||x&&e.length===1))if(p)for(let ce=1/13,$e=ce;$e<=1;$e+=ce){let Le=ei(b[0],_e,ti*$e);we.push(Le)}else{let ce=Pt(C[0],b[0]),$e=Dt(ce,.5),Le=Dt(ce,.51);we.push(Pt(_e,$e),Pt(_e,Le),qt(_e,Le),qt(_e,$e))}let ne=Xo(Ty(e[e.length-1].vector));if(x||S&&e.length===1)Re.push(be);else if(f){let ce=xu(be,ne,A);for(let $e=1/29,Le=$e;Le<1;Le+=$e)Re.push(ei(ce,be,ti*3*Le))}else Re.push(qt(be,Dt(ne,A)),qt(be,Dt(ne,A*.99)),Pt(be,Dt(ne,A*.99)),Pt(be,Dt(ne,A)))}return C.concat(Re,b.reverse(),we)}function Ry(e,t={}){var n;let{streamline:i=.5,size:s=16,last:a=!1}=t;if(e.length===0)return[];let l=.15+(1-i)*.85,r=Array.isArray(e[0])?e:e.map(({x:h,y:v,pressure:S=.5})=>[h,v,S]);if(r.length===2){let h=r[1];r=r.slice(0,-1);for(let v=1;v<5;v++)r.push(Tl(r[0],h,v/4))}r.length===1&&(r=[...r,[...qt(r[0],[1,1]),...r[0].slice(2)]]);let u=[{point:[r[0][0],r[0][1]],pressure:r[0][2]>=0?r[0][2]:.25,vector:[1,1],distance:0,runningLength:0}],d=!1,p=0,m=u[0],f=r.length-1;for(let h=1;h<r.length;h++){let v=a&&h===f?r[h].slice(0,2):Tl(m.point,r[h],l);if(Oy(m.point,v))continue;let S=Py(v,m.point);if(p+=S,h<f&&!d){if(p<s)continue;d=!0}m={point:v,pressure:r[h][2]>=0?r[h][2]:.5,vector:wm(Pt(m.point,v)),distance:S,runningLength:p},u.push(m)}return u[0].vector=((n=u[1])==null?void 0:n.vector)||[0,0],u}function Hy(e,t={}){return Ly(Ry(e,t),t)}var Wy=()=>({events:{},emit(e,...t){let n=this.events[e]||[];for(let i=0,s=n.length;i<s;i++)n[i](...t)},on(e,t){var n;return(n=this.events[e])!=null&&n.push(t)||(this.events[e]=[t]),()=>{var i;this.events[e]=(i=this.events[e])==null?void 0:i.filter(s=>t!==s)}}});function Fs(e,t){return e-t}function Ny(e){return e<0?-1:1}function js(e){return[Math.abs(e),Ny(e)]}function xm(){const e=()=>((1+Math.random())*65536|0).toString(16).substring(1);return`${e()+e()}-${e()}-${e()}-${e()}-${e()}${e()}${e()}`}var Dy=2,fn=Dy,Do=class{constructor(e){this.drauu=e,this.event=void 0,this.point=void 0,this.start=void 0,this.el=null}onSelected(e){}onUnselected(){}onStart(e){}onMove(e){return!1}onEnd(e){}get brush(){return this.drauu.brush}get shiftPressed(){return this.drauu.shiftPressed}get altPressed(){return this.drauu.altPressed}get svgElement(){return this.drauu.el}getMousePosition(e){var t;const n=this.drauu.el,i=this.drauu.options.coordinateScale??1;if(this.drauu.options.coordinateTransform===!1){const s=this.drauu.el.getBoundingClientRect();return{x:(e.pageX-s.left)*i,y:(e.pageY-s.top)*i,pressure:e.pressure}}else{const s=this.drauu.svgPoint;s.x=e.clientX,s.y=e.clientY;const a=s.matrixTransform((t=n.getScreenCTM())==null?void 0:t.inverse());return{x:a.x*i,y:a.y*i,pressure:e.pressure}}}createElement(e,t){const n=document.createElementNS("http://www.w3.org/2000/svg",e),i=t?{...this.brush,...t}:this.brush;return n.setAttribute("fill",i.fill??"transparent"),n.setAttribute("stroke",i.color),n.setAttribute("stroke-width",i.size.toString()),n.setAttribute("stroke-linecap","round"),i.dasharray&&n.setAttribute("stroke-dasharray",i.dasharray),n}attr(e,t){this.el.setAttribute(e,typeof t=="string"?t:t.toFixed(fn))}_setEvent(e){this.event=e,this.point=this.getMousePosition(e)}_eventDown(e){return this._setEvent(e),this.start=this.point,this.onStart(this.point)}_eventMove(e){return this._setEvent(e),this.onMove(this.point)}_eventUp(e){return this._setEvent(e),this.onEnd(this.point)}},qy=class extends Do{constructor(){super(...arguments),this.points=[]}onStart(e){return this.el=document.createElementNS("http://www.w3.org/2000/svg","path"),this.points=[e],this.attr("fill",this.brush.color),this.attr("d",this.getSvgData(this.points)),this.el}onMove(e){return this.el||this.onStart(e),this.points[this.points.length-1]!==e&&this.points.push(e),this.attr("d",this.getSvgData(this.points)),!0}onEnd(){const e=this.el;return this.el=null,!!e}getSvgData(e){const t=Hy(e,{size:this.brush.size*2,thinning:.9,simulatePressure:!1,start:{taper:5},end:{taper:5},...this.brush.stylusOptions});if(!t.length)return"";const n=t.reduce((i,[s,a],l,r)=>{const[u,d]=r[(l+1)%r.length];return i.push(s,a,(s+u)/2,(a+d)/2),i},["M",...t[0],"Q"]);return n.push("Z"),n.map(i=>typeof i=="number"?i.toFixed(2):i).join(" ")}},Fy=class extends Do{onStart(e){return this.el=this.createElement("ellipse"),this.attr("cx",e.x),this.attr("cy",e.y),this.el}onMove(e){if(!this.el||!this.start)return!1;let[t,n]=js(e.x-this.start.x),[i,s]=js(e.y-this.start.y);if(this.shiftPressed){const a=Math.min(t,i);t=a,i=a}if(this.altPressed)this.attr("cx",this.start.x),this.attr("cy",this.start.y),this.attr("rx",t),this.attr("ry",i);else{const[a,l]=[this.start.x,this.start.x+t*n].sort(Fs),[r,u]=[this.start.y,this.start.y+i*s].sort(Fs);this.attr("cx",(a+l)/2),this.attr("cy",(r+u)/2),this.attr("rx",(l-a)/2),this.attr("ry",(u-r)/2)}return!0}onEnd(){const e=this.el;return this.el=null,!(!e||!e.getTotalLength())}};function km(e,t){const n=document.createElementNS("http://www.w3.org/2000/svg","defs"),i=document.createElementNS("http://www.w3.org/2000/svg","marker"),s=document.createElementNS("http://www.w3.org/2000/svg","path");return s.setAttribute("fill",t),i.setAttribute("id",e),i.setAttribute("viewBox","0 -5 10 10"),i.setAttribute("refX","5"),i.setAttribute("refY","0"),i.setAttribute("markerWidth","4"),i.setAttribute("markerHeight","4"),i.setAttribute("orient","auto"),s.setAttribute("d","M0,-5L10,0L0,5"),i.appendChild(s),n.appendChild(i),n}var jy=class extends Do{onStart(e){if(this.el=this.createElement("line",{fill:"transparent"}),this.attr("x1",e.x),this.attr("y1",e.y),this.attr("x2",e.x),this.attr("y2",e.y),this.brush.arrowEnd){const t=xm(),n=document.createElementNS("http://www.w3.org/2000/svg","g");return n.append(km(t,this.brush.color)),n.append(this.el),this.attr("marker-end",`url(#${t})`),n}return this.el}onMove(e){if(!this.el)return!1;let{x:t,y:n}=e;if(this.shiftPressed){const i=e.x-this.start.x,s=e.y-this.start.y;if(s!==0){let a=i/s;a=Math.round(a),Math.abs(a)<=1?(t=this.start.x+s*a,n=this.start.y+s):(t=this.start.x+i,n=this.start.y)}}return this.altPressed?(this.attr("x1",this.start.x*2-t),this.attr("y1",this.start.y*2-n),this.attr("x2",t),this.attr("y2",n)):(this.attr("x1",this.start.x),this.attr("y1",this.start.y),this.attr("x2",t),this.attr("y2",n)),!0}onEnd(){const e=this.el;return this.el=null,!(!e||e.getTotalLength()<5)}},Vy=class extends Do{onStart(e){return this.el=this.createElement("rect"),this.brush.cornerRadius&&(this.attr("rx",this.brush.cornerRadius),this.attr("ry",this.brush.cornerRadius)),this.attr("x",e.x),this.attr("y",e.y),this.el}onMove(e){if(!this.el||!this.start)return!1;let[t,n]=js(e.x-this.start.x),[i,s]=js(e.y-this.start.y);if(this.shiftPressed){const a=Math.min(t,i);t=a,i=a}if(this.altPressed)this.attr("x",this.start.x-t),this.attr("y",this.start.y-i),this.attr("width",t*2),this.attr("height",i*2);else{const[a,l]=[this.start.x,this.start.x+t*n].sort(Fs),[r,u]=[this.start.y,this.start.y+i*s].sort(Fs);this.attr("x",a),this.attr("y",r),this.attr("width",l-a),this.attr("height",u-r)}return!0}onEnd(){const e=this.el;return this.el=null,!(!e||!e.getTotalLength())}};function By(e,t){const n=e.x-t.x,i=e.y-t.y;return n*n+i*i}function Uy(e,t,n){let i=t.x,s=t.y,a=n.x-i,l=n.y-s;if(a!==0||l!==0){const r=((e.x-i)*a+(e.y-s)*l)/(a*a+l*l);r>1?(i=n.x,s=n.y):r>0&&(i+=a*r,s+=l*r)}return a=e.x-i,l=e.y-s,a*a+l*l}function Jy(e,t){let n=e[0];const i=[n];let s;for(let a=1,l=e.length;a<l;a++)s=e[a],By(s,n)>t&&(i.push(s),n=s);return n!==s&&s&&i.push(s),i}function El(e,t,n,i,s){let a=i,l=0;for(let r=t+1;r<n;r++){const u=Uy(e[r],e[t],e[n]);u>a&&(l=r,a=u)}a>i&&(l-t>1&&El(e,t,l,i,s),s.push(e[l]),n-l>1&&El(e,l,n,i,s))}function Qy(e,t){const n=e.length-1,i=[e[0]];return El(e,0,n,t,i),i.push(e[n]),i}function $u(e,t,n=!1){if(e.length<=2)return e;const i=t!==void 0?t*t:1;return e=n?e:Jy(e,i),e=Qy(e,i),e}var Yy=class extends Do{constructor(){super(...arguments),this.points=[],this.count=0}onStart(e){if(this.el=this.createElement("path",{fill:"transparent"}),this.points=[e],this.brush.arrowEnd){this.arrowId=xm();const t=km(this.arrowId,this.brush.color);this.el.appendChild(t)}return this.el}onMove(e){return this.el||this.onStart(e),this.points[this.points.length-1]!==e&&(this.points.push(e),this.count+=1),this.count>5&&(this.points=$u(this.points,1,!0),this.count=0),this.attr("d",Iu(this.points)),!0}onEnd(){const e=this.el;return this.el=null,!(!e||(e.setAttribute("d",Iu($u(this.points,1,!0))),!e.getTotalLength()))}};function Zy(e,t){const n=t.x-e.x,i=t.y-e.y;return{length:Math.sqrt(n**2+i**2),angle:Math.atan2(i,n)}}function zu(e,t,n,i){const s=t||e,a=n||e,l=.2,r=Zy(s,a),u=r.angle+(i?Math.PI:0),d=r.length*l,p=e.x+Math.cos(u)*d,m=e.y+Math.sin(u)*d;return{x:p,y:m}}function Gy(e,t,n){const i=zu(n[t-1],n[t-2],e),s=zu(e,n[t-1],n[t+1],!0);return`C ${i.x.toFixed(fn)},${i.y.toFixed(fn)} ${s.x.toFixed(fn)},${s.y.toFixed(fn)} ${e.x.toFixed(fn)},${e.y.toFixed(fn)}`}function Iu(e){return e.reduce((t,n,i,s)=>i===0?`M ${n.x.toFixed(fn)},${n.y.toFixed(fn)}`:`${t} ${Gy(n,i,s)}`,"")}var Xy=class extends Do{constructor(){super(...arguments),this.pathSubFactor=20,this.pathFragments=[]}onSelected(e){const t=(n,i)=>{if(n&&n.length)for(let s=0;s<n.length;s++){const a=n[s];if(a.getTotalLength){const l=a.getTotalLength();for(let r=0;r<this.pathSubFactor;r++){const u=a.getPointAtLength(l*r/this.pathSubFactor),d=a.getPointAtLength(l*(r+1)/this.pathSubFactor);this.pathFragments.push({x1:u.x,x2:d.x,y1:u.y,y2:d.y,segment:r,element:i||a})}}else a.children&&t(a.children,a)}};e&&t(e.children)}onUnselected(){this.pathFragments=[]}onStart(e){this.svgPointPrevious=this.svgElement.createSVGPoint(),this.svgPointPrevious.x=e.x,this.svgPointPrevious.y=e.y}onMove(e){this.svgPointCurrent=this.svgElement.createSVGPoint(),this.svgPointCurrent.x=e.x,this.svgPointCurrent.y=e.y;const t=this.checkAndEraseElement();return this.svgPointPrevious=this.svgPointCurrent,t}onEnd(){return this.svgPointPrevious=void 0,this.svgPointCurrent=void 0,!0}checkAndEraseElement(){const e=[];if(this.pathFragments.length)for(let t=0;t<this.pathFragments.length;t++){const n=this.pathFragments[t],i={x1:this.svgPointPrevious.x,x2:this.svgPointCurrent.x,y1:this.svgPointPrevious.y,y2:this.svgPointCurrent.y};this.lineLineIntersect(n,i)&&(n.element.remove(),e.push(t))}return e.length&&(this.pathFragments=this.pathFragments.filter((t,n)=>!e.includes(n))),e.length>0}lineLineIntersect(e,t){const n=e.x1,i=e.x2,s=t.x1,a=t.x2,l=e.y1,r=e.y2,u=t.y1,d=t.y2,p=(n-i)*(u-d)-(l-r)*(s-a),m=(n*r-l*i)*(s-a)-(n-i)*(s*d-u*a),f=(n*r-l*i)*(u-d)-(l-r)*(s*d-u*a),h=(v,S,x)=>v>=S&&v<=x?!0:v>=x&&v<=S;if(p===0)return!1;{const v={x:m/p,y:f/p};return h(v.x,n,i)&&h(v.y,l,r)&&h(v.x,s,a)&&h(v.y,u,d)}}};function eS(e){return{draw:new Yy(e),stylus:new qy(e),line:new jy(e),rectangle:new Vy(e),ellipse:new Fy(e),eraseLine:new Xy(e)}}var tS=class{constructor(e={}){this.options=e,this.el=null,this.svgPoint=null,this.eventEl=null,this.shiftPressed=!1,this.altPressed=!1,this.drawing=!1,this._emitter=Wy(),this._models=eS(this),this._undoStack=[],this._disposables=[],this.options.brush||(this.options.brush={color:"black",size:3,mode:"stylus"}),e.el&&this.mount(e.el,e.eventTarget)}get model(){return this._models[this.mode]}get mounted(){return!!this.el}get mode(){return this.options.brush.mode||"stylus"}set mode(e){this._models[this.mode].onUnselected(),this.options.brush.mode=e,this.model.onSelected(this.el)}get brush(){return this.options.brush}set brush(e){this.options.brush=e}resolveSelector(e){return typeof e=="string"?document.querySelector(e):e||null}mount(e,t){if(this.el)throw new Error("[drauu] already mounted, unmount previous target first");if(this.el=this.resolveSelector(e),!this.el)throw new Error("[drauu] target element not found");if(this.el.tagName.toLocaleLowerCase()!=="svg")throw new Error("[drauu] can only mount to a SVG element");if(!this.el.createSVGPoint)throw new Error("[drauu] SVG element must be create by document.createElementNS('http://www.w3.org/2000/svg', 'svg')");this.svgPoint=this.el.createSVGPoint();const n=this.resolveSelector(t)||this.el,i=this.eventStart.bind(this),s=this.eventMove.bind(this),a=this.eventEnd.bind(this),l=this.eventKeyboard.bind(this);n.addEventListener("pointerdown",i,{passive:!1}),window.addEventListener("pointermove",s,{passive:!1}),window.addEventListener("pointerup",a,{passive:!1}),window.addEventListener("pointercancel",a,{passive:!1}),window.addEventListener("keydown",l,!1),window.addEventListener("keyup",l,!1),this._disposables.push(()=>{n.removeEventListener("pointerdown",i),window.removeEventListener("pointermove",s),window.removeEventListener("pointerup",a),window.removeEventListener("pointercancel",a),window.removeEventListener("keydown",l,!1),window.removeEventListener("keyup",l,!1)}),this._emitter.emit("mounted")}unmount(){this._disposables.forEach(e=>e()),this._disposables.length=0,this.el=null,this._emitter.emit("unmounted")}on(e,t){return this._emitter.on(e,t)}undo(){const e=this.el;return e.lastElementChild?(this._undoStack.push(e.lastElementChild.cloneNode(!0)),e.lastElementChild.remove(),this._emitter.emit("changed"),!0):!1}redo(){return this._undoStack.length?(this.el.appendChild(this._undoStack.pop()),this._emitter.emit("changed"),!0):!1}canRedo(){return!!this._undoStack.length}canUndo(){var e;return!!((e=this.el)!=null&&e.lastElementChild)}eventMove(e){!this.acceptsInput(e)||!this.drawing||this.model._eventMove(e)&&(e.stopPropagation(),e.preventDefault(),this._emitter.emit("changed"))}eventStart(e){this.acceptsInput(e)&&(e.stopPropagation(),e.preventDefault(),this._currentNode&&this.cancel(),this.drawing=!0,this._emitter.emit("start"),this._currentNode=this.model._eventDown(e),this._currentNode&&this.mode!=="eraseLine"&&this.el.appendChild(this._currentNode),this._emitter.emit("changed"))}eventEnd(e){if(!this.acceptsInput(e)||!this.drawing)return;const t=this.model._eventUp(e);t?(t instanceof Element&&t!==this._currentNode&&(this._currentNode=t),this.commit()):this.cancel(),this.drawing=!1,this._emitter.emit("end"),this._emitter.emit("changed")}acceptsInput(e){return!this.options.acceptsInputTypes||this.options.acceptsInputTypes.includes(e.pointerType)}eventKeyboard(e){this.shiftPressed===e.shiftKey&&this.altPressed===e.altKey||(this.shiftPressed=e.shiftKey,this.altPressed=e.altKey,this.model.point&&this.model.onMove(this.model.point)&&this._emitter.emit("changed"))}commit(){this._undoStack.length=0;const e=this._currentNode;this._currentNode=void 0,this._emitter.emit("committed",e)}clear(){this._undoStack.length=0,this.cancel(),this.el.innerHTML="",this._emitter.emit("changed")}cancel(){this._currentNode&&(this.el.removeChild(this._currentNode),this._currentNode=void 0,this._emitter.emit("canceled"))}dump(){return this.el.innerHTML}load(e){this.clear(),this.el.innerHTML=e}};function nS(e){return new tS(e)}const Ol=["#ff595e","#ffca3a","#8ac926","#1982c4","#6a4c93","#ffffff","#000000"],en=Jt("slidev-drawing-enabled",!1),Vq=Jt("slidev-drawing-pinned",!1),oS=Z(!1),iS=Z(!1),sS=Z(!1),Mi=Z(!1),so=T1(Jt("slidev-drawing-brush",{color:Ol[0],size:4,mode:"stylus"})),Cu=Z("stylus"),$m=N(()=>Ee.drawings.syncAll||_t.value);let Ai=!1;const ni=N({get(){return Cu.value},set(e){Cu.value=e,e==="arrow"?(so.mode="line",so.arrowEnd=!0):(so.mode=e,so.arrowEnd=!1)}}),aS=je({brush:so,acceptsInputTypes:N(()=>en.value&&(!Ee.drawings.presenterOnly||_t.value)?void 0:["pen"]),coordinateTransform:!1}),ft=ta(nS(aS));function lS(){ft.clear(),$m.value&&Bp(Be.value,"")}function zr(){var e;iS.value=ft.canRedo(),oS.value=ft.canUndo(),sS.value=!!((e=ft.el)!=null&&e.children.length)}function rS(e){Ai=!0;const t=Ds[e||Be.value];t!=null?ft.load(t):ft.clear(),zr(),Ai=!1}ft.on("changed",()=>{if(zr(),!Ai){const e=ft.dump(),t=Be.value;(Ds[t]||"")!==e&&$m.value&&Bp(t,ft.dump())}});$1(e=>{Ai=!0,e[Be.value]!=null&&ft.load(e[Be.value]||""),Ai=!1,zr()});it(()=>{ge(Be,()=>{ft.mounted&&rS()},{immediate:!0})});ft.on("start",()=>Mi.value=!0);ft.on("end",()=>Mi.value=!1);window.addEventListener("keydown",e=>{if(!en.value)return;const t=!e.ctrlKey&&!e.altKey&&!e.shiftKey&&!e.metaKey;let n=!0;e.code==="KeyZ"&&(e.ctrlKey||e.metaKey)?e.shiftKey?ft.redo():ft.undo():e.code==="Escape"?en.value=!1:e.code==="KeyL"&&t?ni.value="line":e.code==="KeyA"&&t?ni.value="arrow":e.code==="KeyS"&&t?ni.value="stylus":e.code==="KeyR"&&t?ni.value="rectangle":e.code==="KeyE"&&t?ni.value="ellipse":e.code==="KeyC"&&t?lS():e.code.startsWith("Digit")&&t&&+e.code[5]<=Ol.length?so.color=Ol[+e.code[5]-1]:n=!1,n&&(e.preventDefault(),e.stopPropagation())},!1);function Ye(...e){return N(()=>e.every(t=>Je(t)))}function kt(e){return N(()=>!Je(e))}const Tu=z0(),La=Jt("slidev-color-schema","auto"),Ml=N(()=>Ee.colorSchema!=="auto"),Ir=N({get(){return Ml.value?Ee.colorSchema==="dark":La.value==="auto"?Tu.value:La.value==="dark"},set(e){Ml.value||(La.value=e===Tu.value?"auto":e?"dark":"light")}}),zm=Yp(Ir);Ut&&ge(Ir,e=>{const t=document.querySelector("html");t.classList.toggle("dark",e),t.classList.toggle("light",!e)},{immediate:!0});const ys=Z(1),Ss=N(()=>Qe.length-1),Ct=Z(0),Cr=Z(0);function cS(){Ct.value>ys.value&&(Ct.value-=1)}function uS(){Ct.value<Ss.value&&(Ct.value+=1)}function dS(){if(Ct.value>ys.value){let e=Ct.value-Cr.value;e<ys.value&&(e=ys.value),Ct.value=e}}function pS(){if(Ct.value<Ss.value){let e=Ct.value+Cr.value;e>Ss.value&&(e=Ss.value),Ct.value=e}}function mS(){const{escape:e,space:t,shift:n,left:i,right:s,up:a,down:l,enter:r,d:u,g:d,o:p}=bm;let m=[{name:"next_space",key:Ye(t,kt(n)),fn:Kn,autoRepeat:!0},{name:"prev_space",key:Ye(t,n),fn:Ln,autoRepeat:!0},{name:"next_right",key:Ye(s,kt(n),kt(ut)),fn:Kn,autoRepeat:!0},{name:"prev_left",key:Ye(i,kt(n),kt(ut)),fn:Ln,autoRepeat:!0},{name:"next_page_key",key:"pageDown",fn:Kn,autoRepeat:!0},{name:"prev_page_key",key:"pageUp",fn:Ln,autoRepeat:!0},{name:"next_down",key:Ye(l,kt(ut)),fn:Ki,autoRepeat:!0},{name:"prev_up",key:Ye(a,kt(ut)),fn:()=>Li(!1),autoRepeat:!0},{name:"next_shift",key:Ye(s,n),fn:Ki,autoRepeat:!0},{name:"prev_shift",key:Ye(i,n),fn:()=>Li(!1),autoRepeat:!0},{name:"toggle_dark",key:Ye(u,kt(en)),fn:zm},{name:"toggle_overview",key:Ye(p,kt(en)),fn:Sm},{name:"hide_overview",key:Ye(e,kt(en)),fn:()=>ut.value=!1},{name:"goto",key:Ye(d,kt(en)),fn:()=>Eo.value=!Eo.value},{name:"next_overview",key:Ye(s,ut),fn:uS},{name:"prev_overview",key:Ye(i,ut),fn:cS},{name:"up_overview",key:Ye(a,ut),fn:dS},{name:"down_overview",key:Ye(l,ut),fn:pS},{name:"goto_from_overview",key:Ye(r,ut),fn:()=>{Wo(Ct.value),ut.value=!1}}];const f=new Set(m.map(v=>v.name));if(m.filter(v=>v.name&&f.has(v.name)).length===0){const v=["========== WARNING ==========","defineShortcutsSetup did not return any of the base shortcuts.","See https://sli.dev/custom/config-shortcuts.html for migration.",'If it is intentional, return at least one shortcut with one of the base names (e.g. name:"goto").'].join(`

`);alert(v),console.warn(v)}return m}const Im=Ye(kt(Iy),kt(Cy),$y);function fS(e,t,n=!1){typeof e=="string"&&(e=bm[e]);const i=Ye(e,Im);let s=0,a;const l=()=>{if(clearTimeout(a),!i.value){s=0;return}n&&(a=setTimeout(l,Math.max(1e3-s*250,150)),s++),t()};return ge(i,l,{flush:"sync"})}function hS(e,t){return c0(e,n=>{Im.value&&(n.repeat||t())})}function vS(){const e=mS();new Map(e.map(n=>[n.key,n])).forEach(n=>{n.fn&&fS(n.key,n.fn,n.autoRepeat)}),hS("f",()=>ym.toggle())}const _S={class:"slidev-icon",viewBox:"0 0 32 32",width:"1.2em",height:"1.2em"},gS=o("path",{fill:"currentColor",d:"M24 9.4L22.6 8L16 14.6L9.4 8L8 9.4l6.6 6.6L8 22.6L9.4 24l6.6-6.6l6.6 6.6l1.4-1.4l-6.6-6.6L24 9.4z"},null,-1),bS=[gS];function yS(e,t){return g(),ie("svg",_S,bS)}const SS={name:"carbon-close",render:yS};function Tr(e,t=""){var s,a;const n=["slidev-page",t],i=(a=(s=e==null?void 0:e.meta)==null?void 0:s.slide)==null?void 0:a.no;return i!=null&&n.push(`slidev-page-${i}`),n.filter(Boolean).join(" ")}const wS=Pe({__name:"SlideContainer",props:{width:{type:Number},meta:{default:()=>({})},scale:{type:[Number,String]}},setup(e){const t=e;$(I);const n=Z(),i=H0(n),s=N(()=>t.width?t.width:i.width.value),a=N(()=>t.width?t.width/On:i.height.value);t.width&&yo(()=>{n.value&&(n.value.style.width=`${s.value}px`,n.value.style.height=`${a.value}px`)});const l=N(()=>s.value/a.value),r=N(()=>t.scale&&!Ho.value?t.scale:l.value<On?s.value/Mn:a.value*On/Mn),u=N(()=>({height:`${wr}px`,width:`${Mn}px`,transform:`translate(-50%, -50%) scale(${r.value})`})),d=N(()=>({"select-none":!Ee.selectable,"slidev-code-line-numbers":Ee.lineNumbers}));return zt(Fp,r),(p,m)=>(g(),ie("div",{id:"slide-container",ref_key:"root",ref:n,class:Ve(d.value)},[o("div",{id:"slide-content",style:tt(u.value)},[Bt(p.$slots,"default")],4),Bt(p.$slots,"controls")],2))}});const T=(e,t)=>{const n=e.__vccOpts||e;for(const[i,s]of t)n[i]=s;return n},Cm=T(wS,[["__file","/home/antonio/WORK/ITI_Agnelli/Materie/slidev/node_modules/@slidev/client/internals/SlideContainer.vue"]]),Er=Pe({name:"SlideWrapper",props:{clicks:{type:[Number,String],default:0},clicksElements:{type:Array,default:()=>[]},clicksOrderMap:{type:Map,default:()=>new Map},clicksDisabled:{type:Boolean,default:!1},context:{type:String,default:"main"},is:{type:Object,default:void 0},route:{type:Object,default:void 0}},setup(e,{emit:t}){const n=Kt(e,"clicks",t),i=Kt(e,"clicksElements",t),s=Kt(e,"clicksDisabled",t),a=Kt(e,"clicksOrderMap",t);i.value.length=0,zt(u1,e.route),zt(d1,e.context),zt(mi,n),zt(fi,s),zt(eo,i),zt(gl,a)},render(){var e,t;return this.$props.is?St(this.$props.is):(t=(e=this.$slots)==null?void 0:e.default)==null?void 0:t.call(e)}}),xS=["innerHTML"],kS=Pe({__name:"DrawingPreview",props:{page:{type:Number,required:!0}},setup(e){return $(I),(t,n)=>L(Ds)[t.page]?(g(),ie("svg",{key:0,class:"w-full h-full absolute top-0 pointer-events-none",innerHTML:L(Ds)[t.page]},null,8,xS)):Se("v-if",!0)}}),Tm=T(kS,[["__file","/home/antonio/WORK/ITI_Agnelli/Materie/slidev/node_modules/@slidev/client/internals/DrawingPreview.vue"]]),$S=Object.freeze(Object.defineProperty({__proto__:null,default:Tm},Symbol.toStringTag,{value:"Module"})),zS={class:"slides-overview bg-main !bg-opacity-75 p-16 overflow-y-auto"},IS=["onClick"],Ra=4*16*2,Eu=2*16,CS=Pe({__name:"SlidesOverview",props:{modelValue:{type:Boolean,required:!0}},emits:[],setup(e,{emit:t}){const n=e;$(I);const i=Kt(n,"modelValue",t);function s(){i.value=!1}function a(m){Wo(m),s()}function l(m){return m===Ct.value}const r=Cl.smaller("xs"),u=Cl.smaller("sm"),d=N(()=>r.value?ho.width.value-Ra:u.value?(ho.width.value-Ra-Eu)/2:300),p=N(()=>Math.floor((ho.width.value-Ra)/(d.value+Eu)));return yo(()=>{Ct.value=Be.value,Cr.value=p.value}),(m,f)=>{const h=SS;return g(),ie(Oe,null,[np(o("div",zS,[o("div",{class:"grid gap-y-4 gap-x-8 w-full",style:tt(`grid-template-columns: repeat(auto-fit,minmax(${d.value}px,1fr))`)},[(g(!0),ie(Oe,null,No(L(Qe).slice(0,-1),(v,S)=>(g(),ie("div",{key:v.path,class:"relative"},[o("div",{class:Ve(["inline-block border rounded border-opacity-50 overflow-hidden bg-main hover:border-$slidev-theme-primary",{"border-$slidev-theme-primary":l(S+1),"border-gray-400":!l(S+1)}]),style:tt(L(xr)),onClick:x=>a(+v.path)},[(g(),z(Cm,{key:v.path,width:d.value,"clicks-disabled":!0,class:"pointer-events-none"},{default:w(()=>[v!=null&&v.component?(g(),z(L(Er),{key:0,is:v.component,"clicks-disabled":!0,class:Ve(L(Tr)(v)),route:v,context:"overview"},null,8,["is","class","route"])):Se("v-if",!0),j(Tm,{page:+v.path},null,8,["page"])]),_:2},1032,["width"]))],14,IS),o("div",{class:"absolute top-0 opacity-50",style:tt(`left: ${d.value+5}px`)},gt(S+1),5)]))),128))],4)],512),[[Mp,L(i)]]),L(i)?(g(),ie("button",{key:0,class:"fixed text-2xl top-4 right-4 slidev-icon-btn text-gray-400",onClick:s},[j(h)])):Se("v-if",!0)],64)}}});const TS=T(CS,[["__file","/home/antonio/WORK/ITI_Agnelli/Materie/slidev/node_modules/@slidev/client/internals/SlidesOverview.vue"]]),ES="/TPSI/4/svelte/assets/logo-b72bde5d.png",OS={key:0,class:"fixed top-0 bottom-0 left-0 right-0 grid z-20"},MS=Pe({__name:"Modal",props:{modelValue:{default:!1},class:{default:""}},emits:["modelValue"],setup(e,{emit:t}){const n=e;$(I);const i=Kt(n,"modelValue",t);function s(){i.value=!1}return(a,l)=>(g(),z(ip,null,[L(i)?(g(),ie("div",OS,[o("div",{bg:"black opacity-80",class:"absolute top-0 bottom-0 left-0 right-0 -z-1",onClick:l[0]||(l[0]=r=>s())}),o("div",{class:Ve(["m-auto rounded-md bg-main shadow",n.class]),"dark:border":"~ main"},[Bt(a.$slots,"default")],2)])):Se("v-if",!0)],1024))}}),AS=T(MS,[["__file","/home/antonio/WORK/ITI_Agnelli/Materie/slidev/node_modules/@slidev/client/internals/Modal.vue"]]),PS={class:"slidev-info-dialog slidev-layout flex flex-col gap-4 text-base"},KS=["innerHTML"],LS=o("a",{href:"https://github.com/slidevjs/slidev",target:"_blank",class:"!opacity-100 !border-none !text-current"},[o("div",{class:"flex gap-1 children:my-auto"},[o("div",{class:"opacity-50 text-sm mr-2"},"Powered by"),o("img",{class:"w-5 h-5",src:ES,alt:"Slidev"}),o("div",{style:{color:"#2082A6"}},[o("b",null,"Sli"),c("dev ")])])],-1),RS=Pe({__name:"InfoDialog",props:{modelValue:{default:!1}},emits:["modelValue"],setup(e,{emit:t}){const n=e;$(I);const i=Kt(n,"modelValue",t),s=N(()=>typeof Ee.info=="string");return(a,l)=>(g(),z(AS,{modelValue:L(i),"onUpdate:modelValue":l[0]||(l[0]=r=>Me(i)?i.value=r:null),class:"px-6 py-4"},{default:w(()=>[o("div",PS,[s.value?(g(),ie("div",{key:0,class:"mb-4",innerHTML:L(Ee).info},null,8,KS)):Se("v-if",!0),LS])]),_:1},8,["modelValue"]))}});const HS=T(RS,[["__file","/home/antonio/WORK/ITI_Agnelli/Materie/slidev/node_modules/@slidev/client/internals/InfoDialog.vue"]]);function _n(e){return Array.isArray?Array.isArray(e):Mm(e)==="[object Array]"}const WS=1/0;function NS(e){if(typeof e=="string")return e;let t=e+"";return t=="0"&&1/e==-WS?"-0":t}function DS(e){return e==null?"":NS(e)}function tn(e){return typeof e=="string"}function Em(e){return typeof e=="number"}function qS(e){return e===!0||e===!1||FS(e)&&Mm(e)=="[object Boolean]"}function Om(e){return typeof e=="object"}function FS(e){return Om(e)&&e!==null}function It(e){return e!=null}function Ha(e){return!e.trim().length}function Mm(e){return e==null?e===void 0?"[object Undefined]":"[object Null]":Object.prototype.toString.call(e)}const jS="Incorrect 'index' type",VS=e=>`Invalid value for key ${e}`,BS=e=>`Pattern length exceeds max of ${e}.`,US=e=>`Missing ${e} property in key`,JS=e=>`Property 'weight' in key '${e}' must be a positive integer`,Ou=Object.prototype.hasOwnProperty;class QS{constructor(t){this._keys=[],this._keyMap={};let n=0;t.forEach(i=>{let s=Am(i);n+=s.weight,this._keys.push(s),this._keyMap[s.id]=s,n+=s.weight}),this._keys.forEach(i=>{i.weight/=n})}get(t){return this._keyMap[t]}keys(){return this._keys}toJSON(){return JSON.stringify(this._keys)}}function Am(e){let t=null,n=null,i=null,s=1,a=null;if(tn(e)||_n(e))i=e,t=Mu(e),n=Al(e);else{if(!Ou.call(e,"name"))throw new Error(US("name"));const l=e.name;if(i=l,Ou.call(e,"weight")&&(s=e.weight,s<=0))throw new Error(JS(l));t=Mu(l),n=Al(l),a=e.getFn}return{path:t,id:n,weight:s,src:i,getFn:a}}function Mu(e){return _n(e)?e:e.split(".")}function Al(e){return _n(e)?e.join("."):e}function YS(e,t){let n=[],i=!1;const s=(a,l,r)=>{if(It(a))if(!l[r])n.push(a);else{let u=l[r];const d=a[u];if(!It(d))return;if(r===l.length-1&&(tn(d)||Em(d)||qS(d)))n.push(DS(d));else if(_n(d)){i=!0;for(let p=0,m=d.length;p<m;p+=1)s(d[p],l,r+1)}else l.length&&s(d,l,r+1)}};return s(e,tn(t)?t.split("."):t,0),i?n:n[0]}const ZS={includeMatches:!1,findAllMatches:!1,minMatchCharLength:1},GS={isCaseSensitive:!1,includeScore:!1,keys:[],shouldSort:!0,sortFn:(e,t)=>e.score===t.score?e.idx<t.idx?-1:1:e.score<t.score?-1:1},XS={location:0,threshold:.6,distance:100},ew={useExtendedSearch:!1,getFn:YS,ignoreLocation:!1,ignoreFieldNorm:!1,fieldNormWeight:1};var fe={...GS,...ZS,...XS,...ew};const tw=/[^ ]+/g;function nw(e=1,t=3){const n=new Map,i=Math.pow(10,t);return{get(s){const a=s.match(tw).length;if(n.has(a))return n.get(a);const l=1/Math.pow(a,.5*e),r=parseFloat(Math.round(l*i)/i);return n.set(a,r),r},clear(){n.clear()}}}class Or{constructor({getFn:t=fe.getFn,fieldNormWeight:n=fe.fieldNormWeight}={}){this.norm=nw(n,3),this.getFn=t,this.isCreated=!1,this.setIndexRecords()}setSources(t=[]){this.docs=t}setIndexRecords(t=[]){this.records=t}setKeys(t=[]){this.keys=t,this._keysMap={},t.forEach((n,i)=>{this._keysMap[n.id]=i})}create(){this.isCreated||!this.docs.length||(this.isCreated=!0,tn(this.docs[0])?this.docs.forEach((t,n)=>{this._addString(t,n)}):this.docs.forEach((t,n)=>{this._addObject(t,n)}),this.norm.clear())}add(t){const n=this.size();tn(t)?this._addString(t,n):this._addObject(t,n)}removeAt(t){this.records.splice(t,1);for(let n=t,i=this.size();n<i;n+=1)this.records[n].i-=1}getValueForItemAtKeyId(t,n){return t[this._keysMap[n]]}size(){return this.records.length}_addString(t,n){if(!It(t)||Ha(t))return;let i={v:t,i:n,n:this.norm.get(t)};this.records.push(i)}_addObject(t,n){let i={i:n,$:{}};this.keys.forEach((s,a)=>{let l=s.getFn?s.getFn(t):this.getFn(t,s.path);if(It(l)){if(_n(l)){let r=[];const u=[{nestedArrIndex:-1,value:l}];for(;u.length;){const{nestedArrIndex:d,value:p}=u.pop();if(It(p))if(tn(p)&&!Ha(p)){let m={v:p,i:d,n:this.norm.get(p)};r.push(m)}else _n(p)&&p.forEach((m,f)=>{u.push({nestedArrIndex:f,value:m})})}i.$[a]=r}else if(tn(l)&&!Ha(l)){let r={v:l,n:this.norm.get(l)};i.$[a]=r}}}),this.records.push(i)}toJSON(){return{keys:this.keys,records:this.records}}}function Pm(e,t,{getFn:n=fe.getFn,fieldNormWeight:i=fe.fieldNormWeight}={}){const s=new Or({getFn:n,fieldNormWeight:i});return s.setKeys(e.map(Am)),s.setSources(t),s.create(),s}function ow(e,{getFn:t=fe.getFn,fieldNormWeight:n=fe.fieldNormWeight}={}){const{keys:i,records:s}=e,a=new Or({getFn:t,fieldNormWeight:n});return a.setKeys(i),a.setIndexRecords(s),a}function ds(e,{errors:t=0,currentLocation:n=0,expectedLocation:i=0,distance:s=fe.distance,ignoreLocation:a=fe.ignoreLocation}={}){const l=t/e.length;if(a)return l;const r=Math.abs(i-n);return s?l+r/s:r?1:l}function iw(e=[],t=fe.minMatchCharLength){let n=[],i=-1,s=-1,a=0;for(let l=e.length;a<l;a+=1){let r=e[a];r&&i===-1?i=a:!r&&i!==-1&&(s=a-1,s-i+1>=t&&n.push([i,s]),i=-1)}return e[a-1]&&a-i>=t&&n.push([i,a-1]),n}const no=32;function sw(e,t,n,{location:i=fe.location,distance:s=fe.distance,threshold:a=fe.threshold,findAllMatches:l=fe.findAllMatches,minMatchCharLength:r=fe.minMatchCharLength,includeMatches:u=fe.includeMatches,ignoreLocation:d=fe.ignoreLocation}={}){if(t.length>no)throw new Error(BS(no));const p=t.length,m=e.length,f=Math.max(0,Math.min(i,m));let h=a,v=f;const S=r>1||u,x=S?Array(m):[];let k;for(;(k=e.indexOf(t,v))>-1;){let F=ds(t,{currentLocation:k,expectedLocation:f,distance:s,ignoreLocation:d});if(h=Math.min(F,h),v=k+p,S){let W=0;for(;W<p;)x[k+W]=1,W+=1}}v=-1;let C=[],b=1,K=p+m;const A=1<<p-1;for(let F=0;F<p;F+=1){let W=0,U=K;for(;W<U;)ds(t,{errors:F,currentLocation:f+U,expectedLocation:f,distance:s,ignoreLocation:d})<=h?W=U:K=U,U=Math.floor((K-W)/2+W);K=U;let se=Math.max(1,f-U+1),de=l?m:Math.min(f+U,m)+p,G=Array(de+2);G[de+1]=(1<<F)-1;for(let be=de;be>=se;be-=1){let we=be-1,Re=n[e.charAt(we)];if(S&&(x[we]=+!!Re),G[be]=(G[be+1]<<1|1)&Re,F&&(G[be]|=(C[be+1]|C[be])<<1|1|C[be+1]),G[be]&A&&(b=ds(t,{errors:F,currentLocation:we,expectedLocation:f,distance:s,ignoreLocation:d}),b<=h)){if(h=b,v=we,v<=f)break;se=Math.max(1,2*f-v)}}if(ds(t,{errors:F+1,currentLocation:f,expectedLocation:f,distance:s,ignoreLocation:d})>h)break;C=G}const R={isMatch:v>=0,score:Math.max(.001,b)};if(S){const F=iw(x,r);F.length?u&&(R.indices=F):R.isMatch=!1}return R}function aw(e){let t={};for(let n=0,i=e.length;n<i;n+=1){const s=e.charAt(n);t[s]=(t[s]||0)|1<<i-n-1}return t}class Km{constructor(t,{location:n=fe.location,threshold:i=fe.threshold,distance:s=fe.distance,includeMatches:a=fe.includeMatches,findAllMatches:l=fe.findAllMatches,minMatchCharLength:r=fe.minMatchCharLength,isCaseSensitive:u=fe.isCaseSensitive,ignoreLocation:d=fe.ignoreLocation}={}){if(this.options={location:n,threshold:i,distance:s,includeMatches:a,findAllMatches:l,minMatchCharLength:r,isCaseSensitive:u,ignoreLocation:d},this.pattern=u?t:t.toLowerCase(),this.chunks=[],!this.pattern.length)return;const p=(f,h)=>{this.chunks.push({pattern:f,alphabet:aw(f),startIndex:h})},m=this.pattern.length;if(m>no){let f=0;const h=m%no,v=m-h;for(;f<v;)p(this.pattern.substr(f,no),f),f+=no;if(h){const S=m-no;p(this.pattern.substr(S),S)}}else p(this.pattern,0)}searchIn(t){const{isCaseSensitive:n,includeMatches:i}=this.options;if(n||(t=t.toLowerCase()),this.pattern===t){let v={isMatch:!0,score:0};return i&&(v.indices=[[0,t.length-1]]),v}const{location:s,distance:a,threshold:l,findAllMatches:r,minMatchCharLength:u,ignoreLocation:d}=this.options;let p=[],m=0,f=!1;this.chunks.forEach(({pattern:v,alphabet:S,startIndex:x})=>{const{isMatch:k,score:C,indices:b}=sw(t,v,S,{location:s+x,distance:a,threshold:l,findAllMatches:r,minMatchCharLength:u,includeMatches:i,ignoreLocation:d});k&&(f=!0),m+=C,k&&b&&(p=[...p,...b])});let h={isMatch:f,score:f?m/this.chunks.length:1};return f&&i&&(h.indices=p),h}}class qn{constructor(t){this.pattern=t}static isMultiMatch(t){return Au(t,this.multiRegex)}static isSingleMatch(t){return Au(t,this.singleRegex)}search(){}}function Au(e,t){const n=e.match(t);return n?n[1]:null}class lw extends qn{constructor(t){super(t)}static get type(){return"exact"}static get multiRegex(){return/^="(.*)"$/}static get singleRegex(){return/^=(.*)$/}search(t){const n=t===this.pattern;return{isMatch:n,score:n?0:1,indices:[0,this.pattern.length-1]}}}class rw extends qn{constructor(t){super(t)}static get type(){return"inverse-exact"}static get multiRegex(){return/^!"(.*)"$/}static get singleRegex(){return/^!(.*)$/}search(t){const i=t.indexOf(this.pattern)===-1;return{isMatch:i,score:i?0:1,indices:[0,t.length-1]}}}class cw extends qn{constructor(t){super(t)}static get type(){return"prefix-exact"}static get multiRegex(){return/^\^"(.*)"$/}static get singleRegex(){return/^\^(.*)$/}search(t){const n=t.startsWith(this.pattern);return{isMatch:n,score:n?0:1,indices:[0,this.pattern.length-1]}}}class uw extends qn{constructor(t){super(t)}static get type(){return"inverse-prefix-exact"}static get multiRegex(){return/^!\^"(.*)"$/}static get singleRegex(){return/^!\^(.*)$/}search(t){const n=!t.startsWith(this.pattern);return{isMatch:n,score:n?0:1,indices:[0,t.length-1]}}}class dw extends qn{constructor(t){super(t)}static get type(){return"suffix-exact"}static get multiRegex(){return/^"(.*)"\$$/}static get singleRegex(){return/^(.*)\$$/}search(t){const n=t.endsWith(this.pattern);return{isMatch:n,score:n?0:1,indices:[t.length-this.pattern.length,t.length-1]}}}class pw extends qn{constructor(t){super(t)}static get type(){return"inverse-suffix-exact"}static get multiRegex(){return/^!"(.*)"\$$/}static get singleRegex(){return/^!(.*)\$$/}search(t){const n=!t.endsWith(this.pattern);return{isMatch:n,score:n?0:1,indices:[0,t.length-1]}}}class Lm extends qn{constructor(t,{location:n=fe.location,threshold:i=fe.threshold,distance:s=fe.distance,includeMatches:a=fe.includeMatches,findAllMatches:l=fe.findAllMatches,minMatchCharLength:r=fe.minMatchCharLength,isCaseSensitive:u=fe.isCaseSensitive,ignoreLocation:d=fe.ignoreLocation}={}){super(t),this._bitapSearch=new Km(t,{location:n,threshold:i,distance:s,includeMatches:a,findAllMatches:l,minMatchCharLength:r,isCaseSensitive:u,ignoreLocation:d})}static get type(){return"fuzzy"}static get multiRegex(){return/^"(.*)"$/}static get singleRegex(){return/^(.*)$/}search(t){return this._bitapSearch.searchIn(t)}}class Rm extends qn{constructor(t){super(t)}static get type(){return"include"}static get multiRegex(){return/^'"(.*)"$/}static get singleRegex(){return/^'(.*)$/}search(t){let n=0,i;const s=[],a=this.pattern.length;for(;(i=t.indexOf(this.pattern,n))>-1;)n=i+a,s.push([i,n-1]);const l=!!s.length;return{isMatch:l,score:l?0:1,indices:s}}}const Pl=[lw,Rm,cw,uw,pw,dw,rw,Lm],Pu=Pl.length,mw=/ +(?=(?:[^\"]*\"[^\"]*\")*[^\"]*$)/,fw="|";function hw(e,t={}){return e.split(fw).map(n=>{let i=n.trim().split(mw).filter(a=>a&&!!a.trim()),s=[];for(let a=0,l=i.length;a<l;a+=1){const r=i[a];let u=!1,d=-1;for(;!u&&++d<Pu;){const p=Pl[d];let m=p.isMultiMatch(r);m&&(s.push(new p(m,t)),u=!0)}if(!u)for(d=-1;++d<Pu;){const p=Pl[d];let m=p.isSingleMatch(r);if(m){s.push(new p(m,t));break}}}return s})}const vw=new Set([Lm.type,Rm.type]);class _w{constructor(t,{isCaseSensitive:n=fe.isCaseSensitive,includeMatches:i=fe.includeMatches,minMatchCharLength:s=fe.minMatchCharLength,ignoreLocation:a=fe.ignoreLocation,findAllMatches:l=fe.findAllMatches,location:r=fe.location,threshold:u=fe.threshold,distance:d=fe.distance}={}){this.query=null,this.options={isCaseSensitive:n,includeMatches:i,minMatchCharLength:s,findAllMatches:l,ignoreLocation:a,location:r,threshold:u,distance:d},this.pattern=n?t:t.toLowerCase(),this.query=hw(this.pattern,this.options)}static condition(t,n){return n.useExtendedSearch}searchIn(t){const n=this.query;if(!n)return{isMatch:!1,score:1};const{includeMatches:i,isCaseSensitive:s}=this.options;t=s?t:t.toLowerCase();let a=0,l=[],r=0;for(let u=0,d=n.length;u<d;u+=1){const p=n[u];l.length=0,a=0;for(let m=0,f=p.length;m<f;m+=1){const h=p[m],{isMatch:v,indices:S,score:x}=h.search(t);if(v){if(a+=1,r+=x,i){const k=h.constructor.type;vw.has(k)?l=[...l,...S]:l.push(S)}}else{r=0,a=0,l.length=0;break}}if(a){let m={isMatch:!0,score:r/a};return i&&(m.indices=l),m}}return{isMatch:!1,score:1}}}const Kl=[];function gw(...e){Kl.push(...e)}function Ll(e,t){for(let n=0,i=Kl.length;n<i;n+=1){let s=Kl[n];if(s.condition(e,t))return new s(e,t)}return new Km(e,t)}const Vs={AND:"$and",OR:"$or"},Rl={PATH:"$path",PATTERN:"$val"},Hl=e=>!!(e[Vs.AND]||e[Vs.OR]),bw=e=>!!e[Rl.PATH],yw=e=>!_n(e)&&Om(e)&&!Hl(e),Ku=e=>({[Vs.AND]:Object.keys(e).map(t=>({[t]:e[t]}))});function Hm(e,t,{auto:n=!0}={}){const i=s=>{let a=Object.keys(s);const l=bw(s);if(!l&&a.length>1&&!Hl(s))return i(Ku(s));if(yw(s)){const u=l?s[Rl.PATH]:a[0],d=l?s[Rl.PATTERN]:s[u];if(!tn(d))throw new Error(VS(u));const p={keyId:Al(u),pattern:d};return n&&(p.searcher=Ll(d,t)),p}let r={children:[],operator:a[0]};return a.forEach(u=>{const d=s[u];_n(d)&&d.forEach(p=>{r.children.push(i(p))})}),r};return Hl(e)||(e=Ku(e)),i(e)}function Sw(e,{ignoreFieldNorm:t=fe.ignoreFieldNorm}){e.forEach(n=>{let i=1;n.matches.forEach(({key:s,norm:a,score:l})=>{const r=s?s.weight:null;i*=Math.pow(l===0&&r?Number.EPSILON:l,(r||1)*(t?1:a))}),n.score=i})}function ww(e,t){const n=e.matches;t.matches=[],It(n)&&n.forEach(i=>{if(!It(i.indices)||!i.indices.length)return;const{indices:s,value:a}=i;let l={indices:s,value:a};i.key&&(l.key=i.key.src),i.idx>-1&&(l.refIndex=i.idx),t.matches.push(l)})}function xw(e,t){t.score=e.score}function kw(e,t,{includeMatches:n=fe.includeMatches,includeScore:i=fe.includeScore}={}){const s=[];return n&&s.push(ww),i&&s.push(xw),e.map(a=>{const{idx:l}=a,r={item:t[l],refIndex:l};return s.length&&s.forEach(u=>{u(a,r)}),r})}class qo{constructor(t,n={},i){this.options={...fe,...n},this.options.useExtendedSearch,this._keyStore=new QS(this.options.keys),this.setCollection(t,i)}setCollection(t,n){if(this._docs=t,n&&!(n instanceof Or))throw new Error(jS);this._myIndex=n||Pm(this.options.keys,this._docs,{getFn:this.options.getFn,fieldNormWeight:this.options.fieldNormWeight})}add(t){It(t)&&(this._docs.push(t),this._myIndex.add(t))}remove(t=()=>!1){const n=[];for(let i=0,s=this._docs.length;i<s;i+=1){const a=this._docs[i];t(a,i)&&(this.removeAt(i),i-=1,s-=1,n.push(a))}return n}removeAt(t){this._docs.splice(t,1),this._myIndex.removeAt(t)}getIndex(){return this._myIndex}search(t,{limit:n=-1}={}){const{includeMatches:i,includeScore:s,shouldSort:a,sortFn:l,ignoreFieldNorm:r}=this.options;let u=tn(t)?tn(this._docs[0])?this._searchStringList(t):this._searchObjectList(t):this._searchLogical(t);return Sw(u,{ignoreFieldNorm:r}),a&&u.sort(l),Em(n)&&n>-1&&(u=u.slice(0,n)),kw(u,this._docs,{includeMatches:i,includeScore:s})}_searchStringList(t){const n=Ll(t,this.options),{records:i}=this._myIndex,s=[];return i.forEach(({v:a,i:l,n:r})=>{if(!It(a))return;const{isMatch:u,score:d,indices:p}=n.searchIn(a);u&&s.push({item:a,idx:l,matches:[{score:d,value:a,norm:r,indices:p}]})}),s}_searchLogical(t){const n=Hm(t,this.options),i=(r,u,d)=>{if(!r.children){const{keyId:m,searcher:f}=r,h=this._findMatches({key:this._keyStore.get(m),value:this._myIndex.getValueForItemAtKeyId(u,m),searcher:f});return h&&h.length?[{idx:d,item:u,matches:h}]:[]}const p=[];for(let m=0,f=r.children.length;m<f;m+=1){const h=r.children[m],v=i(h,u,d);if(v.length)p.push(...v);else if(r.operator===Vs.AND)return[]}return p},s=this._myIndex.records,a={},l=[];return s.forEach(({$:r,i:u})=>{if(It(r)){let d=i(n,r,u);d.length&&(a[u]||(a[u]={idx:u,item:r,matches:[]},l.push(a[u])),d.forEach(({matches:p})=>{a[u].matches.push(...p)}))}}),l}_searchObjectList(t){const n=Ll(t,this.options),{keys:i,records:s}=this._myIndex,a=[];return s.forEach(({$:l,i:r})=>{if(!It(l))return;let u=[];i.forEach((d,p)=>{u.push(...this._findMatches({key:d,value:l[p],searcher:n}))}),u.length&&a.push({idx:r,item:l,matches:u})}),a}_findMatches({key:t,value:n,searcher:i}){if(!It(n))return[];let s=[];if(_n(n))n.forEach(({v:a,i:l,n:r})=>{if(!It(a))return;const{isMatch:u,score:d,indices:p}=i.searchIn(a);u&&s.push({score:d,key:t,value:a,idx:l,norm:r,indices:p})});else{const{v:a,n:l}=n,{isMatch:r,score:u,indices:d}=i.searchIn(a);r&&s.push({score:u,key:t,value:a,norm:l,indices:d})}return s}}qo.version="6.6.2";qo.createIndex=Pm;qo.parseIndex=ow;qo.config=fe;qo.parseQuery=Hm;gw(_w);const $w={class:"bg-main transform",shadow:"~",p:"x-4 y-2",border:"~ transparent rounded dark:main"},zw=["value","disabled","onKeydown"],Iw=["border","onClick"],Cw={"w-4":"","text-right":"",op50:"","text-sm":""},Tw=Pe({__name:"Goto",setup(e){$(I);const t=Z(),n=Z(),i=Z(),s=Z(),a=Z(""),l=Z(0);function r(b){return b!=null}const u=N(()=>new qo(Qe.map(b=>{var K;return(K=b.meta)==null?void 0:K.slide}).filter(r),{keys:["no","title"],threshold:.3,shouldSort:!0,minMatchCharLength:1})),d=N(()=>a.value.startsWith("/")?a.value.substring(1):a.value),p=N(()=>u.value.search(d.value).map(b=>b.item)),m=N(()=>!!p.value.length);function f(){if(m.value){const b=p.value.at(l.value||0);b&&Wo(b.no)}h()}function h(){a.value="",Eo.value=!1}function v(b){b.preventDefault(),l.value++,l.value>=p.value.length&&(l.value=0),x()}function S(b){b.preventDefault(),l.value--,l.value<=-2&&(l.value=p.value.length-1),x()}function x(){var K;const b=(K=s.value)==null?void 0:K[l.value];b&&i.value&&(b.offsetTop+b.offsetHeight>i.value.offsetHeight+i.value.scrollTop?i.value.scrollTo({behavior:"smooth",top:b.offsetTop+b.offsetHeight-i.value.offsetHeight+1}):b.offsetTop<i.value.scrollTop&&i.value.scrollTo({behavior:"smooth",top:b.offsetTop}))}function k(b){l.value=0,a.value=b.target.value}function C(b){Wo(b),h()}return ge(Eo,async b=>{var K;b?(a.value="",l.value=0,setTimeout(()=>{var A;return(A=n.value)==null?void 0:A.focus()},0)):(K=n.value)==null||K.blur()}),ge(Pn,()=>{var b;(b=t.value)!=null&&b.contains(Pn.value)||h()}),(b,K)=>(g(),ie("div",{id:"slidev-goto-dialog",ref_key:"container",ref:t,class:Ve(["fixed right-5 transition-all",L(Eo)?"top-5":"-top-20"]),"w-90":""},[o("div",$w,[o("input",{ref_key:"input",ref:n,value:a.value,type:"text",disabled:!L(Eo),class:Ve(["outline-none bg-transparent",{"text-red-400":!m.value&&a.value}]),placeholder:"Goto...",onKeydown:[is(f,["enter"]),is(h,["escape"]),is(v,["down"]),is(S,["up"])],onInput:k},null,42,zw)]),p.value.length>0?(g(),ie("ul",{key:0,ref_key:"list",ref:i,class:"autocomplete-list",shadow:"~",border:"~ transparent rounded dark:main"},[(g(!0),ie(Oe,null,No(p.value,(A,R)=>(g(),ie("li",{ref_for:!0,ref_key:"items",ref:s,key:A.id,role:"button",tabindex:"0",p:"x-4 y-2","cursor-pointer":"",hover:"op100",flex:"~ gap-2","items-center":"",border:R===0?"":"t main",class:Ve(l.value===R?"bg-active op100":"op80"),onClick:dg(F=>C(A.no),["stop"])},[o("div",Cw,gt(A.no),1),c(" "+gt(A.title),1)],10,Iw))),128))],512)):Se("v-if",!0)],2))}});const Ew=T(Tw,[["__scopeId","data-v-f5ee02a7"],["__file","/home/antonio/WORK/ITI_Agnelli/Materie/slidev/node_modules/@slidev/client/internals/Goto.vue"]]),Ow=Pe({__name:"Controls",setup(e){$(I);const t=sn(),n=sn();return(i,s)=>(g(),ie(Oe,null,[j(TS,{modelValue:L(ut),"onUpdate:modelValue":s[0]||(s[0]=a=>Me(ut)?ut.value=a:null)},null,8,["modelValue"]),j(Ew),t.value?(g(),z(L(t),{key:0})):Se("v-if",!0),n.value?(g(),z(L(n),{key:1,modelValue:L(Pa),"onUpdate:modelValue":s[1]||(s[1]=a=>Me(Pa)?Pa.value=a:null)},null,8,["modelValue"])):Se("v-if",!0),L(Ee).info?(g(),z(HS,{key:2,modelValue:L(_i),"onUpdate:modelValue":s[2]||(s[2]=a=>Me(_i)?_i.value=a:null)},null,8,["modelValue"])):Se("v-if",!0)],64))}}),Mw=T(Ow,[["__file","/home/antonio/WORK/ITI_Agnelli/Materie/slidev/node_modules/@slidev/client/internals/Controls.vue"]]),Aw={class:"slidev-icon",viewBox:"0 0 32 32",width:"1.2em",height:"1.2em"},Pw=o("path",{fill:"currentColor",d:"M30 8h-4.1c-.5-2.3-2.5-4-4.9-4s-4.4 1.7-4.9 4H2v2h14.1c.5 2.3 2.5 4 4.9 4s4.4-1.7 4.9-4H30V8zm-9 4c-1.7 0-3-1.3-3-3s1.3-3 3-3s3 1.3 3 3s-1.3 3-3 3zM2 24h4.1c.5 2.3 2.5 4 4.9 4s4.4-1.7 4.9-4H30v-2H15.9c-.5-2.3-2.5-4-4.9-4s-4.4 1.7-4.9 4H2v2zm9-4c1.7 0 3 1.3 3 3s-1.3 3-3 3s-3-1.3-3-3s1.3-3 3-3z"},null,-1),Kw=[Pw];function Lw(e,t){return g(),ie("svg",Aw,Kw)}const Rw={name:"carbon-settings-adjust",render:Lw},Hw={class:"slidev-icon",viewBox:"0 0 32 32",width:"1.2em",height:"1.2em"},Ww=o("path",{fill:"currentColor",d:"M17 22v-8h-4v2h2v6h-3v2h8v-2h-3zM16 8a1.5 1.5 0 1 0 1.5 1.5A1.5 1.5 0 0 0 16 8z"},null,-1),Nw=o("path",{fill:"currentColor",d:"M16 30a14 14 0 1 1 14-14a14 14 0 0 1-14 14Zm0-26a12 12 0 1 0 12 12A12 12 0 0 0 16 4Z"},null,-1),Dw=[Ww,Nw];function qw(e,t){return g(),ie("svg",Hw,Dw)}const Fw={name:"carbon-information",render:qw},jw={class:"slidev-icon",viewBox:"0 0 32 32",width:"1.2em",height:"1.2em"},Vw=o("path",{fill:"currentColor",d:"M26 24v4H6v-4H4v4a2 2 0 0 0 2 2h20a2 2 0 0 0 2-2v-4zm0-10l-1.41-1.41L17 20.17V2h-2v18.17l-7.59-7.58L6 14l10 10l10-10z"},null,-1),Bw=[Vw];function Uw(e,t){return g(),ie("svg",jw,Bw)}const Jw={name:"carbon-download",render:Uw},Qw={class:"slidev-icon",viewBox:"0 0 32 32",width:"1.2em",height:"1.2em"},Yw=o("path",{fill:"currentColor",d:"M29.415 19L27.7 17.285A2.97 2.97 0 0 0 28 16a3 3 0 1 0-3 3a2.97 2.97 0 0 0 1.286-.3L28 20.414V28h-6v-3a7.008 7.008 0 0 0-7-7H9a7.008 7.008 0 0 0-7 7v5h28v-9.586A1.988 1.988 0 0 0 29.415 19ZM4 25a5.006 5.006 0 0 1 5-5h6a5.006 5.006 0 0 1 5 5v3H4Z"},null,-1),Zw=o("path",{fill:"currentColor",d:"M12 4a5 5 0 1 1-5 5a5 5 0 0 1 5-5m0-2a7 7 0 1 0 7 7a7 7 0 0 0-7-7Z"},null,-1),Gw=[Yw,Zw];function Xw(e,t){return g(),ie("svg",Qw,Gw)}const ex={name:"carbon-user-speaker",render:Xw},tx={class:"slidev-icon",viewBox:"0 0 32 32",width:"1.2em",height:"1.2em"},nx=o("path",{fill:"currentColor",d:"M15 10h2v8h-2zm5 4h2v4h-2zm-10-2h2v6h-2z"},null,-1),ox=o("path",{fill:"currentColor",d:"M25 4h-8V2h-2v2H7a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h8v6h-4v2h10v-2h-4v-6h8a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2Zm0 16H7V6h18Z"},null,-1),ix=[nx,ox];function sx(e,t){return g(),ie("svg",tx,ix)}const ax={name:"carbon-presentation-file",render:sx},lx={class:"slidev-icon",viewBox:"0 0 32 32",width:"1.2em",height:"1.2em"},rx=o("path",{fill:"currentColor",d:"M27.307 6.107L30 3.414L28.586 2l-2.693 2.693L24.8 3.6a1.933 1.933 0 0 0-2.8 0l-18 18V28h6.4l18-18a1.933 1.933 0 0 0 0-2.8ZM9.6 26H6v-3.6L23.4 5L27 8.6ZM9 11.586L16.586 4L18 5.414L10.414 13z"},null,-1),cx=[rx];function ux(e,t){return g(),ie("svg",lx,cx)}const dx={name:"carbon-pen",render:ux},px={class:"slidev-icon",viewBox:"0 0 256 256",width:"1.2em",height:"1.2em"},mx=o("g",{fill:"currentColor"},[o("path",{d:"M213.66 201L201 213.66a8 8 0 0 1-11.31 0L140 164a8 8 0 0 0-13 2.46l-19.46 44.77a8 8 0 0 1-14.85-.71L40.41 50.44a8 8 0 0 1 10-10l160.1 52.24a8 8 0 0 1 .71 14.85L166.45 127a8 8 0 0 0-2.45 13l49.67 49.67a8 8 0 0 1-.01 11.33Z",opacity:".2"}),o("path",{d:"m169.64 134.33l44.77-19.46a16 16 0 0 0-1.41-29.8L52.92 32.8A16 16 0 0 0 32.8 52.92L85.07 213a15.83 15.83 0 0 0 14.41 11h.78a15.83 15.83 0 0 0 14.61-9.59l19.46-44.77L184 219.31a16 16 0 0 0 22.63 0l12.68-12.68a16 16 0 0 0 0-22.63Zm-69.48 73.76l.06-.05Zm95.15-.09l-49.67-49.67a16 16 0 0 0-26 4.94l-19.42 44.65L48 48l159.87 52.21l-44.64 19.41a16 16 0 0 0-4.94 26L208 195.31Z"})],-1),fx=[mx];function hx(e,t){return g(),ie("svg",px,fx)}const vx={name:"ph-cursor-duotone",render:hx},_x={class:"slidev-icon",viewBox:"0 0 256 256",width:"1.2em",height:"1.2em"},gx=o("path",{fill:"currentColor",d:"M219.31 192a16 16 0 0 1 0 22.63l-4.68 4.68a16 16 0 0 1-22.63 0l-55.25-55.24l-21.88 50.34a15.84 15.84 0 0 1-14.61 9.59h-.78a15.82 15.82 0 0 1-14.41-11L32.8 52.92A15.95 15.95 0 0 1 52.92 32.8L213 85.07a16 16 0 0 1 1.41 29.8l-50.34 21.88Z"},null,-1),bx=[gx];function yx(e,t){return g(),ie("svg",_x,bx)}const Wm={name:"ph-cursor-fill",render:yx},Sx={class:"slidev-icon",viewBox:"0 0 32 32",width:"1.2em",height:"1.2em"},wx=o("path",{fill:"currentColor",d:"M16 12.005a4 4 0 1 1-4 4a4.005 4.005 0 0 1 4-4m0-2a6 6 0 1 0 6 6a6 6 0 0 0-6-6ZM5.394 6.813L6.81 5.399l3.505 3.506L8.9 10.319zM2 15.005h5v2H2zm3.394 10.193L8.9 21.692l1.414 1.414l-3.505 3.506zM15 25.005h2v5h-2zm6.687-1.9l1.414-1.414l3.506 3.506l-1.414 1.414zm3.313-8.1h5v2h-5zm-3.313-6.101l3.506-3.506l1.414 1.414l-3.506 3.506zM15 2.005h2v5h-2z"},null,-1),xx=[wx];function kx(e,t){return g(),ie("svg",Sx,xx)}const $x={name:"carbon-sun",render:kx},zx={class:"slidev-icon",viewBox:"0 0 32 32",width:"1.2em",height:"1.2em"},Ix=o("path",{fill:"currentColor",d:"M13.502 5.414a15.075 15.075 0 0 0 11.594 18.194a11.113 11.113 0 0 1-7.975 3.39c-.138 0-.278.005-.418 0a11.094 11.094 0 0 1-3.2-21.584M14.98 3a1.002 1.002 0 0 0-.175.016a13.096 13.096 0 0 0 1.825 25.981c.164.006.328 0 .49 0a13.072 13.072 0 0 0 10.703-5.555a1.01 1.01 0 0 0-.783-1.565A13.08 13.08 0 0 1 15.89 4.38A1.015 1.015 0 0 0 14.98 3Z"},null,-1),Cx=[Ix];function Tx(e,t){return g(),ie("svg",zx,Cx)}const Ex={name:"carbon-moon",render:Tx},Ox={class:"slidev-icon",viewBox:"0 0 32 32",width:"1.2em",height:"1.2em"},Mx=o("path",{fill:"currentColor",d:"M8 4v4H4V4Zm2-2H2v8h8Zm8 2v4h-4V4Zm2-2h-8v8h8Zm8 2v4h-4V4Zm2-2h-8v8h8ZM8 14v4H4v-4Zm2-2H2v8h8Zm8 2v4h-4v-4Zm2-2h-8v8h8Zm8 2v4h-4v-4Zm2-2h-8v8h8ZM8 24v4H4v-4Zm2-2H2v8h8Zm8 2v4h-4v-4Zm2-2h-8v8h8Zm8 2v4h-4v-4Zm2-2h-8v8h8Z"},null,-1),Ax=[Mx];function Px(e,t){return g(),ie("svg",Ox,Ax)}const Kx={name:"carbon-apps",render:Px},Lx={class:"slidev-icon",viewBox:"0 0 32 32",width:"1.2em",height:"1.2em"},Rx=o("path",{fill:"currentColor",d:"m18 6l-1.43 1.393L24.15 15H4v2h20.15l-7.58 7.573L18 26l10-10L18 6z"},null,-1),Hx=[Rx];function Wx(e,t){return g(),ie("svg",Lx,Hx)}const Nm={name:"carbon-arrow-right",render:Wx},Nx={class:"slidev-icon",viewBox:"0 0 32 32",width:"1.2em",height:"1.2em"},Dx=o("path",{fill:"currentColor",d:"m14 26l1.41-1.41L7.83 17H28v-2H7.83l7.58-7.59L14 6L4 16l10 10z"},null,-1),qx=[Dx];function Fx(e,t){return g(),ie("svg",Nx,qx)}const jx={name:"carbon-arrow-left",render:Fx},Vx={class:"slidev-icon",viewBox:"0 0 32 32",width:"1.2em",height:"1.2em"},Bx=o("path",{fill:"currentColor",d:"M20 2v2h6.586L18 12.582L19.414 14L28 5.414V12h2V2H20zm-6 17.416L12.592 18L4 26.586V20H2v10h10v-2H5.414L14 19.416z"},null,-1),Ux=[Bx];function Jx(e,t){return g(),ie("svg",Vx,Ux)}const Qx={name:"carbon-maximize",render:Jx},Yx={class:"slidev-icon",viewBox:"0 0 32 32",width:"1.2em",height:"1.2em"},Zx=o("path",{fill:"currentColor",d:"M4 18v2h6.586L2 28.582L3.414 30L12 21.414V28h2V18H4zM30 3.416L28.592 2L20 10.586V4h-2v10h10v-2h-6.586L30 3.416z"},null,-1),Gx=[Zx];function Xx(e,t){return g(),ie("svg",Yx,Gx)}const ek={name:"carbon-minimize",render:Xx},tk={class:"slidev-icon",viewBox:"0 0 32 32",width:"1.2em",height:"1.2em"},nk=o("path",{fill:"currentColor",d:"m13 24l-9-9l1.414-1.414L13 21.171L26.586 7.586L28 9L13 24z"},null,-1),ok=[nk];function ik(e,t){return g(),ie("svg",tk,ok)}const sk={name:"carbon-checkmark",render:ik},ak={class:"select-list"},lk={class:"title"},rk={class:"items"},ck=["onClick"],uk=Pe({__name:"SelectList",props:{modelValue:{type:[Object,String,Number]},title:{type:String},items:{type:Array}},setup(e,{emit:t}){const n=e;$(I);const i=Kt(n,"modelValue",t,{passive:!0});return(s,a)=>{const l=sk;return g(),ie("div",ak,[o("div",lk,gt(e.title),1),o("div",rk,[(g(!0),ie(Oe,null,No(e.items,r=>(g(),ie("div",{key:r.value,class:Ve(["item",{active:L(i)===r.value}]),onClick:()=>{var u;i.value=r.value,(u=r.onClick)==null||u.call(r)}},[j(l,{class:Ve(["text-green-500",{"opacity-0":L(i)!==r.value}])},null,8,["class"]),c(" "+gt(r.display||r.value),1)],10,ck))),128))])])}}});const dk=T(uk,[["__scopeId","data-v-3f89fa11"],["__file","/home/antonio/WORK/ITI_Agnelli/Materie/slidev/node_modules/@slidev/client/internals/SelectList.vue"]]),pk={class:"text-sm"},mk=Pe({__name:"Settings",setup(e){$(I);const t=[{display:"Fit",value:0},{display:"1:1",value:1}];return(n,i)=>(g(),ie("div",pk,[j(dk,{modelValue:L(bs),"onUpdate:modelValue":i[0]||(i[0]=s=>Me(bs)?bs.value=s:null),title:"Scale",items:t},null,8,["modelValue"])]))}}),fk=T(mk,[["__file","/home/antonio/WORK/ITI_Agnelli/Materie/slidev/node_modules/@slidev/client/internals/Settings.vue"]]),hk={key:0,class:"rounded-md bg-main shadow absolute bottom-10 left-0 z-20","dark:border":"~ main"},vk=Pe({__name:"MenuButton",props:{modelValue:{default:!1},disabled:{default:!1}},setup(e,{emit:t}){const n=e;$(I);const i=Kt(n,"modelValue",t,{passive:!0}),s=Z();return l0(s,()=>{i.value=!1}),(a,l)=>(g(),ie("div",{ref_key:"el",ref:s,class:"flex relative"},[o("button",{class:Ve({disabled:e.disabled}),onClick:l[0]||(l[0]=r=>i.value=!L(i))},[Bt(a.$slots,"button",{class:Ve({disabled:e.disabled})})],2),(g(),z(ip,null,[L(i)?(g(),ie("div",hk,[Bt(a.$slots,"menu")])):Se("v-if",!0)],1024))],512))}}),_k=T(vk,[["__file","/home/antonio/WORK/ITI_Agnelli/Materie/slidev/node_modules/@slidev/client/internals/MenuButton.vue"]]),gk={class:"w-1px opacity-10 bg-current m-1 lg:m-2"},bk={__name:"VerticalDivider",setup(e){return $(I),(t,n)=>(g(),ie("div",gk))}},ps=T(bk,[["__file","/home/antonio/WORK/ITI_Agnelli/Materie/slidev/node_modules/@slidev/client/internals/VerticalDivider.vue"]]),yk={render(){return[]}},Sk={class:"slidev-icon-btn"},wk={class:"h-40px flex",p:"l-1 t-0.5 r-2",text:"sm leading-2"},xk={class:"my-auto"},kk={class:"opacity-50"},$k=Pe({__name:"NavControls",props:{persist:{default:!1}},setup(e){const t=e;$(I);const n=Cl.smaller("md"),{isFullscreen:i,toggle:s}=ym,a=N(()=>Nl.value?`?password=${Nl.value}`:""),l=N(()=>`/presenter/${Be.value}${a.value}`),r=N(()=>`/${Be.value}${a.value}`),u=Z();function d(){u.value&&Pn.value&&u.value.contains(Pn.value)&&Pn.value.blur()}const p=N(()=>t.persist?"text-$slidev-controls-foreground bg-transparent":"rounded-md bg-main shadow dark:border dark:border-gray-400 dark:border-opacity-10"),m=sn(),f=sn();return An(()=>import("./DrawingControls-b66013c2.js"),[]).then(h=>f.value=h.default),(h,v)=>{const S=ek,x=Qx,k=jx,C=Nm,b=Kx,K=Ex,A=$x,R=Wm,F=vx,W=dx,U=ax,se=Ps("RouterLink"),de=ex,G=Jw,_e=Fw,be=Rw;return g(),ie("nav",{ref_key:"root",ref:u,class:"flex flex-col"},[o("div",{class:Ve(["flex flex-wrap-reverse text-xl gap-0.5 p-1 lg:gap-1 lg:p-2",p.value]),onMouseleave:d},[L(pn)?Se("v-if",!0):(g(),ie("button",{key:0,class:"slidev-icon-btn",onClick:v[0]||(v[0]=(...we)=>L(s)&&L(s)(...we))},[L(i)?(g(),z(S,{key:0})):(g(),z(x,{key:1}))])),o("button",{class:Ve(["slidev-icon-btn",{disabled:!L(lW)}]),onClick:v[1]||(v[1]=(...we)=>L(Ln)&&L(Ln)(...we))},[j(k)],2),o("button",{class:Ve(["slidev-icon-btn",{disabled:!L(aW)}]),title:"Next",onClick:v[2]||(v[2]=(...we)=>L(Kn)&&L(Kn)(...we))},[j(C)],2),L(pn)?Se("v-if",!0):(g(),ie("button",{key:1,class:"slidev-icon-btn",title:"Slides overview",onClick:v[3]||(v[3]=we=>L(Sm)())},[j(b)])),L(Ml)?Se("v-if",!0):(g(),ie("button",{key:2,class:"slidev-icon-btn",title:"Toggle dark mode",onClick:v[4]||(v[4]=we=>L(zm)())},[L(Ir)?(g(),z(K,{key:0})):(g(),z(A,{key:1}))])),j(ps),L(pn)?Se("v-if",!0):(g(),ie(Oe,{key:3},[!L(_t)&&!L(n)&&m.value?(g(),ie(Oe,{key:0},[j(L(m)),j(ps)],64)):Se("v-if",!0),L(_t)?(g(),ie("button",{key:1,class:"slidev-icon-btn",title:"Show presenter cursor",onClick:v[5]||(v[5]=we=>Ka.value=!L(Ka))},[L(Ka)?(g(),z(R,{key:0})):(g(),z(F,{key:1,class:"opacity-50"}))])):Se("v-if",!0)],64)),(!L(Ee).drawings.presenterOnly||L(_t))&&!L(pn)?(g(),ie(Oe,{key:4},[o("button",{class:"slidev-icon-btn relative",title:"Drawing",onClick:v[6]||(v[6]=we=>en.value=!L(en))},[j(W),L(en)?(g(),ie("div",{key:0,class:"absolute left-1 right-1 bottom-0 h-0.7 rounded-full",style:tt({background:L(so).color})},null,4)):Se("v-if",!0)]),j(ps)],64)):Se("v-if",!0),L(pn)?Se("v-if",!0):(g(),ie(Oe,{key:5},[L(_t)?(g(),z(se,{key:0,to:r.value,class:"slidev-icon-btn",title:"Play Mode"},{default:w(()=>[j(U)]),_:1},8,["to"])):Se("v-if",!0),L(tW)?(g(),z(se,{key:1,to:l.value,class:"slidev-icon-btn",title:"Presenter Mode"},{default:w(()=>[j(de)]),_:1},8,["to"])):Se("v-if",!0),Se("v-if",!0)],64)),(g(),ie(Oe,{key:6},[L(Ee).download?(g(),ie("button",{key:0,class:"slidev-icon-btn",onClick:v[8]||(v[8]=(...we)=>L(Dl)&&L(Dl)(...we))},[j(G)])):Se("v-if",!0)],64)),!L(_t)&&L(Ee).info&&!L(pn)?(g(),ie("button",{key:7,class:"slidev-icon-btn",onClick:v[9]||(v[9]=we=>_i.value=!L(_i))},[j(_e)])):Se("v-if",!0),!L(_t)&&!L(pn)?(g(),z(_k,{key:8},{button:w(()=>[o("button",Sk,[j(be)])]),menu:w(()=>[j(fk)]),_:1})):Se("v-if",!0),L(pn)?Se("v-if",!0):(g(),z(ps,{key:9})),o("div",wk,[o("div",xk,[c(gt(L(Be))+" ",1),o("span",kk,"/ "+gt(L(nW)),1)])]),j(L(yk))],34)],512)}}}),zk=T($k,[["__file","/home/antonio/WORK/ITI_Agnelli/Materie/slidev/node_modules/@slidev/client/internals/NavControls.vue"]]),Ik={style:{"font-size":"0.55rem","line-height":"1rem"}},Ck=o("div",{class:"absolute bottom-0 left-1"},[o("img",{src:"https://agnelli.it/wp-content/uploads/2021/02/logo_agnelli.png",width:"60"})],-1),Tk={class:"absolute bottom-1 left-89 text-gray-700"},Ek={key:0,class:"absolute bottom-1 right-1 text-gray-700"},Ok={__name:"global-top",setup(e){const t=$(I);return(n,i)=>(g(),ie("footer",Ik,[Ck,o("div",Tk," ITT E.Agnelli - Informatica - "+gt(L(t).configs.materia)+" - prof. Antonio Mancuso - a.s. "+gt(L(t).configs.as)+" - v "+gt(L(t).configs.version||0),1),L(t).nav.currentPage!==1&&L(t).nav.currentPage!=L(t).nav.total+1?(g(),ie("div",Ek,gt(L(t).nav.currentPage-1)+" / "+gt(L(t).nav.total-1),1)):Se("v-if",!0)]))}},Mk=T(Ok,[["__file","/home/antonio/WORK/ITI_Agnelli/Materie/slidev/global-top.vue"]]),Dm={render(){return[St(Mk)]}},qm={render(){return[]}},Ak={key:0,class:"absolute top-0 left-0 right-0 bottom-0 pointer-events-none text-xl"},Pk=Pe({__name:"PresenterMouse",setup(e){return $(I),(t,n)=>{const i=Wm;return L(Ea).cursor?(g(),ie("div",Ak,[j(i,{class:"absolute",style:tt({left:`${L(Ea).cursor.x}%`,top:`${L(Ea).cursor.y}%`})},null,8,["style"])])):Se("v-if",!0)}}}),Kk=T(Pk,[["__file","/home/antonio/WORK/ITI_Agnelli/Materie/slidev/node_modules/@slidev/client/internals/PresenterMouse.vue"]]),Lk=Pe({__name:"SlidesShow",props:{context:{type:String,required:!0}},setup(e){$(I),ge(dt,()=>{var i,s;(i=dt.value)!=null&&i.meta&&dt.value.meta.preload!==!1&&(dt.value.meta.__preloaded=!0),(s=Wa.value)!=null&&s.meta&&Wa.value.meta.preload!==!1&&(Wa.value.meta.__preloaded=!0)},{immediate:!0});const t=sn();An(()=>import("./DrawingLayer-9930e6e6.js"),[]).then(i=>t.value=i.default);const n=N(()=>Qe.filter(i=>{var s;return((s=i.meta)==null?void 0:s.__preloaded)||i===dt.value}));return(i,s)=>(g(),ie(Oe,null,[Se(" Global Bottom "),j(L(qm)),Se(" Slides "),j(ig,me(L(uW),{id:"slideshow",tag:"div"}),{default:w(()=>[(g(!0),ie(Oe,null,No(n.value,a=>{var l;return np((g(),z(L(Er),{key:a.path,is:a==null?void 0:a.component,clicks:a===L(dt)?L(Lt):0,"clicks-elements":((l=a.meta)==null?void 0:l.__clicksElements)||[],"clicks-disabled":!1,class:Ve(L(Tr)(a)),route:a,context:i.context},null,8,["is","clicks","clicks-elements","class","route","context"])),[[Mp,a===L(dt)]])}),128))]),_:1},16),Se(" Global Top "),j(L(Dm)),t.value?(g(),z(L(t),{key:0})):Se("v-if",!0),L(_t)?Se("v-if",!0):(g(),z(Kk,{key:1}))],64))}});const Rk=T(Lk,[["__scopeId","data-v-afb4231e"],["__file","/home/antonio/WORK/ITI_Agnelli/Materie/slidev/node_modules/@slidev/client/internals/SlidesShow.vue"]]),Hk=Pe({__name:"PrintStyle",setup(e){$(I);function t(n,{slots:i}){if(i.default)return St("style",i.default())}return(n,i)=>(g(),z(t,null,{default:w(()=>[c(" @page { size: "+gt(L(Mn))+"px "+gt(L(wr))+"px; margin: 0px; } ",1)]),_:1}))}}),Fm=T(Hk,[["__file","/home/antonio/WORK/ITI_Agnelli/Materie/slidev/node_modules/@slidev/client/internals/PrintStyle.vue"]]),Wk=Pe({__name:"Play",setup(e){$(I),vS();const t=Z();function n(a){var l;bu.value||((l=a.target)==null?void 0:l.id)==="slide-container"&&(a.screenX/window.innerWidth>.6?Kn():Ln())}dW(t);const i=N(()=>zy.value||bu.value);sn();const s=sn();return An(()=>import("./DrawingControls-b66013c2.js"),[]).then(a=>s.value=a.default),(a,l)=>(g(),ie(Oe,null,[L(Ho)?(g(),z(Fm,{key:0})):Se("v-if",!0),o("div",{id:"page-root",ref_key:"root",ref:t,class:"grid grid-cols-[1fr_max-content]",style:tt(L(xr))},[j(Cm,{class:"w-full h-full",style:tt({background:"var(--slidev-slide-container-background, black)"}),width:L(Ho)?L(ho).width.value:void 0,scale:L(bs),onPointerdown:n},{default:w(()=>[j(Rk,{context:"slide"})]),controls:w(()=>[o("div",{class:Ve(["absolute bottom-0 left-0 transition duration-300 opacity-0 hover:opacity-100",[i.value?"opacity-100 right-0":"opacity-0 p-2",L(Mi)?"pointer-events-none":""]])},[j(zk,{class:"m-auto",persist:i.value},null,8,["persist"])],2),!L(Ee).drawings.presenterOnly&&!L(pn)&&s.value?(g(),z(L(s),{key:0,class:"ml-0"})):Se("v-if",!0)]),_:1},8,["style","width","scale"]),Se("v-if",!0)],4),j(Mw)],64))}}),Nk=T(Wk,[["__file","/home/antonio/WORK/ITI_Agnelli/Materie/slidev/node_modules/@slidev/client/internals/Play.vue"]]);/*! js-yaml 4.1.0 https://github.com/nodeca/js-yaml @license MIT */function jm(e){return typeof e>"u"||e===null}function Dk(e){return typeof e=="object"&&e!==null}function qk(e){return Array.isArray(e)?e:jm(e)?[]:[e]}function Fk(e,t){var n,i,s,a;if(t)for(a=Object.keys(t),n=0,i=a.length;n<i;n+=1)s=a[n],e[s]=t[s];return e}function jk(e,t){var n="",i;for(i=0;i<t;i+=1)n+=e;return n}function Vk(e){return e===0&&Number.NEGATIVE_INFINITY===1/e}var Bk=jm,Uk=Dk,Jk=qk,Qk=jk,Yk=Vk,Zk=Fk,Mr={isNothing:Bk,isObject:Uk,toArray:Jk,repeat:Qk,isNegativeZero:Yk,extend:Zk};function Vm(e,t){var n="",i=e.reason||"(unknown reason)";return e.mark?(e.mark.name&&(n+='in "'+e.mark.name+'" '),n+="("+(e.mark.line+1)+":"+(e.mark.column+1)+")",!t&&e.mark.snippet&&(n+=`

`+e.mark.snippet),i+" "+n):i}function Pi(e,t){Error.call(this),this.name="YAMLException",this.reason=e,this.mark=t,this.message=Vm(this,!1),Error.captureStackTrace?Error.captureStackTrace(this,this.constructor):this.stack=new Error().stack||""}Pi.prototype=Object.create(Error.prototype);Pi.prototype.constructor=Pi;Pi.prototype.toString=function(t){return this.name+": "+Vm(this,t)};var oo=Pi,Gk=["kind","multi","resolve","construct","instanceOf","predicate","represent","representName","defaultStyle","styleAliases"],Xk=["scalar","sequence","mapping"];function e2(e){var t={};return e!==null&&Object.keys(e).forEach(function(n){e[n].forEach(function(i){t[String(i)]=n})}),t}function t2(e,t){if(t=t||{},Object.keys(t).forEach(function(n){if(Gk.indexOf(n)===-1)throw new oo('Unknown option "'+n+'" is met in definition of "'+e+'" YAML type.')}),this.options=t,this.tag=e,this.kind=t.kind||null,this.resolve=t.resolve||function(){return!0},this.construct=t.construct||function(n){return n},this.instanceOf=t.instanceOf||null,this.predicate=t.predicate||null,this.represent=t.represent||null,this.representName=t.representName||null,this.defaultStyle=t.defaultStyle||null,this.multi=t.multi||!1,this.styleAliases=e2(t.styleAliases||null),Xk.indexOf(this.kind)===-1)throw new oo('Unknown kind "'+this.kind+'" is specified for "'+e+'" YAML type.')}var at=t2;function Lu(e,t){var n=[];return e[t].forEach(function(i){var s=n.length;n.forEach(function(a,l){a.tag===i.tag&&a.kind===i.kind&&a.multi===i.multi&&(s=l)}),n[s]=i}),n}function n2(){var e={scalar:{},sequence:{},mapping:{},fallback:{},multi:{scalar:[],sequence:[],mapping:[],fallback:[]}},t,n;function i(s){s.multi?(e.multi[s.kind].push(s),e.multi.fallback.push(s)):e[s.kind][s.tag]=e.fallback[s.tag]=s}for(t=0,n=arguments.length;t<n;t+=1)arguments[t].forEach(i);return e}function Wl(e){return this.extend(e)}Wl.prototype.extend=function(t){var n=[],i=[];if(t instanceof at)i.push(t);else if(Array.isArray(t))i=i.concat(t);else if(t&&(Array.isArray(t.implicit)||Array.isArray(t.explicit)))t.implicit&&(n=n.concat(t.implicit)),t.explicit&&(i=i.concat(t.explicit));else throw new oo("Schema.extend argument should be a Type, [ Type ], or a schema definition ({ implicit: [...], explicit: [...] })");n.forEach(function(a){if(!(a instanceof at))throw new oo("Specified list of YAML types (or a single Type object) contains a non-Type object.");if(a.loadKind&&a.loadKind!=="scalar")throw new oo("There is a non-scalar type in the implicit list of a schema. Implicit resolving of such types is not supported.");if(a.multi)throw new oo("There is a multi type in the implicit list of a schema. Multi tags can only be listed as explicit.")}),i.forEach(function(a){if(!(a instanceof at))throw new oo("Specified list of YAML types (or a single Type object) contains a non-Type object.")});var s=Object.create(Wl.prototype);return s.implicit=(this.implicit||[]).concat(n),s.explicit=(this.explicit||[]).concat(i),s.compiledImplicit=Lu(s,"implicit"),s.compiledExplicit=Lu(s,"explicit"),s.compiledTypeMap=n2(s.compiledImplicit,s.compiledExplicit),s};var o2=Wl,i2=new at("tag:yaml.org,2002:str",{kind:"scalar",construct:function(e){return e!==null?e:""}}),s2=new at("tag:yaml.org,2002:seq",{kind:"sequence",construct:function(e){return e!==null?e:[]}}),a2=new at("tag:yaml.org,2002:map",{kind:"mapping",construct:function(e){return e!==null?e:{}}}),l2=new o2({explicit:[i2,s2,a2]});function r2(e){if(e===null)return!0;var t=e.length;return t===1&&e==="~"||t===4&&(e==="null"||e==="Null"||e==="NULL")}function c2(){return null}function u2(e){return e===null}var d2=new at("tag:yaml.org,2002:null",{kind:"scalar",resolve:r2,construct:c2,predicate:u2,represent:{canonical:function(){return"~"},lowercase:function(){return"null"},uppercase:function(){return"NULL"},camelcase:function(){return"Null"},empty:function(){return""}},defaultStyle:"lowercase"});function p2(e){if(e===null)return!1;var t=e.length;return t===4&&(e==="true"||e==="True"||e==="TRUE")||t===5&&(e==="false"||e==="False"||e==="FALSE")}function m2(e){return e==="true"||e==="True"||e==="TRUE"}function f2(e){return Object.prototype.toString.call(e)==="[object Boolean]"}var h2=new at("tag:yaml.org,2002:bool",{kind:"scalar",resolve:p2,construct:m2,predicate:f2,represent:{lowercase:function(e){return e?"true":"false"},uppercase:function(e){return e?"TRUE":"FALSE"},camelcase:function(e){return e?"True":"False"}},defaultStyle:"lowercase"});function v2(e){return 48<=e&&e<=57||65<=e&&e<=70||97<=e&&e<=102}function _2(e){return 48<=e&&e<=55}function g2(e){return 48<=e&&e<=57}function b2(e){if(e===null)return!1;var t=e.length,n=0,i=!1,s;if(!t)return!1;if(s=e[n],(s==="-"||s==="+")&&(s=e[++n]),s==="0"){if(n+1===t)return!0;if(s=e[++n],s==="b"){for(n++;n<t;n++)if(s=e[n],s!=="_"){if(s!=="0"&&s!=="1")return!1;i=!0}return i&&s!=="_"}if(s==="x"){for(n++;n<t;n++)if(s=e[n],s!=="_"){if(!v2(e.charCodeAt(n)))return!1;i=!0}return i&&s!=="_"}if(s==="o"){for(n++;n<t;n++)if(s=e[n],s!=="_"){if(!_2(e.charCodeAt(n)))return!1;i=!0}return i&&s!=="_"}}if(s==="_")return!1;for(;n<t;n++)if(s=e[n],s!=="_"){if(!g2(e.charCodeAt(n)))return!1;i=!0}return!(!i||s==="_")}function y2(e){var t=e,n=1,i;if(t.indexOf("_")!==-1&&(t=t.replace(/_/g,"")),i=t[0],(i==="-"||i==="+")&&(i==="-"&&(n=-1),t=t.slice(1),i=t[0]),t==="0")return 0;if(i==="0"){if(t[1]==="b")return n*parseInt(t.slice(2),2);if(t[1]==="x")return n*parseInt(t.slice(2),16);if(t[1]==="o")return n*parseInt(t.slice(2),8)}return n*parseInt(t,10)}function S2(e){return Object.prototype.toString.call(e)==="[object Number]"&&e%1===0&&!Mr.isNegativeZero(e)}var w2=new at("tag:yaml.org,2002:int",{kind:"scalar",resolve:b2,construct:y2,predicate:S2,represent:{binary:function(e){return e>=0?"0b"+e.toString(2):"-0b"+e.toString(2).slice(1)},octal:function(e){return e>=0?"0o"+e.toString(8):"-0o"+e.toString(8).slice(1)},decimal:function(e){return e.toString(10)},hexadecimal:function(e){return e>=0?"0x"+e.toString(16).toUpperCase():"-0x"+e.toString(16).toUpperCase().slice(1)}},defaultStyle:"decimal",styleAliases:{binary:[2,"bin"],octal:[8,"oct"],decimal:[10,"dec"],hexadecimal:[16,"hex"]}}),x2=new RegExp("^(?:[-+]?(?:[0-9][0-9_]*)(?:\\.[0-9_]*)?(?:[eE][-+]?[0-9]+)?|\\.[0-9_]+(?:[eE][-+]?[0-9]+)?|[-+]?\\.(?:inf|Inf|INF)|\\.(?:nan|NaN|NAN))$");function k2(e){return!(e===null||!x2.test(e)||e[e.length-1]==="_")}function $2(e){var t,n;return t=e.replace(/_/g,"").toLowerCase(),n=t[0]==="-"?-1:1,"+-".indexOf(t[0])>=0&&(t=t.slice(1)),t===".inf"?n===1?Number.POSITIVE_INFINITY:Number.NEGATIVE_INFINITY:t===".nan"?NaN:n*parseFloat(t,10)}var z2=/^[-+]?[0-9]+e/;function I2(e,t){var n;if(isNaN(e))switch(t){case"lowercase":return".nan";case"uppercase":return".NAN";case"camelcase":return".NaN"}else if(Number.POSITIVE_INFINITY===e)switch(t){case"lowercase":return".inf";case"uppercase":return".INF";case"camelcase":return".Inf"}else if(Number.NEGATIVE_INFINITY===e)switch(t){case"lowercase":return"-.inf";case"uppercase":return"-.INF";case"camelcase":return"-.Inf"}else if(Mr.isNegativeZero(e))return"-0.0";return n=e.toString(10),z2.test(n)?n.replace("e",".e"):n}function C2(e){return Object.prototype.toString.call(e)==="[object Number]"&&(e%1!==0||Mr.isNegativeZero(e))}var T2=new at("tag:yaml.org,2002:float",{kind:"scalar",resolve:k2,construct:$2,predicate:C2,represent:I2,defaultStyle:"lowercase"}),E2=l2.extend({implicit:[d2,h2,w2,T2]}),O2=E2,Bm=new RegExp("^([0-9][0-9][0-9][0-9])-([0-9][0-9])-([0-9][0-9])$"),Um=new RegExp("^([0-9][0-9][0-9][0-9])-([0-9][0-9]?)-([0-9][0-9]?)(?:[Tt]|[ \\t]+)([0-9][0-9]?):([0-9][0-9]):([0-9][0-9])(?:\\.([0-9]*))?(?:[ \\t]*(Z|([-+])([0-9][0-9]?)(?::([0-9][0-9]))?))?$");function M2(e){return e===null?!1:Bm.exec(e)!==null||Um.exec(e)!==null}function A2(e){var t,n,i,s,a,l,r,u=0,d=null,p,m,f;if(t=Bm.exec(e),t===null&&(t=Um.exec(e)),t===null)throw new Error("Date resolve error");if(n=+t[1],i=+t[2]-1,s=+t[3],!t[4])return new Date(Date.UTC(n,i,s));if(a=+t[4],l=+t[5],r=+t[6],t[7]){for(u=t[7].slice(0,3);u.length<3;)u+="0";u=+u}return t[9]&&(p=+t[10],m=+(t[11]||0),d=(p*60+m)*6e4,t[9]==="-"&&(d=-d)),f=new Date(Date.UTC(n,i,s,a,l,r,u)),d&&f.setTime(f.getTime()-d),f}function P2(e){return e.toISOString()}var K2=new at("tag:yaml.org,2002:timestamp",{kind:"scalar",resolve:M2,construct:A2,instanceOf:Date,represent:P2});function L2(e){return e==="<<"||e===null}var R2=new at("tag:yaml.org,2002:merge",{kind:"scalar",resolve:L2}),Ar=`ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=
\r`;function H2(e){if(e===null)return!1;var t,n,i=0,s=e.length,a=Ar;for(n=0;n<s;n++)if(t=a.indexOf(e.charAt(n)),!(t>64)){if(t<0)return!1;i+=6}return i%8===0}function W2(e){var t,n,i=e.replace(/[\r\n=]/g,""),s=i.length,a=Ar,l=0,r=[];for(t=0;t<s;t++)t%4===0&&t&&(r.push(l>>16&255),r.push(l>>8&255),r.push(l&255)),l=l<<6|a.indexOf(i.charAt(t));return n=s%4*6,n===0?(r.push(l>>16&255),r.push(l>>8&255),r.push(l&255)):n===18?(r.push(l>>10&255),r.push(l>>2&255)):n===12&&r.push(l>>4&255),new Uint8Array(r)}function N2(e){var t="",n=0,i,s,a=e.length,l=Ar;for(i=0;i<a;i++)i%3===0&&i&&(t+=l[n>>18&63],t+=l[n>>12&63],t+=l[n>>6&63],t+=l[n&63]),n=(n<<8)+e[i];return s=a%3,s===0?(t+=l[n>>18&63],t+=l[n>>12&63],t+=l[n>>6&63],t+=l[n&63]):s===2?(t+=l[n>>10&63],t+=l[n>>4&63],t+=l[n<<2&63],t+=l[64]):s===1&&(t+=l[n>>2&63],t+=l[n<<4&63],t+=l[64],t+=l[64]),t}function D2(e){return Object.prototype.toString.call(e)==="[object Uint8Array]"}var q2=new at("tag:yaml.org,2002:binary",{kind:"scalar",resolve:H2,construct:W2,predicate:D2,represent:N2}),F2=Object.prototype.hasOwnProperty,j2=Object.prototype.toString;function V2(e){if(e===null)return!0;var t=[],n,i,s,a,l,r=e;for(n=0,i=r.length;n<i;n+=1){if(s=r[n],l=!1,j2.call(s)!=="[object Object]")return!1;for(a in s)if(F2.call(s,a))if(!l)l=!0;else return!1;if(!l)return!1;if(t.indexOf(a)===-1)t.push(a);else return!1}return!0}function B2(e){return e!==null?e:[]}var U2=new at("tag:yaml.org,2002:omap",{kind:"sequence",resolve:V2,construct:B2}),J2=Object.prototype.toString;function Q2(e){if(e===null)return!0;var t,n,i,s,a,l=e;for(a=new Array(l.length),t=0,n=l.length;t<n;t+=1){if(i=l[t],J2.call(i)!=="[object Object]"||(s=Object.keys(i),s.length!==1))return!1;a[t]=[s[0],i[s[0]]]}return!0}function Y2(e){if(e===null)return[];var t,n,i,s,a,l=e;for(a=new Array(l.length),t=0,n=l.length;t<n;t+=1)i=l[t],s=Object.keys(i),a[t]=[s[0],i[s[0]]];return a}var Z2=new at("tag:yaml.org,2002:pairs",{kind:"sequence",resolve:Q2,construct:Y2}),G2=Object.prototype.hasOwnProperty;function X2(e){if(e===null)return!0;var t,n=e;for(t in n)if(G2.call(n,t)&&n[t]!==null)return!1;return!0}function e$(e){return e!==null?e:{}}var t$=new at("tag:yaml.org,2002:set",{kind:"mapping",resolve:X2,construct:e$});O2.extend({implicit:[K2,R2],explicit:[q2,U2,Z2,t$]});function Ru(e){return e===48?"\0":e===97?"\x07":e===98?"\b":e===116||e===9?"	":e===110?`
`:e===118?"\v":e===102?"\f":e===114?"\r":e===101?"\x1B":e===32?" ":e===34?'"':e===47?"/":e===92?"\\":e===78?"":e===95?" ":e===76?"\u2028":e===80?"\u2029":""}var n$=new Array(256),o$=new Array(256);for(var Co=0;Co<256;Co++)n$[Co]=Ru(Co)?1:0,o$[Co]=Ru(Co);function i$(e){return Array.from(new Set(e))}function Hu(...e){let t,n,i;e.length===1?(t=0,i=1,[n]=e):[t,n,i=1]=e;const s=[];let a=t;for(;a<n;)s.push(a),a+=i||1;return s}function Jm(e,t){if(!t||t==="all"||t==="*")return Hu(1,e+1);const n=[];for(const i of t.split(/[,;]/g))if(!i.includes("-"))n.push(+i);else{const[s,a]=i.split("-",2);n.push(...Hu(+s,a?+a+1:e+1))}return i$(n).filter(i=>i<=e).sort((i,s)=>i-s)}function Qm(e){const t=N(()=>e.value.path),n=N(()=>Qe.length-1),i=N(()=>parseInt(t.value.split(/\//g).slice(-1)[0])||1),s=N(()=>ma(i.value)),a=N(()=>Qe.find(f=>f.path===`${i.value}`)),l=N(()=>{var f,h,v;return(v=(h=(f=a.value)==null?void 0:f.meta)==null?void 0:h.slide)==null?void 0:v.id}),r=N(()=>{var f,h;return((h=(f=a.value)==null?void 0:f.meta)==null?void 0:h.layout)||(i.value===1?"cover":"default")}),u=N(()=>Qe.find(f=>f.path===`${Math.min(Qe.length,i.value+1)}`)),d=N(()=>Qe.filter(f=>{var h,v;return(v=(h=f.meta)==null?void 0:h.slide)==null?void 0:v.title}).reduce((f,h)=>(Pr(f,h),f),[])),p=N(()=>Kr(d.value,a.value)),m=N(()=>Lr(p.value));return{route:e,path:t,total:n,currentPage:i,currentPath:s,currentRoute:a,currentSlideId:l,currentLayout:r,nextRoute:u,rawTree:d,treeWithActiveStatuses:p,tree:m,downloadPDF:Dl,next:Kn,nextSlide:Ki,openInEditor:pW,prev:Ln,prevSlide:Li}}function Ym(e,t,n){const i=Z(0);it(()=>{yt.afterEach(async()=>{await it(),i.value+=1})});const s=N(()=>{var u,d;return i.value,((d=(u=t.value)==null?void 0:u.meta)==null?void 0:d.__clicksElements)||[]}),a=N(()=>{var u,d;return+(((d=(u=t.value)==null?void 0:u.meta)==null?void 0:d.clicks)??s.value.length)}),l=N(()=>n.value<Qe.length-1||e.value<a.value),r=N(()=>n.value>1||e.value>0);return{clicks:e,clicksElements:s,clicksTotal:a,hasNext:l,hasPrev:r}}const s$=["id"],a$=Pe({__name:"PrintSlideClick",props:{clicks:{type:Number,required:!0},clicksElements:{type:Array,required:!1},nav:{type:null,required:!0},route:{type:null,required:!0}},emits:["update:clicksElements"],setup(e,{emit:t}){const n=e,i=Kt(n,"clicksElements",t),s=N(()=>({height:`${wr}px`,width:`${Mn}px`})),a=sn();An(()=>Promise.resolve().then(()=>$S),void 0).then(d=>a.value=d.default);const l=N(()=>n.clicks),r=Ym(l,n.nav.currentRoute,n.nav.currentPage),u=N(()=>`${n.route.path.toString().padStart(3,"0")}-${(l.value+1).toString().padStart(2,"0")}`);return zt(I,je({nav:{...n.nav,...r},configs:Ee,themeConfigs:N(()=>Ee.themeConfig)})),(d,p)=>{var m;return g(),ie("div",{id:u.value,class:"print-slide-container",style:tt(s.value)},[j(L(qm)),j(L(Er),{is:(m=d.route)==null?void 0:m.component,"clicks-elements":L(i),"onUpdate:clicksElements":p[0]||(p[0]=f=>Me(i)?i.value=f:null),clicks:l.value,"clicks-disabled":!1,class:Ve(L(Tr)(d.route)),route:d.route},null,8,["is","clicks-elements","clicks","class","route"]),a.value?(g(),z(L(a),{key:0,page:+d.route.path},null,8,["page"])):Se("v-if",!0),j(L(Dm))],12,s$)}}}),Wu=T(a$,[["__file","/home/antonio/WORK/ITI_Agnelli/Materie/slidev/node_modules/@slidev/client/internals/PrintSlideClick.vue"]]),l$=Pe({__name:"PrintSlide",props:{route:{type:null,required:!0}},setup(e){var a;const t=e;$(I);const n=Z(((a=t.route.meta)==null?void 0:a.__clicksElements)||[]),i=N(()=>t.route),s=Qm(i);return(l,r)=>(g(),ie(Oe,null,[j(Wu,{"clicks-elements":n.value,"onUpdate:clicksElements":r[0]||(r[0]=u=>n.value=u),clicks:0,nav:L(s),route:i.value},null,8,["clicks-elements","nav","route"]),L(gi)?Se("v-if",!0):(g(!0),ie(Oe,{key:0},No(n.value.length,u=>(g(),z(Wu,{key:u,clicks:u,nav:L(s),route:i.value},null,8,["clicks","nav","route"]))),128))],64))}}),r$=T(l$,[["__file","/home/antonio/WORK/ITI_Agnelli/Materie/slidev/node_modules/@slidev/client/internals/PrintSlide.vue"]]),c$={id:"print-content"},u$=Pe({__name:"PrintContainer",props:{width:{type:Number,required:!0}},setup(e){const t=e;$(I);const n=N(()=>t.width),i=N(()=>t.width/On),s=N(()=>n.value/i.value),a=N(()=>s.value<On?n.value/Mn:i.value*On/Mn);let l=Qe.slice(0,-1);Ht.value.query.range&&(l=Jm(l.length,Ht.value.query.range).map(d=>l[d-1]));const r=N(()=>({"select-none":!Ee.selectable,"slidev-code-line-numbers":Ee.lineNumbers}));return zt(Fp,a),(u,d)=>(g(),ie("div",{id:"print-container",class:Ve(r.value)},[o("div",c$,[(g(!0),ie(Oe,null,No(L(l),p=>(g(),z(r$,{key:p.path,route:p},null,8,["route"]))),128))]),Bt(u.$slots,"controls")],2))}});const d$=T(u$,[["__file","/home/antonio/WORK/ITI_Agnelli/Materie/slidev/node_modules/@slidev/client/internals/PrintContainer.vue"]]),p$=Pe({__name:"Print",setup(e){return $(I),yo(()=>{Ho?document.body.parentNode.classList.add("print"):document.body.parentNode.classList.remove("print")}),(t,n)=>(g(),ie(Oe,null,[L(Ho)?(g(),z(Fm,{key:0})):Se("v-if",!0),o("div",{id:"page-root",class:"grid grid-cols-[1fr_max-content]",style:tt(L(xr))},[j(d$,{class:"w-full h-full",style:tt({background:"var(--slidev-slide-container-background, black)"}),width:L(ho).width.value},null,8,["style","width"])],4)],64))}});const m$=T(p$,[["__file","/home/antonio/WORK/ITI_Agnelli/Materie/slidev/node_modules/@slidev/client/internals/Print.vue"]]);const f$={class:"slidev-layout end"},h$={__name:"end",setup(e){return $(I),(t,n)=>(g(),ie("div",f$,[Bt(t.$slots,"default",{},()=>[c("END")],!0)]))}},v$=T(h$,[["__scopeId","data-v-e532b98d"],["__file","/home/antonio/WORK/ITI_Agnelli/Materie/slidev/node_modules/@slidev/client/layouts/end.vue"]]);function Nu(e){return e.startsWith("/")?"/TPSI/4/svelte/"+e.slice(1):e}function _$(e,t=!1){const n=e&&["#","rgb","hsl"].some(s=>e.indexOf(s)===0),i={background:n?e:void 0,color:e&&!n?"white":void 0,backgroundImage:n?void 0:e?t?`linear-gradient(#0005, #0008), url(${Nu(e)})`:`url("${Nu(e)}")`:void 0,backgroundRepeat:"no-repeat",backgroundPosition:"center",backgroundSize:"cover"};return i.background||delete i.background,i}const g$={class:"my-auto w-full"},b$=Pe({__name:"cover",props:{background:{default:""}},setup(e){const t=e;$(I);const n=N(()=>_$(t.background,!0));return(i,s)=>(g(),ie("div",{class:"slidev-layout cover",style:tt(n.value)},[o("div",g$,[Bt(i.$slots,"default")])],4))}}),y$=T(b$,[["__file","/home/antonio/WORK/ITI_Agnelli/Materie/slidev/node_modules/@slidev/theme-default/layouts/cover.vue"]]),S$=o("h1",null,"Svelte e SvelteKit",-1),w$=o("p",null,"CYBERNETICALLY ENHANCED WEB APPS",-1),x$={class:"pt-12"},k$={class:"px-2 py-1"},$$={__name:"1",setup(e){const t={theme:"default",background:"https://source.unsplash.com/collection/94734566/1920x1080",class:"text-center",lineNumbers:!1,aspectRatio:"16_/9",routerMode:"hash",as:"2023/2024",version:"1.2.0"};return $(I),(n,i)=>{const s=Nm;return g(),z(y$,O(E(t)),{default:w(()=>[Se(` https://reteinformaticalavoro.it/blog/framework-cosa-sono-e-quali-dominano-le-classifiche/#:~:text=In%20informatica%2C%20un%20framework%20%C3%A8,in%20modo%20semplice%20e%20veloce.

https://www.okupter.com/blog/svelte-vs-sveltekit-the-difference

https://www.okupter.com/blog/sveltekit-full-stack-framework `),S$,w$,o("div",x$,[o("span",k$,[c(" Premi spazio o "),j(s,{class:"inline"}),c(" per la prossima slide ")])])]),_:1},16)}}},z$=T($$,[["__file","/@slidev/slides/1.md"]]),I$={class:"slidev-layout default"},C$={__name:"default",setup(e){return $(I),(t,n)=>(g(),ie("div",I$,[Bt(t.$slots,"default")]))}},M=T(C$,[["__file","/home/antonio/WORK/ITI_Agnelli/Materie/slidev/node_modules/@slidev/client/layouts/default.vue"]]),T$=o("h1",null,"Introduzione",-1),E$=o("p",null,"Vanilla Software",-1),O$=o("ul",null,[o("li",null,[c("Un software "),o("code",null,"Vanilla"),c(" è un programma per computer (e per altri sistemi informatici come hardware o algoritmi) che non viene alterato rispetto alla propria forma originale.")]),o("li",null,"Il termine deriva dal tradizionale gusto di gelato, la vaniglia."),o("li",null,[c("In altre parole con il termine "),o("strong",null,"Vanilla"),c(" si intende un linguaggio, un kernel, un programma non modificato ma utilizzato nella sua forma base")]),o("li",null,"Ciò si applica anche ai linguaggi di programmazione")],-1),M$={__name:"2",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[T$,E$,O$]),_:1},16))}},A$=T(M$,[["__file","/@slidev/slides/2.md"]]),P$="/TPSI/4/svelte/assets/svelte_000-21a7ddac.png",K$=o("h1",null,"Introduzione",-1),L$=o("p",null,"Vanilla Software",-1),R$=o("div",{style:{float:"left",width:"50%"}},[o("ul",null,[o("li",null,"Vanilla JavaScript (o VanillaJS) si riferisce all’uso di JavaScript puro, senza alcun componente aggiuntivo come librerie o framework."),o("li",null,"È una specie di battuta tra informatici per indicare le potenzialità attuali del puro e semplice JavaScript."),o("li",null,"Agli albori del Web era normale programmare in vanillaJS")])],-1),H$=o("img",{src:P$,class:"mx-auto",width:"400"},null,-1),W$={__name:"3",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[K$,L$,R$,H$]),_:1},16))}},N$=T(W$,[["__file","/@slidev/slides/3.md"]]),D$="/TPSI/4/svelte/assets/svelte_001-e8d6b419.png",q$=o("h1",null,"Introduzione",-1),F$=o("p",null,"Librerie JS",-1),j$=o("ul",null,[o("li",null,"Una libreria NON è un’unità eseguibile indipendentemente, ma un modulo aggiuntivo richiesto da un programma."),o("li",null,"In altre parole, le librerie sono raccolte di classi e funzioni, motivo per cui a volte vengono anche chiamate librerie di componenti o di classi."),o("li",null,"Il programma principale utilizza una o più funzioni, messe a disposizione dalla libreria.")],-1),V$=o("img",{src:D$,class:"mx-auto",style:{"margin-top":"2rem"},width:"500"},null,-1),B$={__name:"4",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[q$,F$,j$,V$]),_:1},16))}},U$=T(B$,[["__file","/@slidev/slides/4.md"]]),J$=o("h1",null,"Introduzione",-1),Q$=o("p",null,"Librerie JS",-1),Y$=o("ul",null,[o("li",null,"Una libreria JavaScript è una libreria di codice JavaScript pre-scritto che consente uno sviluppo più semplice di applicazioni basate su JavaScript"),o("li",null,"Ci sono centinaia di librerie JS per qualsiasi funzionalità possa venire in mente allo sviluppatore"),o("li",null,[c("Una delle più note librerie che ha dominato il web per molti anni si chiama "),o("code",null,"jQuery")]),o("li",null,[o("strong",null,"jQuery"),c(" è una libreria JavaScript veloce, piccola e ricca di funzionalità.")]),o("li",null,"Rende funzionalità complesse come l’attraversamento e la manipolazione di documenti HTML, la gestione degli eventi, l’animazione e Ajax molto più semplici che in vanillaJS"),o("li",null,"Con una combinazione di versatilità ed estensibilità, jQuery ha cambiato il modo in cui milioni di persone scrivono JavaScript.")],-1),Z$={__name:"5",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[J$,Q$,Y$]),_:1},16))}},G$=T(Z$,[["__file","/@slidev/slides/5.md"]]),X$=o("h1",null,"Introduzione",-1),ez=o("p",null,"Framework JS",-1),tz=o("ul",null,[o("li",null,"Man mano che l’importanza dello sviluppo Web cresceva, e con essa l’importanza di JS, l’uso di VanillaJS o di semplici librerie non era più sufficiente"),o("li",null,[c("Pertanto hanno iniziato a proliferare una moltitudine di "),o("code",null,"Framework JS"),c(" che offrono paradigmi differenti e adatti a risolvere la maggioranza delle problematiche dello sviluppo web")])],-1),nz=o("div",{style:{"background-color":"green",color:"yellow",padding:"10px","line-height":"40px",margin:"10px"}},[o("p",null,[c("In informatica, "),o("strong",null,"un framework"),c(" è un sistema che consente di estendere le funzionalità del linguaggio di programmazione su cui è basato, fornendo allo sviluppatore una struttura coerente ed efficace al fine di effettuare azioni e comandi in modo semplice e veloce")])],-1),oz=o("ul",null,[o("li",null,[o("strong",null,"Un framework"),c(' è un tipo speciale di libreria che non contiene funzioni "finite" come una normale libreria.')]),o("li",null,"In sostanza, si può definire un framework come un insieme di funzioni e tool già “pronti all’uso”, ovvero che si possono utilizzare senza doverli progettare da zero ogni volta.")],-1),iz={__name:"6",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[X$,ez,tz,nz,oz]),_:1},16))}},sz=T(iz,[["__file","/@slidev/slides/6.md"]]),az=o("h1",null,"Introduzione",-1),lz=o("p",null,"Framework JS",-1),rz=o("ul",null,[o("li",null,"I framework sono piuttosto impalcature/scheletri/template di programmi che forniscono il progetto, le linee guida e l’organizzazione del codice ma non l’unità finita."),o("li",null,"Il framework, quindi, fornisce il progetto e il framework di base e mostra anche ciò che è ancora necessario al programmatore in termini di personalizzazione."),o("li",null,"Il framework fornisce il flusso di un’applicazione software e comunica allo sviluppatore ciò di cui ha bisogno e chiama il codice fornito dallo sviluppatore come richiesto")],-1),cz={__name:"7",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[az,lz,rz]),_:1},16))}},uz=T(cz,[["__file","/@slidev/slides/7.md"]]),dz="/TPSI/4/svelte/assets/svelte_004-24e4fca1.png",pz=o("h1",null,"Introduzione",-1),mz=o("p",null,"Framework JS",-1),fz=o("img",{src:dz,class:"mx-auto",style:{"margin-top":"0rem"},width:"800"},null,-1),hz={__name:"8",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[pz,mz,fz]),_:1},16))}},vz=T(hz,[["__file","/@slidev/slides/8.md"]]),_z="/TPSI/4/svelte/assets/svelte_002-3d42938e.png",gz=o("h1",null,"Introduzione",-1),bz=o("p",null,"Framework JS",-1),yz=o("ul",null,[o("li",null,[c("I principali "),o("a",{href:"https://en.wikipedia.org/wiki/Software_framework",target:"_blank",rel:"noopener"},"framework"),c(" degli ultimi anni sono")])],-1),Sz=o("img",{src:_z,class:"mx-auto",style:{"margin-top":"0rem"},width:"600"},null,-1),wz={__name:"9",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[gz,bz,yz,Sz]),_:1},16))}},xz=T(wz,[["__file","/@slidev/slides/9.md"]]),kz=o("h1",null,"Introduzione",-1),$z=o("p",null,"Framework JS",-1),zz=o("ul",null,[o("li",null,"L’uso di un frameowrk non è indispensabile: si tratta più che altro di uno dei tanti strumenti che lo sviluppatore ha a sua disposizione per programmare meglio e più velocemente."),o("li",null,"Proprio per queste sue caratteristiche, sono diventati sempre più fondamentali per lo sviluppo di siti web e app."),o("li",null,[c("I framework consentono di: "),o("ul",null,[o("li",null,"ottimizzare tempi, costi e benefici;"),o("li",null,"evitare al programmatore di riscrivere codice già scritto in precedenza per compiti simili;"),o("li",null,"organizzare e trovare rapidamente i file necessari;"),o("li",null,"concentrarsi sul problema da risolvere, senza dover implementare funzionalità che qualcun altro ha già provveduto a creare.")])])],-1),Iz={__name:"10",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[kz,$z,zz]),_:1},16))}},Cz=T(Iz,[["__file","/@slidev/slides/10.md"]]),Tz=o("h1",null,"Web Components",-1),Ez=o("p",null,"OOP per il Web",-1),Oz=o("ul",null,[o("li",null,[c("Lo sviluppo Web moderno è incentrato sul concetto di "),o("code",null,"componente")])],-1),Mz=o("div",{style:{"background-color":"green",color:"yellow",padding:"10px","line-height":"40px",margin:"10px"}},[o("p",null,[o("em",null,"Web Components is a suite of different technologies allowing you to create reusable custom elements — with their functionality encapsulated away from the rest of your code — and utilize them in your web apps."),c(" (source MDN)")])],-1),Az=o("ul",null,[o("li",null,"Un componente è un elemento atomico e auto sufficiente, di un’applicazione Web."),o("li",null,'In altre parole un componente è un "mattoncino", ben definito, che viene utilizzato all’interno di un’applicazione più ampia'),o("li",null,"Da ciò ne consegue che una moderna applicazione web è composta da uno o più componenti indipendenti che interagiscono tra loro per fornire il layout e la funzionalità desiderata")],-1),Pz={__name:"11",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[Tz,Ez,Oz,Mz,Az]),_:1},16))}},Kz=T(Pz,[["__file","/@slidev/slides/11.md"]]),Lz="/TPSI/4/svelte/assets/svelte_03-b6c35794.png",Rz=o("h1",null,"Web Components",-1),Hz=o("p",null,"OOP per il Web",-1),Wz=o("ul",null,[o("li",null,"Un elemento di input può essere un componente."),o("li",null,"Un form può essere un componente."),o("li",null,"Una pagina intera può essere è un componente.")],-1),Nz=o("img",{src:Lz,style:{position:"relative",left:"450px",top:"-150px"},width:"500"},null,-1),Dz={__name:"12",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[Rz,Hz,Wz,Nz]),_:1},16))}},qz=T(Dz,[["__file","/@slidev/slides/12.md"]]),Fz="/TPSI/4/svelte/assets/svelte_006-2096526e.png",jz=o("h1",null,"Web Components",-1),Vz=o("p",null,"OOP per il Web",-1),Bz=o("img",{src:Fz,class:"mx-auto",width:"600"},null,-1),Uz={__name:"13",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[jz,Vz,Bz]),_:1},16))}},Jz=T(Uz,[["__file","/@slidev/slides/13.md"]]),Qz=o("h1",null,"SvelteKit",-1),Yz=o("p",null,"Svelte ~ SvelteKit",-1),Zz=o("ul",null,[o("li",null,[c("Svelte è un framework "),o("strong",null,"che propone un approccio radicalmente nuovo alla creazione di applicazioni Web"),c(".")]),o("li",null,"Svelte è un modo per scrivere componenti dell’interfaccia utente, come una barra di navigazione, una sezione dei commenti o un modulo di contatto"),o("li",null,"Se hai già esperienza con React, Vue, Angular o altri framework frontend rimarrai piacevolmente sorpreso da Svelte."),o("li",null,"Lavorando con Svelte tutto sembra molto più simile al JavaScript-vanilla rispetto che a lavorare con altri framework."),o("li",null,"In generale la maggior parte delle cose che sono complicate con altri framework sono molto semplici e leggeri con Svelte.")],-1),Gz=o("div",{style:{"background-color":"green",color:"yellow",padding:"10px","line-height":"40px"}},[c(" Svelte è stato recentemente votato come il "),o("h2",null,"framework web più amato dagli sviluppatori")],-1),Xz=o("p",null,[o("a",{href:"https://insights.stackoverflow.com/survey/2021#section-most-loved-dreaded-and-wanted-web-frameworks",target:"_blank",rel:"noopener"},"https://insights.stackoverflow.com/survey/2021#section-most-loved-dreaded-and-wanted-web-frameworks")],-1),eI={__name:"14",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[Qz,Yz,Zz,Gz,Xz]),_:1},16))}},tI=T(eI,[["__file","/@slidev/slides/14.md"]]),nI="/TPSI/4/svelte/assets/svelte_00-c251d652.png",oI=o("h1",null,"SvelteKit",-1),iI=o("p",null,"Introduzione",-1),sI=o("img",{src:nI,class:"mx-auto",width:"750"},null,-1),aI={__name:"15",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[oI,iI,sI]),_:1},16))}},lI=T(aI,[["__file","/@slidev/slides/15.md"]]),rI=o("h1",null,"SvelteKit",-1),cI=o("p",null,"Svelte vs Others",-1),uI=o("ul",null,[o("li",null,"Mentre i framework tradizionali come React e Vue fanno la maggior parte del loro lavoro nel browser, Svelte sposta il lavoro in una fase di compilazione che si verifica quando crei la tua app, in modo da non dover far scaricare l’intero framework a tutti i tuoi visitatori del sito."),o("li",null,"Di conseguenza, la fruizione dell’esperienza è più fluida, consuma meno larghezza di banda e tutto risulta più veloce e leggero."),o("li",null,"Al momento della distribuzione, Svelte scompare e tutto ciò che ottieni è puro JavaScript Vanilla (molto veloce!)."),o("li",null,[c("In altre parole "),o("code",null,"Svelte è un compilatore"),c(" che trasforma il codice della tua applicazione Web in puro JavaScript, raggiungendo così massime prestazioni")])],-1),dI={__name:"16",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[rI,cI,uI]),_:1},16))}},pI=T(dI,[["__file","/@slidev/slides/16.md"]]),mI=o("h1",null,"SvelteKit",-1),fI=o("p",null,"Svelte vs Others",-1),hI=o("ul",null,[o("li",null,[c("Molti framework Web utilizzano il concetto di "),o("code",null,"Virtual DOM")]),o("li",null,[c("Il Virtual DOM "),o("code",null,"VDOM"),c(" è una rappresentazione ideale della UI di una pagina che è mantenuta in memoria")]),o("li",null,"Il VDOM è sincronizzato periodicamente con il DOM reale da una libreria (Reacts, Vue, Angular)"),o("li",null,[c("Svelte, in modo innovativo, anzichè utilizzare la tecnica del "),o("code",null,"virtual DOM diffing"),c(", genera codice JS che aggiorna direttamente il DOM quando cambia lo stato della tua app.")])],-1),vI=o("br",null,null,-1),_I=o("div",{style:{"background-color":"green",color:"yellow",padding:"10px","line-height":"40px"}}," La principale differenza tra Svelte e gli altri framework Web è che Svelte è un compilatore che converte la tua applicazione Web in JavaScript-vanilla durante la fase di build. Al contrario gli altri framework usano un virtual DOM interpretato dall'applicazione Web durante il runtime sul browser. ",-1),gI={__name:"17",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[mI,fI,hI,vI,_I]),_:1},16))}},bI=T(gI,[["__file","/@slidev/slides/17.md"]]),yI=o("h1",null,"SvelteKit",-1),SI=o("p",null,"Svelte vs Others",-1),wI=o("ul",null,[o("li",null,[c("React utilizza un concetto noto come Virtual DOM (VDOM), in cui una rappresentazione virtuale dell’interfaccia utente viene mantenuta in memoria e sincronizzata con il DOM reale attraverso un processo chiamato "),o("strong",null,"riconciliazione"),c(".")]),o("li",null,"Il processo di riconciliazione troverà la differenza (diffing) tra il Virtual DOM (un oggetto in memoria, dove inviamo gli ultimi aggiornamenti all’interfaccia utente) e il vero DOM (DOM che contiene l’interfaccia utente precedentemente renderizzata)."),o("li",null,"Utilizzando specifici algoritmi, il framework decide come aggiornare l’interfaccia utente."),o("li",null,"Ovviamente questo processo, non è efficiente e veloce"),o("li",null,"Per raggiungere questo obiettivo, React introduce un overhead (la libreria), che verrà eseguito nel motore JS del browser per monitorare e aggiornare il DOM in base alle varie interazioni dell’utente.")],-1),xI={__name:"18",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[yI,SI,wI]),_:1},16))}},kI=T(xI,[["__file","/@slidev/slides/18.md"]]),$I="/TPSI/4/svelte/assets/svelte_01-09f90fce.png",zI=o("h1",null,"SvelteKit",-1),II=o("p",null,"Svelte vs Others",-1),CI=o("img",{src:$I,class:"mx-auto w-160"},null,-1),TI={__name:"19",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[zI,II,CI]),_:1},16))}},EI=T(TI,[["__file","/@slidev/slides/19.md"]]),OI="/TPSI/4/svelte/assets/svelte_003-ae5236bd.png",MI=o("h1",null,"SvelteKit",-1),AI=o("p",null,"Svelte vs Others",-1),PI=o("ul",null,[o("li",null,"Svelte è solamente un compilatore, che converte la tua applicazione in codice JavaScript durante la fase di sviluppo e build."),o("li",null,"Ciò significa che non inietterà alcun codice aggiuntivo (no librerie aggiuntive) da eseguire nel browser quando l’applicazione è in esecuzione per aggiornare il DOM."),o("li",null,"Questo approccio è generalmente più veloce dell’approccio basato su Virtual DOM.")],-1),KI=o("img",{src:OI,class:"mx-auto",width:"480",style:{"margin-top":"20px"}},null,-1),LI={__name:"20",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[MI,AI,PI,KI]),_:1},16))}},RI=T(LI,[["__file","/@slidev/slides/20.md"]]),HI=o("h1",null,"SvelteKit",-1),WI=o("p",null,"Svelte vs Others",-1),NI=o("p",null,[o("strong",null,"PRO")],-1),DI=o("ul",null,[o("li",null,"Tempo di compilazione velocissimo rispetto a React o altri framework e dimensione del pacchetto generato è più piccola rispetto a React"),o("li",null,"Tempi di caricamento e rendering della Web app più veloci rispetto a React o altri framework."),o("li",null,"Più facile da capire rispetto a altri framework poiché Svelte è semplice JavaScript, HTML e CSS."),o("li",null,"Permette di scrivere meno codice rispetto ad altri framework"),o("li",null,[c("Nativamente "),o("strong",null,"reactive"),c(" e perfettamente adatto alle moderne Web app")])],-1),qI=o("p",null,[o("strong",null,"CONTRO")],-1),FI=o("ul",null,[o("li",null,"Svelte è un framework ancora nuovo e giovane con un supporto limitato da parte della community, quindi non ha il supporto per un’ampia gamma di plugin e integrazioni come per esempio React"),o("li",null,"Alcuni sviluppatori potrebbero non preferire l’uso di sintassi speciali come #if e #each all’interno dei loro modelli e preferirebbero invece utilizzare JavaScript puro, come consentito da React.")],-1),jI={__name:"21",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[HI,WI,NI,DI,qI,FI]),_:1},16))}},VI=T(jI,[["__file","/@slidev/slides/21.md"]]),BI=o("h1",null,"SvelteKit",-1),UI=o("p",null,"Fullstack Framework",-1),JI=o("ul",null,[o("li",null,[o("code",null,"SvelteKit"),c(" è un framework per lo sviluppo rapido di applicazioni Web robuste e performanti che utilizza Svelte.")]),o("li",null,"Se provieni da React, SvelteKit è simile a Next. Se vieni da Vue, SvelteKit è simile a Nuxt"),o("li",null,"Sveltekit è il framework che permette agli sviluppatori di creare e gestire la user experience della loro applicazione."),o("li",null,"Fornisce un ambiente unificato per lavorare con componenti, dati, routing, back-end, front-end e altro ancora."),o("li",null,[c("SvelteKit e Svelte sono "),o("strong",null,"totalmente allineati"),c(" al paradigma e modello di sviluppo per componenti caratteristico del web moderno.")])],-1),QI={__name:"22",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[BI,UI,JI]),_:1},16))}},YI=T(QI,[["__file","/@slidev/slides/22.md"]]),ZI=o("h1",null,"SvelteKit",-1),GI=o("p",null,"Fullstack Framework",-1),XI=o("ul",null,[o("li",null,[c("SvelteKit è un framework per app che risolve i difficili molti problemi comunini ad applicazioni pronte per la produzione: "),o("ul",null,[o("li",null,"Routing (navigazione tra le pagine)"),o("li",null,"Server-side rendering (supporto al back-end)"),o("li",null,"Data fetching ()"),o("li",null,"Service workers"),o("li",null,"Supporto TypeScript (la versione di JavaScript con steroidi)"),o("li",null,"Prerendering (per applicazioni statiche. vedi blog profmancusoa)"),o("li",null,"Single-page apps (SPA: approccio moderno che sostituisce lo sviluppo desktop)"),o("li",null,"Supporto per diversi hosting providers molto comuni su Internet (vercel, netlify, …)")])])],-1),eC={__name:"23",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[ZI,GI,XI]),_:1},16))}},tC=T(eC,[["__file","/@slidev/slides/23.md"]]),nC=o("h1",null,"SvelteKit",-1),oC=o("p",null,"Svelte vs SvelteKit",-1),iC=o("p",null,[o("strong",null,"SVELTE")],-1),sC=o("ul",null,[o("li",null,"Un linguaggio di programmazione che si basa su HTML, CSS e JS"),o("li",null,[c("Svelte permette la creazione di "),o("strong",null,"componenti"),c(" web.")]),o("li",null,[c("Un componente è un blocco di codice autonomo riutilizzabile che incapsula HTML, CSS e JavaScript scritti in un file "),o("strong",null,".svelte"),c(".")])],-1),aC=o("p",null,[o("strong",null,"SVELTE KIT")],-1),lC=o("ul",null,[o("li",null,"Sveltekit è il framework, basato su Svelte, che permette agli sviluppatori di creare e gestire applicazioni full stack che combinano insieme componenti Svelte."),o("li",null,"Fornisce un ambiente unificato per lavorare con componenti, dati, routing e altro ancora."),o("li",null,[c("Sveltekit è un "),o("code",null,"full stack framework"),c(" ricco di funzionalità e permette lo sviluppo di un applicazione web completa di back-end e front-end")])],-1),rC={__name:"24",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[nC,oC,iC,sC,aC,lC]),_:1},16))}},cC=T(rC,[["__file","/@slidev/slides/24.md"]]),uC="/TPSI/4/svelte/assets/svelte_005-e897ef89.png",dC=o("h1",null,"SvelteKit",-1),pC=o("p",null,"Web App Architecture",-1),mC=o("img",{src:uC,class:"mx-auto",width:"900"},null,-1),fC={__name:"25",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[dC,pC,mC]),_:1},16))}},hC=T(fC,[["__file","/@slidev/slides/25.md"]]),vC=o("h1",null,"SvelteKit",-1),_C=o("p",null,"Svelte Components",-1),gC=o("ul",null,[o("li",null,"Un componente web è assimilabile al concetto di Oggetto nella programmazione OOP"),o("li",null,"Come un oggetto incapusala dati e metodi, un componente Web incapsula tutto ciò che è necessario per eseguire il rendering della sua interfaccia utente e per gestire la sua logica di funzionamento."),o("li",null,[c("Ogni componente Svelte è dichiarato in un file "),o("code",null,".svelte"),c(", che contiene: "),o("ul",null,[o("li",null,"il contenuto (markup) in HTML"),o("li",null,"la presentazione o stile (CSS)"),o("li",null,"il comportamento (JavaScript)")])])],-1),bC=o("br",null,null,-1),yC=o("div",{style:{"background-color":"green",color:"yellow",padding:"10px","line-height":"25px"}}," Questo raggruppamento (senza un ordine particolare) permette un modo efficiente di definire una parte dell'interfaccia utente perché non è necessario cercare gli elementi che influiscono sullo stesso elemento in vari file. ",-1),SC={__name:"26",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[vC,_C,gC,bC,yC]),_:1},16))}},wC=T(SC,[["__file","/@slidev/slides/26.md"]]),xC="/TPSI/4/svelte/assets/svelte_007-e6e59c17.png",kC=o("h1",null,"SvelteKit",-1),$C=o("p",null,"Svelte Components",-1),zC=o("ul",null,[o("li",null,"Ecco la struttura di un componente Svelte")],-1),IC=o("br",null,null,-1),CC=o("img",{src:xC,class:"mx-auto",width:"700"},null,-1),TC={__name:"27",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[kC,$C,zC,IC,CC]),_:1},16))}},EC=T(TC,[["__file","/@slidev/slides/27.md"]]),OC="/TPSI/4/svelte/assets/svelte_008-4c504ad0.png",MC=o("h1",null,"SvelteKit",-1),AC=o("p",null,"Esempio di componente Svelte",-1),PC=o("img",{src:OC,class:"mx-auto",width:"350"},null,-1),KC={__name:"28",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[MC,AC,PC]),_:1},16))}},LC=T(KC,[["__file","/@slidev/slides/28.md"]]),RC="/TPSI/4/svelte/assets/svelte_04-397495f6.png",HC=o("h1",null,"SvelteKit",-1),WC=o("p",null,"Svelte Components",-1),NC=o("p",null,[o("br"),o("br")],-1),DC=o("img",{src:RC,class:"mx-auto"},null,-1),qC={__name:"29",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[HC,WC,NC,DC]),_:1},16))}},FC=T(qC,[["__file","/@slidev/slides/29.md"]]),jC=o("h1",null,"SvelteKit",-1),VC=o("p",null,"Svelte Components",-1),BC=o("ul",null,[o("li",null,"Questo componente, per quanto semplice, contiene tutti gli elementi di un componente web (HTML/CSS/JS)"),o("li",null,[c("Nel tag "),o("code",null,"<script>"),c(" è presente il codice JS di gestione del componente")]),o("li",null,[c("Il markup HTML non è inserito in un tag particolare e pertanto tutto ciò che non è parte del tag "),o("code",null,"<script>"),c(" e "),o("code",null,"<style>"),c(" è cosiderato contenuto del componente.")]),o("li",null,[c("Il tag "),o("code",null,"<style>"),c(" definisce il CSS del componente")])],-1),UC=o("br",null,null,-1),JC=o("div",{style:{"background-color":"green",color:"yellow",padding:"10px","line-height":"40px"}}," Sia il codice JS e lo stile CSS sono confinati solo all'interno di questo componente e non possono influire o essere influenzati da altri componenti parte dell'applicazione complessiva. ",-1),QC=o("br",null,null,-1),YC=o("ul",null,[o("li",null,"Se un altro componente ha un tag h1, lo stile non sarà modificato."),o("li",null,"Questo è molto utile quando riutilizzi componenti che hai già scritto per altre applicazioni o quando includi librerie Open Source pubblicate da altre persone.")],-1),ZC={__name:"30",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[jC,VC,BC,UC,JC,QC,YC]),_:1},16))}},GC=T(ZC,[["__file","/@slidev/slides/30.md"]]),XC={class:"slidev-icon",viewBox:"0 0 256 256",width:"1.2em",height:"1.2em"},eT=o("path",{fill:"currentColor",d:"M200 32h-36.26a47.92 47.92 0 0 0-71.48 0H56a16 16 0 0 0-16 16v168a16 16 0 0 0 16 16h144a16 16 0 0 0 16-16V48a16 16 0 0 0-16-16Zm-72 0a32 32 0 0 1 32 32H96a32 32 0 0 1 32-32Zm72 184H56V48h26.75A47.93 47.93 0 0 0 80 64v8a8 8 0 0 0 8 8h80a8 8 0 0 0 8-8v-8a47.93 47.93 0 0 0-2.75-16H200Z"},null,-1),tT=[eT];function nT(e,t){return g(),ie("svg",XC,tT)}const oT={name:"ph-clipboard",render:nT},iT={class:"slidev-icon",viewBox:"0 0 256 256",width:"1.2em",height:"1.2em"},sT=o("path",{fill:"currentColor",d:"M173.66 98.34a8 8 0 0 1 0 11.32l-56 56a8 8 0 0 1-11.32 0l-24-24a8 8 0 0 1 11.32-11.32L112 148.69l50.34-50.35a8 8 0 0 1 11.32 0ZM232 128A104 104 0 1 1 128 24a104.11 104.11 0 0 1 104 104Zm-16 0a88 88 0 1 0-88 88a88.1 88.1 0 0 0 88-88Z"},null,-1),aT=[sT];function lT(e,t){return g(),ie("svg",iT,aT)}const rT={name:"ph-check-circle",render:lT},cT=["title"],uT=Pe({__name:"CodeBlockWrapper",props:{ranges:{default:()=>[]},at:{type:Number,default:void 0},maxHeight:{type:String,default:void 0}},setup(e){const t=e;$(I);const n=$(mi),i=$(eo),s=$(fi);function a(m=5){const f=[],h="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",v=h.length;for(let S=0;S<m;S++)f.push(h.charAt(Math.floor(Math.random()*v)));return f.join("")}const l=Z(),r=wt();bn(()=>{const m=t.at==null?i==null?void 0:i.value.length:t.at,f=N(()=>s!=null&&s.value?t.ranges.length-1:Math.min(Math.max(0,((n==null?void 0:n.value)||0)-(m||0)),t.ranges.length-1)),h=N(()=>t.ranges[f.value]||"");if(t.ranges.length>=2&&!(s!=null&&s.value)){const v=a(),S=h1(t.ranges.length-1).map(x=>v+x);i!=null&&i.value&&(i.value.push(...S),ji(()=>S.forEach(x=>bl(i.value,x)),r))}yo(()=>{if(!l.value)return;const S=l.value.querySelector(".shiki-dark")?Array.from(l.value.querySelectorAll(".shiki")):[l.value];for(const x of S){const k=Array.from(x.querySelectorAll(".line")),C=Jm(k.length,h.value);if(k.forEach((b,K)=>{const A=C.includes(K+1);b.classList.toggle(Yn,!0),b.classList.toggle("highlighted",A),b.classList.toggle("dishonored",!A)}),t.maxHeight){const b=Array.from(x.querySelectorAll(".line.highlighted"));b.reduce((A,R)=>R.offsetHeight+A,0)>l.value.offsetHeight?b[0].scrollIntoView({behavior:"smooth",block:"start"}):b.length>0&&b[Math.round((b.length-1)/2)].scrollIntoView({behavior:"smooth",block:"center"})}}})});const{copied:u,copy:d}=h0();function p(){var f,h;const m=(h=(f=l.value)==null?void 0:f.querySelector(".slidev-code"))==null?void 0:h.textContent;m&&d(m)}return(m,f)=>{const h=rT,v=oT;return g(),ie("div",{ref_key:"el",ref:l,class:"slidev-code-wrapper relative group",style:tt({"max-height":t.maxHeight,"overflow-y":t.maxHeight?"scroll":void 0})},[Bt(m.$slots,"default"),L(Ee).codeCopy?(g(),ie("button",{key:0,class:"slidev-code-copy absolute top-0 right-0 transition opacity-0 group-hover:opacity-20 hover:!opacity-100",title:L(u)?"Copied":"Copy",onClick:f[0]||(f[0]=S=>p())},[L(u)?(g(),z(h,{key:0,class:"p-2 w-8 h-8"})):(g(),z(v,{key:1,class:"p-2 w-8 h-8"}))],8,cT)):Se("v-if",!0)],4)}}}),Ie=T(uT,[["__file","/home/antonio/WORK/ITI_Agnelli/Materie/slidev/node_modules/@slidev/client/builtin/CodeBlockWrapper.vue"]]),dT=o("h1",null,"SvelteKit",-1),pT=o("p",null,"Svelte Components",-1),mT=o("pre",{class:"slidev-code language-html"},[o("code",null,[o("span",{class:"line"},[o("span",{class:"token tag"},[o("span",{class:"token tag"},[o("span",{class:"token punctuation"},"<"),c("h1")]),o("span",{class:"token punctuation"},">")]),c("My name is John Doe!"),o("span",{class:"token tag"},[o("span",{class:"token tag"},[o("span",{class:"token punctuation"},"</"),c("h1")]),o("span",{class:"token punctuation"},">")])])])],-1),fT=o("ul",null,[o("li",null,"Questo è un componente Svelte valido"),o("li",null,"Include solo la parte di contenuto"),o("li",null,"Non ha nessuno stuile e nessuna logica di controllo")],-1),hT={__name:"31",setup(e){const t={};return $(I),(n,i)=>{const s=Ie;return g(),z(M,O(E(t)),{default:w(()=>[dT,pT,j(s,me({},{ranges:[""]}),{default:w(()=>[mT]),_:1},16),fT]),_:1},16)}}},vT=T(hT,[["__file","/@slidev/slides/31.md"]]),_T=o("h1",null,"SvelteKit",-1),gT=o("p",null,"Svelte Components",-1),bT=o("pre",{class:"slidev-code language-html"},[o("code",null,[o("span",{class:"line"},[o("span",{class:"token tag"},[o("span",{class:"token tag"},[o("span",{class:"token punctuation"},"<"),c("h1")]),o("span",{class:"token punctuation"},">")]),c("My name is John Doe!"),o("span",{class:"token tag"},[o("span",{class:"token tag"},[o("span",{class:"token punctuation"},"</"),c("h1")]),o("span",{class:"token punctuation"},">")])]),c(`
`),o("span",{class:"line"}),c(`
...
`),o("span",{class:"line"},"	}"),c(`
`),o("span",{class:"line"},[o("span",{class:"token tag"},[o("span",{class:"token tag"},[o("span",{class:"token punctuation"},"</"),c("style")]),o("span",{class:"token punctuation"},">")])])])],-1),yT=o("ul",null,[o("li",null,"Questo è un componente Svelte valido"),o("li",null,"Include la parte di contenuto e di stile")],-1),ST={__name:"32",setup(e){const t={};return $(I),(n,i)=>{const s=Ie;return g(),z(M,O(E(t)),{default:w(()=>[_T,gT,j(s,me({},{ranges:[""]}),{default:w(()=>[bT]),_:1},16),yT]),_:1},16)}}},wT=T(ST,[["__file","/@slidev/slides/32.md"]]),xT=o("h1",null,"SvelteKit",-1),kT=o("p",null,"Svelte Components",-1),$T=o("pre",{class:"slidev-code language-html"},[o("code",null,[o("span",{class:"line"},[o("span",{class:"token tag"},[o("span",{class:"token tag"},[o("span",{class:"token punctuation"},"<"),c("script")]),o("span",{class:"token punctuation"},">")])]),c(`
`),o("span",{class:"line"},"	let name = 'John Doe';"),c(`
`),o("span",{class:"line"},[o("span",{class:"token tag"},[o("span",{class:"token tag"},[o("span",{class:"token punctuation"},"</"),c("script")]),o("span",{class:"token punctuation"},">")])])])],-1),zT=o("ul",null,[o("li",null,"Questo è un componente Svelte valido."),o("li",null,"Non ha nessuno contenuto e non verrà visualizzato."),o("li",null,"Anche se apparentemente non ha senso, lo ha in quanto posso avere componenti che svolgono solo funzioni utilizzate da altri componenti.")],-1),IT=o("p",null,"Esempio:",-1),CT=o("ul",null,[o("li",null,"un componente che fornisce accesso ad un DB nosql non ha nessuna parte di UI, ma è di grande utilità all’interno della mia applicazione.")],-1),TT={__name:"33",setup(e){const t={};return $(I),(n,i)=>{const s=Ie;return g(),z(M,O(E(t)),{default:w(()=>[xT,kT,j(s,me({},{ranges:[""]}),{default:w(()=>[$T]),_:1},16),zT,IT,CT]),_:1},16)}}},ET=T(TT,[["__file","/@slidev/slides/33.md"]]),OT=o("h1",null,"SvelteKit",-1),MT=o("p",null,"Hello World",-1),AT=o("ul",null,[o("li",null,[o("p",null,"Vediamo i semplici passi per creare un progetto base SvelteKit")]),o("li",null,[o("p",null,"Utilizzeremo il progetto base per provare a analizzare e comprendere le principali carattristiche:"),o("ul",null,[o("li",null,"del linguaggio Svelte e delle principali funzionalità"),o("li",null,"dello sviluppo per componenti"),o("li",null,"delle funzioni più importanti di SvelteKit")])]),o("li",null,[o("p",null,"Di seguito i link alla documentazione e tutoria di Svelte e SvelteKit"),o("ul",null,[o("li",null,[o("a",{href:"https://svelte.dev/tutorial/basics",target:"_blank",rel:"noopener"},"Svelte tutorial")]),o("li",null,[o("a",{href:"https://learn.svelte.dev/tutorial/welcome-to-svelte",target:"_blank",rel:"noopener"},"Tutorial Interattivo Svelte")]),o("li",null,[o("a",{href:"https://kit.svelte.dev/docs/introduction",target:"_blank",rel:"noopener"},"Introduzione a SvelteKit")])])])],-1),PT=o("p",null,[o("em",null,[o("strong",null,"Questi link sono il riferimento per gli studenti e vi suggerisco di studiarli e di utilizzarli per tutto il tempo necessario ad apprendere Svlete e SvelteKit")])],-1),KT={__name:"34",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[OT,MT,AT,PT]),_:1},16))}},LT=T(KT,[["__file","/@slidev/slides/34.md"]]),RT=o("h1",null,"SvelteKit",-1),HT=o("p",null,"Hello World: Creare un Progetto SvelteKit",-1),WT=o("ul",null,[o("li",null,[c("Per sviluppare con Svelte e SvelteKit è necessario: "),o("ul",null,[o("li",null,[c("nodejs (almeno versione 18) —> "),o("a",{href:"http://cedws",target:"_blank",rel:"noopener"},"Come installare nodejs su Linux")]),o("li",null,"npm"),o("li",null,"git")])]),o("li",null,"Assicurati che siano instllati sul tuo sistema eseguendo i seguenti comandi:")],-1),NT=o("pre",{class:"slidev-code language-bash"},[o("code",null,[o("span",{class:"line"},[o("span",{class:"token operator"},">"),c(),o("span",{class:"token function"},"node"),c(),o("span",{class:"token parameter variable"},"--version")]),c(`
...
`),o("span",{class:"line"},[o("span",{class:"token function"},"git"),c(" version "),o("span",{class:"token number"},"2.34"),c(".1")])])],-1),DT={__name:"35",setup(e){const t={};return $(I),(n,i)=>{const s=Ie;return g(),z(M,O(E(t)),{default:w(()=>[RT,HT,WT,j(s,me({},{ranges:[""]}),{default:w(()=>[NT]),_:1},16)]),_:1},16)}}},qT=T(DT,[["__file","/@slidev/slides/35.md"]]),FT=o("h1",null,"SvelteKit",-1),jT=o("p",null,"Hello World: Creare un Progetto SvelteKit",-1),VT=o("ul",null,[o("li",null,"Spostati nella tua directory di lavoro (es: cd ~/tmp)"),o("li",null,[c("Da qui crea lo "),o("a",{href:"https://en.wikipedia.org/wiki/Scaffold_(programming)",target:"_blank",rel:"noopener"},[o("strong",null,"scaffolding")]),c(" di un’applicazione base seguendo le semplici istruzioni a video")])],-1),BT=o("pre",{class:"slidev-code language-bash"},[o("code",null,[o("span",{class:"line"},[o("span",{class:"token operator"},">"),c(),o("span",{class:"token function"},"npm"),c(" create svelte@latest hello-word-svelte-kit")]),c(`
`),o("span",{class:"line"}),c(`
...
`),o("span",{class:"line"},"└")])],-1),UT={__name:"36",setup(e){const t={};return $(I),(n,i)=>{const s=Ie;return g(),z(M,O(E(t)),{default:w(()=>[FT,jT,VT,j(s,me({},{ranges:[""]}),{default:w(()=>[BT]),_:1},16)]),_:1},16)}}},JT=T(UT,[["__file","/@slidev/slides/36.md"]]),QT=o("h1",null,"SvelteKit",-1),YT=o("p",null,"Hello World: Creare un Progetto SvelteKit",-1),ZT=o("pre",{class:"slidev-code language-bash"},[o("code",null,[o("span",{class:"line"},[c("◆  Select additional options "),o("span",{class:"token punctuation"},"("),c("use arrow keys/space bar"),o("span",{class:"token punctuation"},")")]),c(`
...
`),o("span",{class:"line"}),c(`
`),o("span",{class:"line"},"To close the dev server, hit Ctrl-C")])],-1),GT={__name:"37",setup(e){const t={};return $(I),(n,i)=>{const s=Ie;return g(),z(M,O(E(t)),{default:w(()=>[QT,YT,j(s,me({},{ranges:[""]}),{default:w(()=>[ZT]),_:1},16)]),_:1},16)}}},XT=T(GT,[["__file","/@slidev/slides/37.md"]]),eE="/TPSI/4/svelte/assets/svelte_0000-8c1f6978.png",tE=o("h1",null,"SvelteKit",-1),nE=o("p",null,"Hello World: Creare un Progetto SvelteKit",-1),oE=o("ul",null,[o("li",null,[c("Ora nella directory "),o("strong",null,"hello-word-svelte-kit"),c(" è presente un progetto base realizzato con SvelteKit")]),o("li",null,"Per portare a termine la creazione del progetto eseguire i seguenti comandi")],-1),iE=o("pre",{class:"slidev-code language-bash"},[o("code",null,[o("span",{class:"line"},[o("span",{class:"token operator"},">"),c(),o("span",{class:"token builtin class-name"},"cd"),c(" hello-word-svelte-kit  "),o("span",{class:"token comment"},"# mi sposto nella directory hello-word-svelte-kit")]),c(`
...
`),o("span",{class:"line"}),c(`
`),o("span",{class:"line"},[c("found "),o("span",{class:"token number"},"0"),c(" vulnerabilities")])])],-1),sE=o("ul",null,[o("li",null,"Se non si sono verificatri errori, il progetto è pronto per l’esecuzione")],-1),aE=o("img",{src:eE,class:"mx-auto",width:"100"},null,-1),lE={__name:"38",setup(e){const t={};return $(I),(n,i)=>{const s=Ie;return g(),z(M,O(E(t)),{default:w(()=>[tE,nE,oE,j(s,me({},{ranges:[""]}),{default:w(()=>[iE]),_:1},16),sE,aE]),_:1},16)}}},rE=T(lE,[["__file","/@slidev/slides/38.md"]]),cE=o("h1",null,"SvelteKit",-1),uE=o("p",null,"Hello World: Eseguiamo il progetto",-1),dE=o("ul",null,[o("li",null,"Per eseguire il progetto, all’interno della directory di progetto (hello-word-svelte-kit), eseguire il seguente comando")],-1),pE=o("pre",{class:"slidev-code language-bash"},[o("code",null,[o("span",{class:"line"},[o("span",{class:"token operator"},">"),c(),o("span",{class:"token function"},"npm"),c(" run dev -- "),o("span",{class:"token parameter variable"},"--open")]),c(`
`),o("span",{class:"line"}),c(`
...
`),o("span",{class:"line"},[c("  ➜  press h to show "),o("span",{class:"token builtin class-name"},"help")])])],-1),mE=o("ul",null,[o("li",null,[c("Viene automaticamente aperta una fienstra del browser che punta al seguente indirizzo: "),o("a",{href:"http://localhost:5173/",target:"_blank",rel:"noopener"},"http://localhost:5173/")])],-1),fE={__name:"39",setup(e){const t={};return $(I),(n,i)=>{const s=Ie;return g(),z(M,O(E(t)),{default:w(()=>[cE,uE,dE,j(s,me({},{ranges:[""]}),{default:w(()=>[pE]),_:1},16),mE]),_:1},16)}}},hE=T(fE,[["__file","/@slidev/slides/39.md"]]),vE="/TPSI/4/svelte/assets/svelte_009-3fc6e637.png",_E=o("h1",null,"SvelteKit",-1),gE=o("p",null,"Hello World: Eseguiamo il progetto",-1),bE=o("img",{src:vE,class:"mx-auto",width:"500"},null,-1),yE={__name:"40",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[_E,gE,bE]),_:1},16))}},SE=T(yE,[["__file","/@slidev/slides/40.md"]]),wE="/TPSI/4/svelte/assets/svelte_010-f742c650.png",xE=o("h1",null,"SvelteKit",-1),kE=o("p",null,"Hello World: Eseguiamo il progetto",-1),$E=o("img",{src:wE,class:"mx-auto",width:"450"},null,-1),zE={__name:"41",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[xE,kE,$E]),_:1},16))}},IE=T(zE,[["__file","/@slidev/slides/41.md"]]),CE=o("h1",null,"SvelteKit",-1),TE=o("p",null,"Hello World: Analisi del progetto base",-1),EE=o("ul",null,[o("li",null,[c("Quest’applicazione ci permette di comprendere alcuni concetti molto importanti: "),o("ol",null,[o("li",null,[o("strong",null,"Ogni pagina dell’applicazione è un componente Svelte")]),o("li",null,[o("strong",null,"Il routing è implementato la gerarchia di directory nel filesystem")]),o("li",null,[o("strong",null,"Ogni pagina è una directory all’interno di src/routes")]),o("li",null,[o("strong",null,"La home page è un componente Svelte all’interno di src/routes")]),o("li",null,[o("strong",null,"Una pagina(componente) può includere uno o più componenti esterni")])])])],-1),OE={__name:"42",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[CE,TE,EE]),_:1},16))}},ME=T(OE,[["__file","/@slidev/slides/42.md"]]),AE=o("h1",null,"SvelteKit",-1),PE=o("p",null,"Hello World: Analisi del progetto base",-1),KE=o("ul",null,[o("li",null,"Analizziamo il progetto generato")],-1),LE=o("pre",{class:"slidev-code language-bash"},[o("code",null,[o("span",{class:"line"},"src"),c(`
...
`),o("span",{class:"line"},[c("        └── +page.svelte --"),o("span",{class:"token operator"},">"),c(" la pagina sverdle "),o("span",{class:"token punctuation"},"("),c("componente svelte"),o("span",{class:"token punctuation"},")")])])],-1),RE={__name:"43",setup(e){const t={};return $(I),(n,i)=>{const s=Ie;return g(),z(M,O(E(t)),{default:w(()=>[AE,PE,KE,j(s,me({},{ranges:[""]}),{default:w(()=>[LE]),_:1},16)]),_:1},16)}}},HE=T(RE,[["__file","/@slidev/slides/43.md"]]),WE=o("h1",null,"SvelteKit",-1),NE=o("p",null,"Hello World: Analisi del progetto base",-1),DE=o("ul",null,[o("li",null,[o("p",null,"Da questa prima analisi possiamo dedurre che:"),o("ul",null,[o("li",null,[c("Ogni pagina è composta da: "),o("ul",null,[o("li",null,"una directory all’interno di src/router. Il nome della directory coincide con la URL della pagina (quindi niente spazi, ma usiamo _)"),o("li",null,[c("un file nominato "),o("strong",null,"+page-svelte"),c(" che è un componente completo ed indipendente che include HTML, CSS e JS")])])]),o("li",null,[c("Ogni componente che non è una pagina è formato da un file chiamato "),o("em",null,[o("strong",null,"<nome_componente>.svelte")])]),o("li",null,"Il routing tra pagine viene gestito automaticamente da SvelteKit se si rispetta la convenzione descritta sopra")])]),o("li",null,[o("p",null,[o("strong",null,[c("Segue ora un’analisi live a cura del professore ("),o("code",null,"necessario prendere appunti"),c(")")])])])],-1),qE={__name:"44",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[WE,NE,DE]),_:1},16))}},FE=T(qE,[["__file","/@slidev/slides/44.md"]]),jE=o("h1",null,"SvelteKit",-1),VE=o("p",null,"Hello World: Esercitazione_01",-1),BE=o("ul",null,[o("li",null,"Creare ed installare il progetto base SvelteKit come spiegato sopra"),o("li",null,"Eseguire l’applicazione"),o("li",null,"Consegnare su github il progetto appena creato"),o("li",null,[c("IMPORTANTE: non fare il push della directory "),o("em",null,[o("strong",null,"node_modules")])])],-1),UE={__name:"45",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[jE,VE,BE]),_:1},16))}},JE=T(UE,[["__file","/@slidev/slides/45.md"]]),QE="/TPSI/4/svelte/assets/svelte_011-5ebbb473.png",YE=o("h1",null,"SvelteKit",-1),ZE=o("p",null,"Hello World: Esercitazione_02",-1),GE=o("ul",null,[o("li",null,"provare a modificare la home page del progetto in modo che appaia come in figura")],-1),XE=o("img",{src:QE,class:"mx-auto",width:"400"},null,-1),eO=o("ul",null,[o("li",null,"Consegnare su github il progetto modificato")],-1),tO={__name:"46",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[YE,ZE,GE,XE,eO]),_:1},16))}},nO=T(tO,[["__file","/@slidev/slides/46.md"]]),oO="/TPSI/4/svelte/assets/svelte_012-0ceab35c.png",iO=o("h1",null,"SvelteKit",-1),sO=o("p",null,"Hello World: Esercitazione_03",-1),aO=o("ul",null,[o("li",null,"provare a modificare il layout del progetto in modo che appaia come in figura")],-1),lO=o("p",null,[o("br"),o("br"),o("img",{src:oO,class:"mx-auto",width:"650"})],-1),rO=o("ul",null,[o("li",null,"Consegnare su github il progetto modificato")],-1),cO={__name:"47",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[iO,sO,aO,lO,rO]),_:1},16))}},uO=T(cO,[["__file","/@slidev/slides/47.md"]]),dO="/TPSI/4/svelte/assets/svelte_013-7818c60a.png",pO=o("h1",null,"SvelteKit",-1),mO=o("p",null,"Hello World: Esercitazione_04",-1),fO=o("ul",null,[o("li",null,"provare a modificare la pagina about in modo che appaia come in figura")],-1),hO=o("img",{src:dO,class:"mx-auto",width:"550"},null,-1),vO=o("ul",null,[o("li",null,"Consegnare su github il progetto modificato")],-1),_O={__name:"48",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[pO,mO,fO,hO,vO]),_:1},16))}},gO=T(_O,[["__file","/@slidev/slides/48.md"]]),bO="/TPSI/4/svelte/assets/svelte_014-9655b9ec.png",yO=o("h1",null,"SvelteKit",-1),SO=o("p",null,"Hello World: Esercitazione_05",-1),wO=o("ul",null,[o("li",null,"provare a modificare il componente counter in modo che si incrementi o decrementi di due unità alla pressione dei pulsati + o -")],-1),xO=o("br",null,null,-1),kO=o("img",{src:bO,class:"mx-auto",width:"500"},null,-1),$O=o("ul",null,[o("li",null,"Consegnare su github il progetto modificato")],-1),zO={__name:"49",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[yO,SO,wO,xO,kO,$O]),_:1},16))}},IO=T(zO,[["__file","/@slidev/slides/49.md"]]),Zm="/TPSI/4/svelte/assets/svelte_015-368b64e2.png",CO=o("h1",null,"SvelteKit",-1),TO=o("p",null,"Creiamo un componente",-1),EO=o("ul",null,[o("li",null,"Vediamo ora come creare un nostro componente e utilizzarlo nelle pagine della nostra applicazione"),o("li",null,"Realizzeremo il componente introdotto alla slide #28 e successive"),o("li",null,"Lo visualizzeremo sia sulla pagina home che sulla pagina about")],-1),OO=o("img",{src:Zm,class:"mx-auto",width:"450"},null,-1),MO={__name:"50",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[CO,TO,EO,OO]),_:1},16))}},AO=T(MO,[["__file","/@slidev/slides/50.md"]]),PO=o("h1",null,"SvelteKit",-1),KO=o("p",null,"Creiamo un componente",-1),LO=o("ul",null,[o("li",null,"Per una corretta organizzazione del codice metetremo i nostri componenti nella directory lib"),o("li",null,[c("Il nostro componente si chiama "),o("strong",null,"Banner")]),o("li",null,[c("Quindi dobbiamo creare una directory "),o("em",null,"components"),c(" in src/lib e al suo interno creare un file "),o("em",null,"banner.svelte")])],-1),RO=o("pre",{class:"slidev-code language-bash"},[o("code",null,[o("span",{class:"line"},[o("span",{class:"token operator"},">"),c(),o("span",{class:"token builtin class-name"},"cd"),c(" src/lib")]),c(`
...
`),o("span",{class:"line"},"│   │   └── banner.svelte")])],-1),HO=o("ul",null,[o("li",null,"Ora editiamo il file banner.svelte ed utilizziamo il codice di slide #28")],-1),WO={__name:"51",setup(e){const t={};return $(I),(n,i)=>{const s=Ie;return g(),z(M,O(E(t)),{default:w(()=>[PO,KO,LO,j(s,me({},{ranges:[""]}),{default:w(()=>[RO]),_:1},16),HO]),_:1},16)}}},NO=T(WO,[["__file","/@slidev/slides/51.md"]]),DO=o("h1",null,"SvelteKit",-1),qO=o("p",null,"Creiamo un componente",-1),FO=o("ul",null,[o("li",null,[c("Il componente "),o("strong",null,"banner"),c(" è ora disponibile per essere utilizzato")]),o("li",null,[c("Per fare ciò dobbiamo "),o("em",null,[o("strong",null,"importarlo")]),c(" nella pagina in cui vogliamo utilizzarlo")]),o("li",null,[c("Partiamo modificando la home e quindi editiamo il file "),o("em",null,"src/routes/+page.svelte")])],-1),jO=o("pre",{class:"slidev-code language-html"},[o("code",null,[o("span",{class:"line"},[o("span",{class:"token tag"},[o("span",{class:"token tag"},[o("span",{class:"token punctuation"},"<"),c("script")]),o("span",{class:"token punctuation"},">")])]),c(`
...
`),o("span",{class:"line"},[o("span",{class:"token tag"},[o("span",{class:"token tag"},[o("span",{class:"token punctuation"},"</"),c("script")]),o("span",{class:"token punctuation"},">")])])])],-1),VO=o("ul",null,[o("li",null,[c("Ora abbiamo a disposizione un nuovo tag HTML che si chiama "),o("strong",null,"<Banner>")]),o("li",null,"Questo è un componente Web e possiamo usarlo come qualsiasi altro tag html"),o("li",null,"Come anticipato il paradigma dei web component offre infinite possibilità")],-1),BO={__name:"52",setup(e){const t={};return $(I),(n,i)=>{const s=Ie;return g(),z(M,O(E(t)),{default:w(()=>[DO,qO,FO,j(s,me({},{ranges:[""]}),{default:w(()=>[jO]),_:1},16),VO]),_:1},16)}}},UO=T(BO,[["__file","/@slidev/slides/52.md"]]),JO=o("h1",null,"SvelteKit",-1),QO=o("p",null,"Creiamo un componente",-1),YO=o("ul",null,[o("li",null,"Ora usiamo il componente nella home page")],-1),ZO=o("pre",{class:"slidev-code language-html"},[o("code",null,[o("span",{class:"line"},[o("span",{class:"token tag"},[o("span",{class:"token tag"},[o("span",{class:"token punctuation"},"<"),c("section")]),o("span",{class:"token punctuation"},">")])]),c(`
...
`),o("span",{class:"line"},[o("span",{class:"token tag"},[o("span",{class:"token tag"},[o("span",{class:"token punctuation"},"</"),c("section")]),o("span",{class:"token punctuation"},">")])])])],-1),GO={__name:"53",setup(e){const t={};return $(I),(n,i)=>{const s=Ie;return g(),z(M,O(E(t)),{default:w(()=>[JO,QO,YO,j(s,me({},{ranges:[""]}),{default:w(()=>[ZO]),_:1},16)]),_:1},16)}}},XO=T(GO,[["__file","/@slidev/slides/53.md"]]),e4=o("h1",null,"SvelteKit",-1),t4=o("p",null,"Creiamo un componente",-1),n4=o("ul",null,[o("li",null,"Ora facciamo partire l’applicazione e verifichiamo che tutto sia corretto")],-1),o4=o("br",null,null,-1),i4=o("img",{src:Zm,class:"mx-auto",width:"500"},null,-1),s4={__name:"54",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[e4,t4,n4,o4,i4]),_:1},16))}},a4=T(s4,[["__file","/@slidev/slides/54.md"]]),l4="/TPSI/4/svelte/assets/svelte_016-51073a42.png",r4=o("h1",null,"SvelteKit",-1),c4=o("p",null,"Hello World: Esercitazione_06",-1),u4=o("ul",null,[o("li",null,"provare a modificare la pagina about aggiungendo il componente Banner")],-1),d4=o("br",null,null,-1),p4=o("img",{src:l4,class:"mx-auto",width:"550"},null,-1),m4=o("ul",null,[o("li",null,"Consegnare su github il progetto modificato")],-1),f4={__name:"55",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[r4,c4,u4,d4,p4,m4]),_:1},16))}},h4=T(f4,[["__file","/@slidev/slides/55.md"]]),v4=o("h1",null,"SvelteKit",-1),_4=o("p",null,"Creiamo un componente",-1),g4=o("ul",null,[o("li",null,"Quindi una volta definito il componente, esso sarà riutilizzabile in qualsiasi pagina e sezione del nostro sito"),o("li",null,"Ma ancor meglio potrà essere utilizzato anche in altri siti e pagine"),o("li",null,[c("Quindi i componenti web ci permettono di implementare importanti proprietà dello sviluppo software, quali "),o("ul",null,[o("li",null,"incapsulamento"),o("li",null,"isolamento"),o("li",null,"riutilizzabilità del codice")])]),o("li",null,"Per questi motivi lo sviluppo component base è oggi alla base di tutti i principali framework di sviluppo per il mondo web (web, mobile, games, web app, desktop app)")],-1),b4={__name:"56",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[v4,_4,g4]),_:1},16))}},y4=T(b4,[["__file","/@slidev/slides/56.md"]]),S4=o("h1",null,"SvelteKit",-1),w4=o("p",null,"Variable Substitution",-1),x4=o("ul",null,[o("li",null,"Analizziamo più in dettaglio il componente Banner")],-1),k4=o("pre",{class:"slidev-code language-html"},[o("code",null,[o("span",{class:"line"},[o("span",{class:"token tag"},[o("span",{class:"token tag"},[o("span",{class:"token punctuation"},"<"),c("script")]),o("span",{class:"token punctuation"},">")])]),c(`
`),o("span",{class:"line"},"    let name = 'John Doe';"),c(`
...
`),o("span",{class:"line"}),c(`
`),o("span",{class:"line"},[o("span",{class:"token tag"},[o("span",{class:"token tag"},[o("span",{class:"token punctuation"},"<"),c("h1")]),o("span",{class:"token punctuation"},">")]),c("My name is {name}!"),o("span",{class:"token tag"},[o("span",{class:"token tag"},[o("span",{class:"token punctuation"},"</"),c("h1")]),o("span",{class:"token punctuation"},">")])])])],-1),$4=o("ul",null,[o("li",null,[c("Nella sezione JS del componente abbiamo solo definito una variabile di nome "),o("em",null,"name"),c(" ed assegnato un valore string")]),o("li",null,[c("Nella sezione HTML del componente abbiamo utilizzato la variabile all’interno di normale codice HTML tramite "),o("code",null,"{}")])],-1),z4=o("div",{style:{"background-color":"green",color:"yellow",padding:"10px","line-height":"30px"}},[o("p",null,"In svelte il costrutto {< var name >} rappresenta una sostituzione di variabili")],-1),I4=o("ul",null,[o("li",null,[c("Pertanto quando il componente sarà compilato ogni occorrenza di "),o("code",null,"{< var name>}"),c(" sarà sostituito con il valore attribuito alla variabile "),o("em",null,"var name")])],-1),C4={__name:"57",setup(e){const t={};return $(I),(n,i)=>{const s=Ie;return g(),z(M,O(E(t)),{default:w(()=>[S4,w4,x4,j(s,me({},{ranges:[""]}),{default:w(()=>[k4]),_:1},16),$4,z4,I4]),_:1},16)}}},T4=T(C4,[["__file","/@slidev/slides/57.md"]]),E4="/TPSI/4/svelte/assets/svelte_017-d1ecfa98.png",O4=o("h1",null,"SvelteKit",-1),M4=o("p",null,"Hello World: Esercitazione_07",-1),A4=o("ul",null,[o("li",null,"Provare a modificare il componente Banner in modo che visualizzi il proprio nome e cognome"),o("li",null,"Verificare che il banner appaia modificato in tutte le pagine")],-1),P4=o("br",null,null,-1),K4=o("img",{src:E4,class:"mx-auto",width:"450"},null,-1),L4=o("ul",null,[o("li",null,"Consegnare su github il progetto modificato")],-1),R4={__name:"58",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[O4,M4,A4,P4,K4,L4]),_:1},16))}},H4=T(R4,[["__file","/@slidev/slides/58.md"]]),W4=o("h1",null,"SvelteKit",-1),N4=o("p",null,"Code Execution",-1),D4=o("ul",null,[o("li",null,"In molti casi sostituire una variabile non è sufficiente, ma si rende necessario l’esecuzione di un codice JS"),o("li",null,[c("Anche in questa situazione il costrutto "),o("code",null,"{}"),c(" viene in nostro aiuto")]),o("li",null,[c("Infatti svelte durante la compilazione, esegue il codice JS contenuto in "),o("code",null,"{}"),c(" e sostituisce il suo output nel codice HTML")]),o("li",null,"Vediamo un esempio")],-1),q4=o("pre",{class:"slidev-code language-html"},[o("code",null,[o("span",{class:"line"},[o("span",{class:"token tag"},[o("span",{class:"token tag"},[o("span",{class:"token punctuation"},"<"),c("script")]),o("span",{class:"token punctuation"},">")])]),c(`
`),o("span",{class:"line"},"    let name = 'John Doe';"),c(`
`),o("span",{class:"line"},[o("span",{class:"token tag"},[o("span",{class:"token tag"},[o("span",{class:"token punctuation"},"</"),c("script")]),o("span",{class:"token punctuation"},">")])]),c(`
`),o("span",{class:"line"}),c(`
`),o("span",{class:"line"},[o("span",{class:"token tag"},[o("span",{class:"token tag"},[o("span",{class:"token punctuation"},"<"),c("h1")]),o("span",{class:"token punctuation"},">")]),c("My name is {name.toLocaleUpperCase()}!"),o("span",{class:"token tag"},[o("span",{class:"token tag"},[o("span",{class:"token punctuation"},"</"),c("h1")]),o("span",{class:"token punctuation"},">")])])])],-1),F4=o("ul",null,[o("li",null,[c("Quando questo codice viene compilato, viene prima richiamato il metodo "),o("em",null,"toUpperCase"),c(" sulla variabile(oggetto) name")]),o("li",null,[c("Successivamente il risultato di questa esecuzione viene sostitutito "),o("em",null,"verbatim"),c(" nel codice HTML")])],-1),j4={__name:"59",setup(e){const t={};return $(I),(n,i)=>{const s=Ie;return g(),z(M,O(E(t)),{default:w(()=>[W4,N4,D4,j(s,me({},{ranges:[""]}),{default:w(()=>[q4]),_:1},16),F4]),_:1},16)}}},V4=T(j4,[["__file","/@slidev/slides/59.md"]]),B4="/TPSI/4/svelte/assets/svelte_018-4a3d51b3.png",U4=o("h1",null,"SvelteKit",-1),J4=o("p",null,"Code Execution",-1),Q4=o("img",{src:B4,class:"mx-auto",width:"500"},null,-1),Y4={__name:"60",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[U4,J4,Q4]),_:1},16))}},Z4=T(Y4,[["__file","/@slidev/slides/60.md"]]),G4=o("h1",null,"SvelteKit",-1),X4=o("p",null,"Code Execution",-1),eM=o("ul",null,[o("li",null,"Ovviamente non siamo limitati ai metodi degli oggetti standard di JS"),o("li",null,"Ma possiamo anche richiamare nostre funzioni"),o("li",null,"Per esempio vediamo come richiamare una funzione che prende il nostro nome e lo stampa al contrario tutto maiuscolo")],-1),tM=o("pre",{class:"slidev-code language-html"},[o("code",null,[o("span",{class:"line"},[o("span",{class:"token tag"},[o("span",{class:"token tag"},[o("span",{class:"token punctuation"},"<"),c("script")]),o("span",{class:"token punctuation"},">")])]),c(`
...
`),o("span",{class:"line"},[o("span",{class:"token tag"},[o("span",{class:"token tag"},[o("span",{class:"token punctuation"},"</"),c("script")]),o("span",{class:"token punctuation"},">")])]),c(`
`),o("span",{class:"line"}),c(`
`),o("span",{class:"line"},[o("span",{class:"token tag"},[o("span",{class:"token tag"},[o("span",{class:"token punctuation"},"<"),c("h1")]),o("span",{class:"token punctuation"},">")]),c("My name is {reverse_string(name)}!"),o("span",{class:"token tag"},[o("span",{class:"token tag"},[o("span",{class:"token punctuation"},"</"),c("h1")]),o("span",{class:"token punctuation"},">")])])])],-1),nM={__name:"61",setup(e){const t={};return $(I),(n,i)=>{const s=Ie;return g(),z(M,O(E(t)),{default:w(()=>[G4,X4,eM,j(s,me({},{ranges:[""]}),{default:w(()=>[tM]),_:1},16)]),_:1},16)}}},oM=T(nM,[["__file","/@slidev/slides/61.md"]]),iM="/TPSI/4/svelte/assets/svelte_019-600c2437.png",sM=o("h1",null,"SvelteKit",-1),aM=o("p",null,"Code Execution",-1),lM=o("ul",null,[o("li",null,[c("Quando questo codice viene compilato, viene prima richiamato la nostra funzione "),o("em",null,"reverse_string")]),o("li",null,[c("Successivamente il risultato di questa esecuzione viene sostitutito "),o("em",null,"verbatim"),c(" nel codice HTML")])],-1),rM=o("br",null,null,-1),cM=o("img",{src:iM,class:"mx-auto",width:"400"},null,-1),uM={__name:"62",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[sM,aM,lM,rM,cM]),_:1},16))}},dM=T(uM,[["__file","/@slidev/slides/62.md"]]),pM=o("h1",null,"SvelteKit",-1),mM=o("ul",null,[o("li",null,[o("p",null,"Come abbiamo visto con semplici esempi, il meccanismo dei componenti di Svlete è molto versatile")]),o("li",null,[o("p",null,"Permette la definizione di componenti indipendenti rendendo più facile lo sviluppo e riducendo gli errori")]),o("li",null,[o("p",null,"Il meccanismo della sostituzione delle variabili e del code execution sono molto utili nello sviluppo di applicazioni web moderne")]),o("li",null,[o("p",null,"Svelte rende tutto ciò semplicissimo e più semplice rispetto ad altri framework")]),o("li",null,[o("p",null,"Per questo e altri motivi è un framework in veloce ascesa nel panorama dello sviluppo web")]),o("li",null,[o("p",null,"Ora vediamo come creare un progetto Svelte da zero, senza scaffolding")]),o("li",null,[o("p",null,"Questo ci permetterà di comprendere altri meccanismi e come è realmente organizzata un’applicazione sveltekit")])],-1),fM={__name:"63",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[pM,mM]),_:1},16))}},hM=T(fM,[["__file","/@slidev/slides/63.md"]]),vM=o("h1",null,"SvelteKit",-1),_M=o("p",null,"Creazione Web App: scaffolding del progetto",-1),gM=o("ul",null,[o("li",null,"Creiamo un nuovo progetto chiamato WebApp")],-1),bM=o("pre",{class:"slidev-code language-bash"},[o("code",null,[o("span",{class:"line"},[o("span",{class:"token operator"},">"),c(),o("span",{class:"token function"},"npm"),c(" create svelte@latest WebApp")]),c(`
`),o("span",{class:"line"}),c(`
`),o("span",{class:"line"},[c("create-svelte version "),o("span",{class:"token number"},"4.2"),c(".0")]),c(`
`),o("span",{class:"line"}),c(`
`),o("span",{class:"line"},[c("┌  Welcome to SvelteKit"),o("span",{class:"token operator"},"!")]),c(`
...
`),o("span",{class:"line"},"│"),c(`
`),o("span",{class:"line"},[c("└  Your project is ready"),o("span",{class:"token operator"},"!")])])],-1),yM={__name:"64",setup(e){const t={};return $(I),(n,i)=>{const s=Ie;return g(),z(M,O(E(t)),{default:w(()=>[vM,_M,gM,j(s,me({},{ranges:[""]}),{default:w(()=>[bM]),_:1},16)]),_:1},16)}}},SM=T(yM,[["__file","/@slidev/slides/64.md"]]),wM="/TPSI/4/svelte/assets/svelte_020-2a368428.png",xM=o("h1",null,"SvelteKit",-1),kM=o("p",null,"Creazione Web App: scaffolding del progetto",-1),$M=o("ul",null,[o("li",null,"Questa volta è stato solo creato il minimo indispendabile")],-1),zM=o("p",null,[o("br"),o("br"),o("img",{src:wM,class:"mx-auto",width:"400"})],-1),IM=o("ul",null,[o("li",null,"Creeremo uno scheletro di una semplice Web App senza spendere troppo tempo sull’aspetto estetico (HTML e CSS sono dati per scontato in questa lezione)"),o("li",null,"L’obiettivo è comprendere il funzionamento e l’organizzazione di un’app sveltekit")],-1),CM={__name:"65",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[xM,kM,$M,zM,IM]),_:1},16))}},TM=T(CM,[["__file","/@slidev/slides/65.md"]]),EM=o("h1",null,"SvelteKit",-1),OM=o("p",null,"Creazione Web App: scaffolding del progetto",-1),MM=o("ul",null,[o("li",null,[c("Iniziamo con la creazione del "),o("code",null,"layout"),c(" della pagina")]),o("li",null,[c("Il "),o("em",null,[o("strong",null,"layout")]),c(" della pagina è il contenitore principale della nostra applicazione")]),o("li",null,"Esso sarà sempre visualizzato in ciascuna pagina del sito"),o("li",null,"Il vantaggio principale è che in questo modo il layout sarà scritto una sola volta ed utilizzato per tutte le pagine"),o("li",null,[c("Questo meccanismo implementa il principio "),o("a",{href:"https://en.wikipedia.org/wiki/Don%27t_repeat_yourself",target:"_blank",rel:"noopener"},"DRY"),c(" (Don’t Repeat Yourself) molto importante nello sviluppo del software")]),o("li",null,[c("Creaimo quindi un file chiamato "),o("code",null,"+layout.svelte"),c(" in "),o("em",null,[o("strong",null,"src/routes")])])],-1),AM=o("pre",{class:"slidev-code language-bash"},[o("code",null,[o("span",{class:"line"},"src"),c(`
`),o("span",{class:"line"},"├── app.html"),c(`
`),o("span",{class:"line"},"└── routes"),c(`
`),o("span",{class:"line"},[c("    ├── +layout.svelte "),o("span",{class:"token operator"},"<"),c("--- layout")]),c(`
`),o("span",{class:"line"},[c("    └── +page.svelte   "),o("span",{class:"token operator"},"<"),c("--- home page")])])],-1),PM=o("ul",null,[o("li",null,"Inseriamo il codice HTML e CSS")],-1),KM={__name:"66",setup(e){const t={};return $(I),(n,i)=>{const s=Ie;return g(),z(M,O(E(t)),{default:w(()=>[EM,OM,MM,j(s,me({},{ranges:[""]}),{default:w(()=>[AM]),_:1},16),PM]),_:1},16)}}},LM=T(KM,[["__file","/@slidev/slides/66.md"]]),RM="/TPSI/4/svelte/assets/svelte_021-dca7a484.png",HM=o("h1",null,"SvelteKit",-1),WM=o("p",null,"Creazione Web App: il layout",-1),NM=o("img",{src:RM,class:"mx-auto",width:"400"},null,-1),DM={__name:"67",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[HM,WM,NM]),_:1},16))}},qM=T(DM,[["__file","/@slidev/slides/67.md"]]),FM="/TPSI/4/svelte/assets/svelte_022-037591fe.png",jM="/TPSI/4/svelte/assets/svelte_023-535f64a4.png",VM=o("h1",null,"SvelteKit",-1),BM=o("p",null,"Creazione Web App: il layout",-1),UM=o("img",{src:FM,class:"mx-auto",width:"400",style:{position:"relative",left:"-200px"}},null,-1),JM=o("img",{src:jM,class:"mx-auto",width:"360",style:{position:"relative",left:"200px",top:"-500px"}},null,-1),QM={__name:"68",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[VM,BM,UM,JM]),_:1},16))}},YM=T(QM,[["__file","/@slidev/slides/68.md"]]),ZM="/TPSI/4/svelte/assets/svelte_024-90632bcf.png",GM=o("h1",null,"SvelteKit",-1),XM=o("p",null,"Creazione Web App: il layout",-1),e3=o("img",{src:ZM,class:"mx-auto",width:"600"},null,-1),t3={__name:"69",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[GM,XM,e3]),_:1},16))}},n3=T(t3,[["__file","/@slidev/slides/69.md"]]),o3=o("h1",null,"SvelteKit",-1),i3=o("p",null,"Creazione Web App: il layout",-1),s3=o("ul",null,[o("li",null,[o("p",null,"Abbiamo definito il layout della nostra applicazione, composto da:"),o("ul",null,[o("li",null,"header"),o("li",null,"navbar"),o("li",null,"main content area (article)"),o("li",null,"footer")])]),o("li",null,[o("p",null,"Le pagine che andremo a sviluppare verranno visualizzate nel main content area")])],-1),a3={__name:"70",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[o3,i3,s3]),_:1},16))}},l3=T(a3,[["__file","/@slidev/slides/70.md"]]),r3={class:"banner"},c3=Pe({__name:"Banner",props:{bg:{default:"white"},fg:{default:"white"}},setup(e,{emit:t}){const n=e;G_(a=>({"76049b2e-bgcol":L(i),"76049b2e-fgcol":L(s)})),$(I);const i=Kt(n,"bg",t),s=Kt(n,"fg",t);return(a,l)=>(g(),ie("div",r3,[Bt(a.$slots,"default")]))}});const xo=T(c3,[["__file","/home/antonio/WORK/ITI_Agnelli/Materie/slidev/components/Banner.vue"]]),u3="/TPSI/4/svelte/assets/svelte_025-e24a97c2.png",d3=o("h1",null,"SvelteKit",-1),p3=o("p",null,"Creazione Web App: il layout",-1),m3=o("ul",null,[o("li",null,"Importante notare che nello style del layout abbiamo modificato lo stile globale del body"),o("li",null,[c("Per far ciò abbiamo usato il costrutto "),o("code",null,":global(<selettore>)")])],-1),f3=o("br",null,null,-1),h3=o("img",{src:u3,class:"mx-auto",width:"400"},null,-1),v3=o("ul",null,[o("li",null,[c("Ciò è necessario in quanto lo stylde del componente (layout è un componente) è "),o("strong",null,"scoped")]),o("li",null,"In altre parole lo stile di un componente è confinato al solo componente stesso e non può modificare lo stilde di altri componenti"),o("li",null,[c("L’uso di "),o("em",null,":globa"),c(" ci permette di fare un’eccezione a questa regola")])],-1),_3=o("br",null,null,-1),g3={__name:"71",setup(e){const t={};return $(I),(n,i)=>{const s=xo;return g(),z(M,O(E(t)),{default:w(()=>[d3,p3,m3,f3,h3,v3,_3,j(s,{bg:"green",fg:"yellow"},{default:w(()=>[c(" Si suggerisce di non abusare di questa possibilità in quanto rende il codice meno leggibile e meno comprensibile ")]),_:1})]),_:1},16)}}},b3=T(g3,[["__file","/@slidev/slides/71.md"]]),y3=o("h1",null,"SvelteKit",-1),S3=o("p",null,"Component Slot",-1),w3=o("ul",null,[o("li",null,"Come si vede al momento la nostra app non visualizza la home page nella main content area"),o("li",null,"Questo perchè al momento il componente layout NON include nessuna ltro componente (home page)"),o("li",null,[c("Per poter risolvere questo problema dobbiamo ricorrere ad un concetto di Svelte chiamato "),o("code",null,"Component Slots")]),o("li",null,"In pratica in modo analogo ai tag HTML che possono avere un contenuto")],-1),x3=o("pre",{class:"slidev-code language-html"},[o("code",null,[o("span",{class:"line"},[o("span",{class:"token tag"},[o("span",{class:"token tag"},[o("span",{class:"token punctuation"},"<"),c("div")]),o("span",{class:"token punctuation"},">")])]),c(`
...
`),o("span",{class:"line"},[o("span",{class:"token tag"},[o("span",{class:"token tag"},[o("span",{class:"token punctuation"},"</"),c("div")]),o("span",{class:"token punctuation"},">")])])])],-1),k3=o("ul",null,[o("li",null,[c("Anche un componente Svelte può avere un contenuto (o figlio) tramite il costrutto "),o("code",null,"<slot />")]),o("li",null,[c('In altre parole all’interno di un componente Svelte possiamo decidere dove visualizzare il contenuto del "figlio" usando '),o("code",null,"<slot />")])],-1),$3={__name:"72",setup(e){const t={};return $(I),(n,i)=>{const s=Ie;return g(),z(M,O(E(t)),{default:w(()=>[y3,S3,w3,j(s,me({},{ranges:[""]}),{default:w(()=>[x3]),_:1},16),k3]),_:1},16)}}},z3=T($3,[["__file","/@slidev/slides/72.md"]]),I3=o("h1",null,"SvelteKit",-1),C3=o("p",null,"Component Slot",-1),T3=o("ul",null,[o("li",null,"Modifichiamo +layout.svelte aggiungendo lo slot nella sezione article")],-1),E3=o("pre",{class:"slidev-code language-html"},[o("code",null,[o("span",{class:"line"},"... "),c(`
...
`),o("span",{class:"line"},[c("   "),o("span",{class:"token tag"},[o("span",{class:"token tag"},[o("span",{class:"token punctuation"},"</"),c("article")]),o("span",{class:"token punctuation"},">")])]),c(`
`),o("span",{class:"line"},"...")])],-1),O3=o("ul",null,[o("li",null,"In questo modo nella sezione article comparirà il contenuto del componente correntemente in utilizzio (home page o +page.svelte in src/routes)")],-1),M3={__name:"73",setup(e){const t={};return $(I),(n,i)=>{const s=Ie;return g(),z(M,O(E(t)),{default:w(()=>[I3,C3,T3,j(s,me({},{ranges:[""]}),{default:w(()=>[E3]),_:1},16),O3]),_:1},16)}}},A3=T(M3,[["__file","/@slidev/slides/73.md"]]),P3="/TPSI/4/svelte/assets/svelte_026-bb839bc1.png",K3=o("h1",null,"SvelteKit",-1),L3=o("p",null,"Component Slot",-1),R3=o("img",{src:P3,class:"mx-auto",width:"650"},null,-1),H3={__name:"74",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[K3,L3,R3]),_:1},16))}},W3=T(H3,[["__file","/@slidev/slides/74.md"]]),N3="/TPSI/4/svelte/assets/svelte_027-b9352cfd.png",D3=o("h1",null,"SvelteKit",-1),q3=o("p",null,"Hello World: Esercitazione_08",-1),F3=o("ul",null,[o("li",null,"Provare a modificare la home page in modo che appaia come in figura")],-1),j3=o("br",null,null,-1),V3=o("img",{src:N3,class:"mx-auto",width:"580"},null,-1),B3=o("ul",null,[o("li",null,"Consegnare su github il progetto modificato")],-1),U3={__name:"75",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[D3,q3,F3,j3,V3,B3]),_:1},16))}},J3=T(U3,[["__file","/@slidev/slides/75.md"]]),Q3=o("h1",null,"SvelteKit",-1),Y3=o("p",null,"Pagina Chi Sono",-1),Z3=o("ul",null,[o("li",null,'Adesso creiamo la pagina "Chi Sono"'),o("li",null,"In questa pagina faremo una breve introduzione di noi stessi"),o("li",null,"E’ importante che nella descrizione di noi stessi includiamo cognome, nome ed età (questo ci sarà utile dopo)"),o("li",null,'Quindi per creare la pagina "Chi Sono" creiamo una directory in modo da ottenere questo risultato')],-1),G3=o("pre",{class:"slidev-code language-bash"},[o("code",null,[o("span",{class:"line"},"src"),c(`
`),o("span",{class:"line"},"├── app.html"),c(`
`),o("span",{class:"line"},"└── routes"),c(`
...
`),o("span",{class:"line"},"    └── +page.svelte")])],-1),X3={__name:"76",setup(e){const t={};return $(I),(n,i)=>{const s=Ie;return g(),z(M,O(E(t)),{default:w(()=>[Q3,Y3,Z3,j(s,me({},{ranges:[""]}),{default:w(()=>[G3]),_:1},16)]),_:1},16)}}},eA=T(X3,[["__file","/@slidev/slides/76.md"]]),tA="/TPSI/4/svelte/assets/svelte_029-5b49b40e.png",nA=o("h1",null,"SvelteKit",-1),oA=o("p",null,"Pagina Chi Sono",-1),iA=o("p",null,"+page.svelte",-1),sA=o("br",null,null,-1),aA=o("img",{src:tA,class:"mx-auto",width:"600"},null,-1),lA={__name:"77",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[nA,oA,iA,sA,aA]),_:1},16))}},rA=T(lA,[["__file","/@slidev/slides/77.md"]]),cA="/TPSI/4/svelte/assets/svelte_030-3eb3d437.png",uA=o("h1",null,"SvelteKit",-1),dA=o("p",null,"Pagina Chi Sono",-1),pA=o("ul",null,[o("li",null,'Ora dobbiamo collegare la nuova pagina "Chi Sono" con la barra di navigazione'),o("li",null,"Basta modificare il link in questo modo")],-1),mA=o("br",null,null,-1),fA=o("img",{src:cA,class:"mx-auto",width:"600"},null,-1),hA=o("br",null,null,-1),vA=o("ul",null,[o("li",null,"In tal modo quando clicchiamo sul link Chi Sono la pagina omonima verrà visualizzata nella main content area")],-1),_A={__name:"78",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[uA,dA,pA,mA,fA,hA,vA]),_:1},16))}},gA=T(_A,[["__file","/@slidev/slides/78.md"]]),bA="/TPSI/4/svelte/assets/svelte_028-0d92289a.png",yA=o("h1",null,"SvelteKit",-1),SA=o("p",null,"Pagina Chi Sono",-1),wA=o("img",{src:bA,class:"mx-auto",width:"650"},null,-1),xA={__name:"79",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[yA,SA,wA]),_:1},16))}},kA=T(xA,[["__file","/@slidev/slides/79.md"]]),$A=o("h1",null,"SvelteKit",-1),zA=o("p",null,"Il componente WhoAmI",-1),IA=o("ul",null,[o("li",null,[c('Ora trasformiamo la pagina "Chi Sono" in modo che visualizzi un solo componente chiamato '),o("em",null,[o("strong",null,"WhoAmI")])]),o("li",null,[c("Quindi creiamo un nuovo componente "),o("em",null,[o("strong",null,"WhoAmI")])])],-1),CA=o("pre",{class:"slidev-code language-bash"},[o("code",null,[o("span",{class:"line"},"src"),c(`
`),o("span",{class:"line"},"├── app.html"),c(`
`),o("span",{class:"line"},"├── lib"),c(`
`),o("span",{class:"line"},"│   └── components"),c(`
...
`),o("span",{class:"line"},[o("span",{class:"token keyword"},"export"),c(),o("span",{class:"token keyword"},"let"),c(" eta"),o("span",{class:"token punctuation"},";"),c(),o("span",{class:"token comment"},"//dichiara la variabile nome come parametro fornito dal chiamante")])])],-1),a5=o("br",null,null,-1),l5=o("ul",null,[o("li",null,[c("Il meccanismo delle "),o("code",null,"Props"),c(" di Svelte è molto potente e di facile utilizzo")])],-1),r5={__name:"84",setup(e){const t={};return $(I),(n,i)=>{const s=Ie;return g(),z(M,O(E(t)),{default:w(()=>[t5,n5,o5,i5,j(s,me({},{ranges:[""]}),{default:w(()=>[s5]),_:1},16),a5,l5]),_:1},16)}}},c5=T(r5,[["__file","/@slidev/slides/84.md"]]),u5="/TPSI/4/svelte/assets/svelte_034-820ec76b.png",d5=o("h1",null,"SvelteKit",-1),p5=o("p",null,"Props",-1),m5=o("ul",null,[o("li",null,[c("Pertanto riscriviamo il componente WhoAmI utilizzando le "),o("em",null,[o("strong",null,"Props")])])],-1),f5=o("br",null,null,-1),h5=o("img",{src:u5,class:"mx-auto",width:"700"},null,-1),v5=o("br",null,null,-1),_5=o("ul",null,[o("li",null,[c("Abbiamo usato il "),o("em",null,"variable substitution di svelte"),c(" per utilizzare i parametri all’interno del corpo HTML del componente")])],-1),g5={__name:"85",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[d5,p5,m5,f5,h5,v5,_5]),_:1},16))}},b5=T(g5,[["__file","/@slidev/slides/85.md"]]),y5="/TPSI/4/svelte/assets/svelte_035-8a0ca6bf.png",S5=o("h1",null,"SvelteKit",-1),w5=o("p",null,"Props",-1),x5=o("img",{src:y5,class:"mx-auto",width:"750"},null,-1),k5=o("br",null,null,-1),$5={__name:"86",setup(e){const t={};return $(I),(n,i)=>{const s=xo;return g(),z(M,O(E(t)),{default:w(()=>[S5,w5,x5,k5,j(s,{bg:"green",fg:"yellow"},{default:w(()=>[c(" Siccome non abbiamo modificato il chiamante, vengono utilizzati i valori di default per le props del componente ")]),_:1})]),_:1},16)}}},z5=T($5,[["__file","/@slidev/slides/86.md"]]),I5="/TPSI/4/svelte/assets/svelte_036-c62c9040.png",C5=o("h1",null,"SvelteKit",-1),T5=o("p",null,"Props",-1),E5=o("ul",null,[o("li",null,"Modifichiamo ora il chiamante e cioè la pagina Chi Sono in modo da passare dei parametri corretti al componente WhoAmI")],-1),O5=o("br",null,null,-1),M5=o("img",{src:I5,class:"mx-auto",width:"750"},null,-1),A5={__name:"87",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[C5,T5,E5,O5,M5]),_:1},16))}},P5=T(A5,[["__file","/@slidev/slides/87.md"]]),K5="/TPSI/4/svelte/assets/svelte_037-55bef59f.png",L5=o("h1",null,"SvelteKit",-1),R5=o("p",null,"Props",-1),H5=o("img",{src:K5,class:"mx-auto",width:"750"},null,-1),W5={__name:"88",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[L5,R5,H5]),_:1},16))}},N5=T(W5,[["__file","/@slidev/slides/88.md"]]),D5="/TPSI/4/svelte/assets/svelte_038-d542d0ee.png",q5=o("h1",null,"SvelteKit",-1),F5=o("p",null,"Props",-1),j5=o("ul",null,[o("li",null,"Cosa succede se chiamo due volte il componente WhoAmI dalla pagina Chi Sono?"),o("li",null,"Quello che ci aspettiamo: vengono visualizzati due componenti ognuno con i propri parametri")],-1),V5=o("br",null,null,-1),B5=o("img",{src:D5,class:"mx-auto",width:"700"},null,-1),U5={__name:"89",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[q5,F5,j5,V5,B5]),_:1},16))}},J5=T(U5,[["__file","/@slidev/slides/89.md"]]),Q5="/TPSI/4/svelte/assets/svelte_039-4fc8afef.png",Y5=o("h1",null,"SvelteKit",-1),Z5=o("p",null,"Props",-1),G5=o("img",{src:Q5,class:"mx-auto",width:"600"},null,-1),X5={__name:"90",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[Y5,Z5,G5]),_:1},16))}},e6=T(X5,[["__file","/@slidev/slides/90.md"]]),t6=o("h1",null,"SvelteKit",-1),n6=o("p",null,"Dynamic Attributes",-1),o6=o("ul",null,[o("li",null,"Come abbiamo visti le props e variabili contenute in un componente possono essere utilizzate per generare del contenuto dinamico"),o("li",null,"Tuttavia possono anche essere utilizzate come attributi dei tag HTML"),o("li",null,[c("In questo caso Svelte parla di "),o("code",null,"Dynamic Attributes")]),o("li",null,"Per esempio per definire il src di un immagine in modo dinamico si può fare così")],-1),i6=o("pre",{class:"slidev-code language-html"},[o("code",null,[o("span",{class:"line"},[o("span",{class:"token tag"},[o("span",{class:"token tag"},[o("span",{class:"token punctuation"},"<"),c("img")]),c(),o("span",{class:"token attr-name"},"src"),o("span",{class:"token attr-value"},[o("span",{class:"token punctuation attr-equals"},"="),c("{url}")]),c(),o("span",{class:"token punctuation"},">")])])])],-1),s6=o("ul",null,[o("li",null,"In questo modo la sorgente dell’immagine non sarà statica ma dipenderà dal valore della variabile url"),o("li",null,"Ovviamente cambiando il valore della variabile l’immagine verrà automaticamente aggiornata in modo dinamico")],-1),a6={__name:"91",setup(e){const t={};return $(I),(n,i)=>{const s=Ie;return g(),z(M,O(E(t)),{default:w(()=>[t6,n6,o6,j(s,me({},{ranges:[""]}),{default:w(()=>[i6]),_:1},16),s6]),_:1},16)}}},l6=T(a6,[["__file","/@slidev/slides/91.md"]]),r6="/TPSI/4/svelte/assets/svelte_040-f4392269.png",c6=o("h1",null,"SvelteKit",-1),u6=o("p",null,"Dynamic Attributes",-1),d6=o("ul",null,[o("li",null,[c("Per comprendere meglio i "),o("em",null,[o("strong",null,"Dynamic Attributes")]),c(" modifichiamo il componente WhoAmI aggiungendo la nostra foto")])],-1),p6=o("img",{src:r6,class:"mx-auto",width:"700"},null,-1),m6={__name:"92",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[c6,u6,d6,p6]),_:1},16))}},f6=T(m6,[["__file","/@slidev/slides/92.md"]]),h6="/TPSI/4/svelte/assets/svelte_041-ee2c2e0b.png",v6=o("h1",null,"SvelteKit",-1),_6=o("p",null,"Dynamic Attributes",-1),g6=o("ul",null,[o("li",null,"Possiamo usare come dymanic attribute una variabile esterna")],-1),b6=o("img",{src:h6,class:"mx-auto",width:"700"},null,-1),y6={__name:"93",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[v6,_6,g6,b6]),_:1},16))}},S6=T(y6,[["__file","/@slidev/slides/93.md"]]),w6="/TPSI/4/svelte/assets/svelte_042-833a06e0.png",x6=o("h1",null,"SvelteKit",-1),k6=o("p",null,"Dynamic Attributes",-1),$6=o("img",{src:w6,class:"mx-auto",width:"550"},null,-1),z6={__name:"94",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[x6,k6,$6]),_:1},16))}},I6=T(z6,[["__file","/@slidev/slides/94.md"]]),C6=o("h1",null,"SvelteKit",-1),T6=o("p",null,"Dynamic Attributes: shorthand",-1),E6=o("ul",null,[o("li",null,"Prima abbiamo scritto")],-1),O6=o("pre",{class:"slidev-code language-html"},[o("code",null,[o("span",{class:"line"},[o("span",{class:"token tag"},[o("span",{class:"token tag"},[o("span",{class:"token punctuation"},"<"),c("img")]),c(),o("span",{class:"token attr-name"},"src"),o("span",{class:"token attr-value"},[o("span",{class:"token punctuation attr-equals"},"="),c("{url}")]),c(),o("span",{class:"token punctuation"},">")])])])],-1),M6=o("ul",null,[o("li",null,"Immaginando che la variabile si chiami src, scriveremo")],-1),A6=o("pre",{class:"slidev-code language-html"},[o("code",null,[o("span",{class:"line"},[o("span",{class:"token tag"},[o("span",{class:"token tag"},[o("span",{class:"token punctuation"},"<"),c("img")]),c(),o("span",{class:"token attr-name"},"src"),o("span",{class:"token attr-value"},[o("span",{class:"token punctuation attr-equals"},"="),c("{src}")]),c(),o("span",{class:"token punctuation"},">")])])])],-1),P6=o("ul",null,[o("li",null,[c("Questo risulta abbastanza ridondante, pertanto Svelte ci semplifica la vita mettendo a disposizione degli "),o("em",null,[o("strong",null,"shorthand")]),c(" o delle scorciatoie")]),o("li",null,"Quindi in questo caso potremmo scrivere")],-1),K6=o("pre",{class:"slidev-code language-html"},[o("code",null,[o("span",{class:"line"},[o("span",{class:"token tag"},[o("span",{class:"token tag"},[o("span",{class:"token punctuation"},"<"),c("img")]),c(),o("span",{class:"token attr-name"},"{src}"),c(),o("span",{class:"token punctuation"},">")])])])],-1),L6=o("ul",null,[o("li",null,"Pertanto le due notazioni sono perfettamente equivalenti e sortiscono lo stesso effetto")],-1),R6=o("pre",{class:"slidev-code language-html"},[o("code",null,[o("span",{class:"line"},[o("span",{class:"token tag"},[o("span",{class:"token tag"},[o("span",{class:"token punctuation"},"<"),c("img")]),c(),o("span",{class:"token attr-name"},"src"),o("span",{class:"token attr-value"},[o("span",{class:"token punctuation attr-equals"},"="),c("{src}")]),c(),o("span",{class:"token punctuation"},">")]),c(" vs "),o("span",{class:"token tag"},[o("span",{class:"token tag"},[o("span",{class:"token punctuation"},"<"),c("img")]),c(),o("span",{class:"token attr-name"},"{src}"),c(),o("span",{class:"token punctuation"},">")])])])],-1),H6={__name:"95",setup(e){const t={};return $(I),(n,i)=>{const s=Ie;return g(),z(M,O(E(t)),{default:w(()=>[C6,T6,E6,j(s,me({},{ranges:[""]}),{default:w(()=>[O6]),_:1},16),M6,j(s,me({},{ranges:[""]}),{default:w(()=>[A6]),_:1},16),P6,j(s,me({},{ranges:[""]}),{default:w(()=>[K6]),_:1},16),L6,j(s,me({},{ranges:[""]}),{default:w(()=>[R6]),_:1},16)]),_:1},16)}}},W6=T(H6,[["__file","/@slidev/slides/95.md"]]),N6=o("h1",null,"SvelteKit",-1),D6=o("p",null,"Dynamic Attributes: Esercitazione_09",-1),q6=o("ul",null,[o("li",null,[o("p",null,"Modificare il componente WhoAmI in modo da passare la larghezza dell’immagine come parametro")]),o("li",null,[o("p",null,"Utilizzare lo shorthand per il dynamic attribute")]),o("li",null,[o("p",null,"Consegnare su github il progetto modificato")])],-1),F6={__name:"96",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[N6,D6,q6]),_:1},16))}},j6=T(F6,[["__file","/@slidev/slides/96.md"]]),V6=o("h1",null,"SvelteKit",-1),B6=o("p",null,"Bindings",-1),U6=o("ul",null,[o("li",null,"Come visto i dati e le props si propagano dall’alto al basso, dal componente chiamante verso il componente figlio"),o("li",null,"Tuttavia spesso in un applicazione web è utile che questa propagazione possa avvenire nel verso opposto")],-1),J6=o("br",null,null,-1),Q6=o("br",null,null,-1),Y6=o("ul",null,[o("li",null,"Uno scenario classico è fare il binding della props di un input text ad una variabile del componente chiamante"),o("li",null,"In questo modo sarà facilissimo ed immediato accedere al valore dell’input text (pensate quanto è macchinoso in vanilla JS)")],-1),Z6={__name:"97",setup(e){const t={};return $(I),(n,i)=>{const s=xo;return g(),z(M,O(E(t)),{default:w(()=>[V6,B6,U6,J6,j(s,{fg:"yellow",bg:"green"},{default:w(()=>[c(" Il binding permette la propagazione del valore di una variabile di un componente al componente chiamante o padre ")]),_:1}),Q6,Y6]),_:1},16)}}},G6=T(Z6,[["__file","/@slidev/slides/97.md"]]),X6="/TPSI/4/svelte/assets/svelte_043-78632da3.png",eP=o("h1",null,"SvelteKit",-1),tP=o("p",null,"Binding: Esercitazione_10",-1),nP=o("ul",null,[o("li",null,"Per comprendere il meccanismo del binding abbiamo bisogno di una nuova pagina nella nostra app"),o("li",null,[c("Creare una nuova pagina chiamata "),o("strong",null,"Input")]),o("li",null,"Creare il relativo menu nella barra nav e linkare la pagina")],-1),oP=o("br",null,null,-1),iP=o("img",{src:X6,class:"mx-auto",width:"650"},null,-1),sP=o("ul",null,[o("li",null,"Consegnare su github il progetto modificato")],-1),aP={__name:"98",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[eP,tP,nP,oP,iP,sP]),_:1},16))}},lP=T(aP,[["__file","/@slidev/slides/98.md"]]),rP="/TPSI/4/svelte/assets/svelte_044-d3d5602c.png",cP=o("h1",null,"SvelteKit",-1),uP=o("p",null,"Bindings",-1),dP=o("ul",null,[o("li",null,"Ora modifichiamo la pafina input aggiungendo un input text box e creando un binding con una variabile")],-1),pP=o("br",null,null,-1),mP=o("img",{src:rP,class:"mx-auto",width:"400"},null,-1),fP={__name:"99",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[cP,uP,dP,pP,mP]),_:1},16))}},hP=T(fP,[["__file","/@slidev/slides/99.md"]]),vP="/TPSI/4/svelte/assets/svelte_045-1784d8ce.png",_P=o("h1",null,"SvelteKit",-1),gP=o("p",null,"Bindings",-1),bP=o("img",{src:vP,class:"mx-auto",width:"600"},null,-1),yP=o("ul",null,[o("li",null,[c("Come si vede le variabili sono sostituite dal valore "),o("em",null,"undefined")]),o("li",null,"Questo succede perchè abbiamo creato il binding tra il contenuto dei input text (undefined) e le variabili nome, cognome e eta"),o("li",null,"Compilando i campi la pagina si aggiornerà in modo automatico e dinamico"),o("li",null,"Anche in questo caso realizzare la stessa cosa in vanilla JS sarebbe molto più laborioso")],-1),SP={__name:"100",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[_P,gP,bP,yP]),_:1},16))}},wP=T(SP,[["__file","/@slidev/slides/100.md"]]),xP="/TPSI/4/svelte/assets/svelte_046-0d05f32b.gif",kP=o("h1",null,"SvelteKit",-1),$P=o("p",null,"Bindings",-1),zP=o("img",{src:xP,class:"mx-auto",width:"700"},null,-1),IP={__name:"101",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[kP,$P,zP]),_:1},16))}},CP=T(IP,[["__file","/@slidev/slides/101.md"]]),TP="/TPSI/4/svelte/assets/svelte_047-7d7077b5.png",EP=o("h1",null,"SvelteKit",-1),OP=o("p",null,"Bindings",-1),MP=o("div",{style:{width:"50%"}},[o("ul",null,[o("li",null,"Vediamo un altro esempio dell’uso del binding"),o("li",null,"Modificare la pagina Input nel seguente modo"),o("li",null,[c("In questo caso creiamo un binding tra la checkbox e la variabile "),o("em",null,"confermato")]),o("li",null,[c("Poi settiamo tramite dynamic attributes l’attribute "),o("em",null,"disabled"),c(" del pulsante")]),o("li",null,"Pertanto il pulsante diventa attivo solo se l’utente ha confermato selezionando la checkbox")])],-1),AP=o("img",{src:TP,class:"mx-auto",width:"450",style:{position:"relative",top:"-300px",right:"-250px"}},null,-1),PP={__name:"102",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[EP,OP,MP,AP]),_:1},16))}},KP=T(PP,[["__file","/@slidev/slides/102.md"]]),LP="/TPSI/4/svelte/assets/svelte_048-c286dfed.gif",RP=o("h1",null,"SvelteKit",-1),HP=o("p",null,"Bindings",-1),WP=o("img",{src:LP,class:"mx-auto",width:"700"},null,-1),NP={__name:"103",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[RP,HP,WP]),_:1},16))}},DP=T(NP,[["__file","/@slidev/slides/103.md"]]),qP="/TPSI/4/svelte/assets/svelte_049-902c4331.png",FP=o("h1",null,"SvelteKit",-1),jP=o("p",null,"Binding: Esercitazione_11",-1),VP=o("ul",null,[o("li",null,[c("Modificare la pagina "),o("em",null,"Input"),c(" in modo che venga aggiunto un nuovo input text per leggere in input la residenza")]),o("li",null,"Utilizzare il meccanismo del binding")],-1),BP=o("br",null,null,-1),UP=o("img",{src:qP,class:"mx-auto",width:"750"},null,-1),JP=o("ul",null,[o("li",null,"Consegnare su github il progetto modificato")],-1),QP={__name:"104",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[FP,jP,VP,BP,UP,JP]),_:1},16))}},YP=T(QP,[["__file","/@slidev/slides/104.md"]]),ZP="/TPSI/4/svelte/assets/svelte_050-4fe36e6f.png",GP=o("h1",null,"SvelteKit",-1),XP=o("p",null,"La pagina e il component Counter",-1),eK=o("ul",null,[o("li",null,"Realizziamo ora la pagina Counter e linkiamola alla nav bar (si lascia come esercizio agli studenti)")],-1),tK=o("br",null,null,-1),nK=o("img",{src:ZP,class:"mx-auto",width:"800"},null,-1),oK={__name:"105",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[GP,XP,eK,tK,nK]),_:1},16))}},iK=T(oK,[["__file","/@slidev/slides/105.md"]]),sK=o("h1",null,"Svelte",-1),aK=o("p",null,"Stateful component",-1),lK=o("ul",null,[o("li",null,"Uno dei problemi tradizionali dello sviluppo di app web è la gestione dello stato"),o("li",null,[c("Questo problema è intrinseco in quanto il protcollo HTTP è "),o("strong",null,"stateless"),c(" o senza stato")]),o("li",null,"Svelte risolve brillantemente questo problema permettendo di immagazzinare lo stato del componente direttamente all’interno del componente stesso"),o("li",null,"Pertanto un componente Svelte è assimilabile a tutti gli effetti ad un oggetto in base alla definizione OOP"),o("li",null,[c("Un componente svelte implementa il meccanismo del "),o("code",null,"encapsulation")])],-1),rK={__name:"106",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[sK,aK,lK]),_:1},16))}},cK=T(rK,[["__file","/@slidev/slides/106.md"]]),uK=o("h1",null,"Svelte",-1),dK=o("p",null,"Stateful component",-1),pK=o("ul",null,[o("li",null,"Ogni componente, oltre a definire il markup, la logica CSS e JavaScript, può ospitare il proprio stato."),o("li",null,"Lo stato è un qualsiasi dato necessario per il corretto funzionamento del componente stesso e dell’applicazione"),o("li",null,'Ad esempio, se un campo di input di un modulo contiene la stringa "test", ci sarà una variabile da qualche parte che contiene questo valore.'),o("li",null,"Questo è lo stato del campo di input."),o("li",null,"Il campo è selezionato? Una variabile da qualche parte registrerà questo fatto. E così via."),o("li",null,[c("Lo stato è ospitato nella sezione "),o("code",null,"<script>"),c(" del componente")])],-1),mK=o("pre",{class:"slidev-code language-html"},[o("code",null,[o("span",{class:"line"},[o("span",{class:"token tag"},[o("span",{class:"token tag"},[o("span",{class:"token punctuation"},"<"),c("script")]),o("span",{class:"token punctuation"},">")])]),c(`
`),o("span",{class:"line"},"	let counter = 0; // stato di un contatore"),c(`
`),o("span",{class:"line"},[o("span",{class:"token tag"},[o("span",{class:"token tag"},[o("span",{class:"token punctuation"},"</"),c("script")]),o("span",{class:"token punctuation"},">")])])])],-1),fK={__name:"107",setup(e){const t={};return $(I),(n,i)=>{const s=Ie;return g(),z(M,O(E(t)),{default:w(()=>[uK,dK,pK,j(s,me({},{ranges:[""]}),{default:w(()=>[mK]),_:1},16)]),_:1},16)}}},hK=T(fK,[["__file","/@slidev/slides/107.md"]]),vK=o("h1",null,"Svelte",-1),_K=o("p",null,"Stateful component",-1),gK=o("ul",null,[o("li",null,"Ma come si aggiorna lo stato di un componente?"),o("li",null,"Altri framework come Vue o React, rendono questa operazione poco intuitiva"),o("li",null,"Al contrario una cosa grandiosa di Svelte è che non è necessario fare nulla di speciale per aggiornare lo stato di un componente.")],-1),bK=o("pre",{class:"slidev-code language-html"},[o("code",null,[o("span",{class:"line"},[o("span",{class:"token tag"},[o("span",{class:"token tag"},[o("span",{class:"token punctuation"},"<"),c("script")]),o("span",{class:"token punctuation"},">")])]),c(`
`),o("span",{class:"line"},"	let counter = 0;"),c(`
`),o("span",{class:"line"}),c(`
`),o("span",{class:"line"},"	function incrementa() {"),c(`
`),o("span",{class:"line"},"		counter++;"),c(`
`),o("span",{class:"line"},"	}"),c(`
`),o("span",{class:"line"},[o("span",{class:"token tag"},[o("span",{class:"token tag"},[o("span",{class:"token punctuation"},"</"),c("script")]),o("span",{class:"token punctuation"},">")])])])],-1),yK=o("br",null,null,-1),SK=o("ul",null,[o("li",null,"In altre parole in Svelte, per aggiornare lo stato di un componente, basta solo un’operazione di assegnazione in qualsiasi parte del componente")],-1),wK={__name:"108",setup(e){const t={};return $(I),(n,i)=>{const s=Ie;return g(),z(M,O(E(t)),{default:w(()=>[vK,_K,gK,j(s,me({},{ranges:[""]}),{default:w(()=>[bK]),_:1},16),yK,SK]),_:1},16)}}},xK=T(wK,[["__file","/@slidev/slides/108.md"]]),kK="/TPSI/4/svelte/assets/svelte_051-70b507e8.png",$K=o("h1",null,"SvelteKit",-1),zK=o("p",null,"La pagina e il component Counter",-1),IK=o("ul",null,[o("li",null,[c("Ora realizziamo un componente chiamato "),o("em",null,"Counter"),c(" ("),o("em",null,"counter.svelte"),c(")")]),o("li",null,"Questo componente permette di incrementare/decrementare un contatore"),o("li",null,"Il valore iniziale è una props esterna con default (zero) 0")],-1),CK=o("br",null,null,-1),TK=o("img",{src:kK,class:"mx-auto",width:"500"},null,-1),EK={__name:"109",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[$K,zK,IK,CK,TK]),_:1},16))}},OK=T(EK,[["__file","/@slidev/slides/109.md"]]),MK="/TPSI/4/svelte/assets/svelte_054-b6901523.png",AK=o("h1",null,"SvelteKit",-1),PK=o("p",null,"La pagina e il component Counter",-1),KK=o("img",{src:MK,class:"mx-auto",width:"600"},null,-1),LK={__name:"110",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[AK,PK,KK]),_:1},16))}},RK=T(LK,[["__file","/@slidev/slides/110.md"]]),HK="/TPSI/4/svelte/assets/svelte_052-12850487.png",WK=o("h1",null,"SvelteKit",-1),NK=o("p",null,"La pagina e il component Counter",-1),DK=o("p",null,[o("strong",null,"counter.svelte (script)")],-1),qK=o("img",{src:HK,class:"mx-auto",width:"700"},null,-1),FK=o("ul",null,[o("li",null,"Utilizziamo icone e font di google (sono molto utili)"),o("li",null,[c("Da notare l’uso della sezione "),o("code",null,"<svelte:head>")])],-1),jK={__name:"111",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[WK,NK,DK,qK,FK]),_:1},16))}},VK=T(jK,[["__file","/@slidev/slides/111.md"]]),BK="/TPSI/4/svelte/assets/svelte_053-b2e286d2.png",UK=o("h1",null,"SvelteKit",-1),JK=o("p",null,"La pagina e il component Counter",-1),QK=o("p",null,[o("strong",null,"counter.svelte (html)")],-1),YK=o("img",{src:BK,class:"mx-auto",width:"600"},null,-1),ZK={__name:"112",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[UK,JK,QK,YK]),_:1},16))}},GK=T(ZK,[["__file","/@slidev/slides/112.md"]]),XK="/TPSI/4/svelte/assets/svelte_055-44899d62.png",eL="/TPSI/4/svelte/assets/svelte_056-ddd19d3e.png",tL=o("h1",null,"SvelteKit",-1),nL=o("p",null,"La pagina e il component Counter",-1),oL=o("p",null,[o("strong",null,"counter.svelte (css)")],-1),iL=o("img",{src:XK,class:"mx-auto",width:"300",style:{position:"relative",top:"-10px",right:"100px"}},null,-1),sL=o("img",{src:eL,class:"mx-auto",width:"300",style:{position:"relative",top:"-350px",right:"-250px"}},null,-1),aL={__name:"113",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[tL,nL,oL,iL,sL]),_:1},16))}},lL=T(aL,[["__file","/@slidev/slides/113.md"]]),rL="/TPSI/4/svelte/assets/svelte_057-c0160448.png",cL=o("h1",null,"SvelteKit",-1),uL=o("p",null,"La pagina e il component Counter",-1),dL=o("img",{src:rL,class:"mx-auto",width:"800"},null,-1),pL={__name:"114",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[cL,uL,dL]),_:1},16))}},mL=T(pL,[["__file","/@slidev/slides/114.md"]]),fL=o("h1",null,"SvelteKit",-1),hL=o("p",null,"DOM Events",-1),vL=o("ul",null,[o("li",null,[c("A questo punto il nostro componente "),o("strong",null,"Counter"),c(" viene visualizzato correttamente")]),o("li",null,[c("E se il chiamante passa un valore iniziale per "),o("em",null,"counter"),c(" questo viene visualizzato correttamente")]),o("li",null,[c("Tuttavia se interagiamo con il componente, premiamo il pulsante "),o("code",null,"+"),c(" o il pulsante "),o("code",null,"-"),c(" non succede nulla")]),o("li",null,[c("Ciò è normale perchè quando premiamo su uno dei pulsanti "),o("strong",null,"VIENE"),c(" generato un evento, ma "),o("strong",null,"NON"),c(" viene gestito dal nostro componente")]),o("li",null,"Quindi in pratica l’evento viene perso e pertanto nessuna operazione particolare viene eseguita"),o("li",null,[c("Quindi "),o("strong",null,"E’ NECESSARIO"),c(" gestire gli eventi del DOM e del nostro componente")]),o("li",null,"Svelte rende questa gestione estremamente facile e intuitiva e molto più facile e veloce rispetto a vanillaJS o altri tipi di framework")],-1),_L={__name:"115",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[fL,hL,vL]),_:1},16))}},gL=T(_L,[["__file","/@slidev/slides/115.md"]]),Gm="/TPSI/4/svelte/assets/svelte_058-ec1cc885.png",bL=o("h1",null,"SvelteKit",-1),yL=o("p",null,"DOM Events",-1),SL=o("ul",null,[o("li",null,"Ogni componente HTML emette degli eventi (mouse click, keyboard press, resize, load, …)"),o("li",null,[c("Per poter gestire questi eventi è necessario specificare due elementi "),o("ol",null,[o("li",null,[o("code",null,"event handler"),c(": una funzione che gestisce l’evento e che viene invocata solo al verificarsi dell’evento stesso")]),o("li",null,[o("code",null,"event hook"),c(': "un posto" a cui agganciare/collegare l’event handler')])])])],-1),wL=o("br",null,null,-1),xL=o("img",{src:Gm,class:"mx-auto",width:"350"},null,-1),kL={__name:"116",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[bL,yL,SL,wL,xL]),_:1},16))}},$L=T(kL,[["__file","/@slidev/slides/116.md"]]),zL=o("h1",null,"SvelteKit",-1),IL=o("p",null,"DOM Events",-1),CL=o("img",{src:Gm,class:"mx-auto",width:"350"},null,-1),TL=o("br",null,null,-1),EL=o("ul",null,[o("li",null,[c("Quando l’utente fa click sul pulsante, viene invocata ed eseguita la funzione "),o("em",null,"button_handler")]),o("li",null,"In questo semplicissimo modo Svelte permette una facile gestioni degli eventi DOM"),o("li",null,[c("Svelte permette anche di utilizzare un "),o("code",null,"inline handler")])],-1),OL=o("br",null,null,-1),ML=o("pre",{class:"slidev-code language-js"},[o("code",null,[o("span",{class:"line"},[o("span",{class:"token operator"},"<"),c("button on"),o("span",{class:"token operator"},":"),c("click"),o("span",{class:"token operator"},"="),o("span",{class:"token punctuation"},"{"),o("span",{class:"token punctuation"},"("),o("span",{class:"token punctuation"},")"),c(),o("span",{class:"token operator"},"=>"),c(" counter"),o("span",{class:"token operator"},"++"),o("span",{class:"token punctuation"},"}"),o("span",{class:"token operator"},">"),c("Premi Qui"),o("span",{class:"token operator"},"<"),o("span",{class:"token operator"},"/"),c("button"),o("span",{class:"token operator"},">")])])],-1),AL={__name:"117",setup(e){const t={};return $(I),(n,i)=>{const s=Ie;return g(),z(M,O(E(t)),{default:w(()=>[zL,IL,CL,TL,EL,OL,j(s,me({},{ranges:[""]}),{default:w(()=>[ML]),_:1},16)]),_:1},16)}}},PL=T(AL,[["__file","/@slidev/slides/117.md"]]),KL="/TPSI/4/svelte/assets/svelte_059-ae776f14.png",LL=o("h1",null,"SvelteKit",-1),RL=o("p",null,"DOM Events",-1),HL=o("div",{style:{width:"50%"}},[o("ul",null,[o("li",null,"Aggiungiamo ora un event handler per il pulsante + ed uno per il pulsante -"),o("li",null,"Modifichiamo counter.svelte nel seguente modo")])],-1),WL=o("img",{src:KL,class:"mx-auto",width:"450",style:{position:"relative",left:"250px",top:"-170px"}},null,-1),NL={__name:"118",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[LL,RL,HL,WL]),_:1},16))}},DL=T(NL,[["__file","/@slidev/slides/118.md"]]),qL=o("h1",null,"SvelteKit",-1),FL=o("p",null,"DOM Events",-1),jL=o("ul",null,[o("li",null,"Bene in questo modo quando l’utente clicca sul pulsante + il contatore si incrementa e viceversa quando preme - si decrementa di un’unità"),o("li",null,"Da notare che il valore del contatore viene aggiornato automaticamente senza la necessità di nessuna operazione da parte dello sviluppatore (in vanilla JS sarebbe stato molto più laborioso ottenere lo stesso effetto)"),o("li",null,"Quindi gli handler agiscono solo sullo stato del componente (il valore della variabile counter) e non si occupano della parte di visualizzazione che è a carico di Svelte")],-1),VL={__name:"119",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[qL,FL,jL]),_:1},16))}},BL=T(VL,[["__file","/@slidev/slides/119.md"]]),UL="/TPSI/4/svelte/assets/svelte_060-c76ee5df.gif",JL=o("h1",null,"SvelteKit",-1),QL=o("p",null,"DOM Events",-1),YL=o("img",{src:UL,class:"mx-auto",width:"700"},null,-1),ZL={__name:"120",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[JL,QL,YL]),_:1},16))}},GL=T(ZL,[["__file","/@slidev/slides/120.md"]]),XL=o("h1",null,"SvelteKit",-1),e8=o("p",null,"Component Bindings",-1),t8=o("ul",null,[o("li",null,"In molti casi è necessario propagare il valore dello stato del componente al componente choiamante"),o("li",null,"Come possiamo fare in modo che il valore della variabile counter venga condiviso con il componente chiamante (pagina)?"),o("li",null,[c("Per realizzare quanto descritto possiamo utilizzare il concetto di "),o("code",null,"Component Binding")]),o("li",null,"In modo analogo al binding dei valori dei tag HTML, possiamo creare, nel chiamante, un binding alle props del componente"),o("li",null,[c("Nel nostro caso la props counter è esposta al chiamante ("),o("em",null,"extern"),c(") e quindi possiamo fare un binding a tale variabile")]),o("li",null,"Pertanto ogni volta che la variabile counter cambierà anche la variabile con cui abbiamo fatto il binding cambierà")],-1),n8={__name:"121",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[XL,e8,t8]),_:1},16))}},o8=T(n8,[["__file","/@slidev/slides/121.md"]]),i8="/TPSI/4/svelte/assets/svelte_061-3e9ad9fd.png",s8=o("h1",null,"SvelteKit",-1),a8=o("p",null,"Component Bindings",-1),l8=o("ul",null,[o("li",null,"Modifichiamo la pagina counter nel seguente modo")],-1),r8=o("br",null,null,-1),c8=o("img",{src:i8,class:"mx-auto",width:"700"},null,-1),u8={__name:"122",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[s8,a8,l8,r8,c8]),_:1},16))}},d8=T(u8,[["__file","/@slidev/slides/122.md"]]),p8=o("h1",null,"SvelteKit",-1),m8=o("p",null,"Component Bindings",-1),f8=o("ul",null,[o("li",null,"Come si vede dall’esempio il binding di props dei nostri componenti si implemente nel seguente modo")],-1),h8=o("pre",{class:"slidev-code language-html"},[o("code",null,[o("span",{class:"line"},[o("span",{class:"token tag"},[o("span",{class:"token tag"},[o("span",{class:"token punctuation"},"<"),c("Componente")]),c(),o("span",{class:"token attr-name"},[o("span",{class:"token namespace"},"bind:"),c("props")]),o("span",{class:"token attr-value"},[o("span",{class:"token punctuation attr-equals"},"="),c("{variabile_locale}")]),o("span",{class:"token punctuation"},">")])])])],-1),v8=o("p",null,"dove:",-1),_8=o("ul",null,[o("li",null,[o("code",null,"props"),c(": è la proprietà del componente a cui vogliamo fare il binding")]),o("li",null,[o("code",null,"variabile_locale"),c(': è la variabile, locale al chiamante, che vogliamo "collegare" (bind) alla props del componente')])],-1),g8=o("br",null,null,-1),b8=o("br",null,null,-1),y8=o("ul",null,[o("li",null,[c("Perciò se cambio il valore di "),o("em",null,"variabile_locale"),c(" cambierà anche il valore di "),o("em",null,"props")]),o("li",null,[c("E viceversa: se cambia il valore di "),o("em",null,"props"),c(" cambia il valore di "),o("em",null,"variabile_locale")])],-1),S8={__name:"123",setup(e){const t={};return $(I),(n,i)=>{const s=Ie,a=xo;return g(),z(M,O(E(t)),{default:w(()=>[p8,m8,f8,j(s,me({},{ranges:[""]}),{default:w(()=>[h8]),_:1},16),v8,_8,g8,j(a,{fg:"yellow",bg:"green"},{default:w(()=>[c(" Importante notare che il bind è bidirezionale ")]),_:1}),b8,y8]),_:1},16)}}},w8=T(S8,[["__file","/@slidev/slides/123.md"]]),x8="/TPSI/4/svelte/assets/svelte_062-f5057466.gif",k8=o("h1",null,"SvelteKit",-1),$8=o("p",null,"Component Bindings",-1),z8=o("img",{src:x8,class:"mx-auto",width:"700"},null,-1),I8={__name:"124",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[k8,$8,z8]),_:1},16))}},C8=T(I8,[["__file","/@slidev/slides/124.md"]]),T8=o("h1",null,"SvelteKit",-1),E8=o("p",null,"DOM Events: Esercitazione_12",-1),O8=o("ul",null,[o("li",null,[o("p",null,"Creare un nuovo componente chiamato DoubeClounter (double_counter.svelte)")]),o("li",null,[o("p",null,"Questo componente funziona in modo simile a Counter, ma quando l’utente preme + il suo valore aumenta di due unità, mentre quando preme - il suo valore viene decrementato di 3 unità")]),o("li",null,[o("p",null,"Aggiungere il componente alla pagina counter")]),o("li",null,[o("p",null,"Tramite il component binding vidualizzare nella pagina counter anche il valore del componente DoubleCounter")]),o("li",null,[o("p",null,"Consegnare su github il progetto modificato")])],-1),M8={__name:"125",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[T8,E8,O8]),_:1},16))}},A8=T(M8,[["__file","/@slidev/slides/125.md"]]),P8=o("h1",null,"SvelteKit",-1),K8=o("p",null,"Logic Statements",-1),L8=o("ul",null,[o("li",null,"Come sappiamo HTML non è un linguaggio di programmazione quindi non ha costrutti logici o iterativi"),o("li",null,"Tuttavia spesso è necessario visualizzare un blocco di HTML in modo condizionale, in funzione di uno stato o variabile"),o("li",null,[c("Anche in questo scenario, Svelte ci viene in aiuto in maniera semplice ed elegante attraverso il concetto di "),o("code",null,"logic blocks")]),o("li",null,"Il funzionamengto è molto semplice, svelte mette a disposizione il seguente costrutto")],-1),R8=o("pre",{class:"slidev-code language-html"},[o("code",null,[o("span",{class:"line"},[c("{#if "),o("span",{class:"token tag"},[o("span",{class:"token tag"},[o("span",{class:"token punctuation"},"<"),c("condizione")]),o("span",{class:"token punctuation"},">")]),c("}")]),c(`
`),o("span",{class:"line"},"    ...."),c(`
...
`),o("span",{class:"line"},"│   └── +page.svelte"),c(`
`),o("span",{class:"line"},"├── +layout.svelte"),c(`
`),o("span",{class:"line"},"└── +page.svelte")])],-1),S9=o("ul",null,[o("li",null,"Non dimenticarti di linkare la pagina About alla navbar")],-1),w9={__name:"155",setup(e){const t={};return $(I),(n,i)=>{const s=Ie;return g(),z(M,O(E(t)),{default:w(()=>[_9,g9,b9,j(s,me({},{ranges:[""]}),{default:w(()=>[y9]),_:1},16),S9]),_:1},16)}}},x9=T(w9,[["__file","/@slidev/slides/155.md"]]),k9="/TPSI/4/svelte/assets/svelte_080-158a95ea.png",$9=o("h1",null,"SvelteKit",-1),z9=o("p",null,"Stores",-1),I9=o("ul",null,[o("li",null,"Ecco il codice della pagina About")],-1),C9=o("br",null,null,-1),T9=o("img",{src:k9,class:"mx-auto",width:"600"},null,-1),E9=o("br",null,null,-1),O9=o("ul",null,[o("li",null,[c("Da notare che per accedere allo store sia in lettura che scrittura, è necessariop anteporre il simbolo "),o("code",null,"$"),c(" in modo da differenziarlo da una normale variabile")]),o("li",null,"Quindi ora se l’utente interagisce con il componente Counter e poi passa alla pagina about vedrà visualizzato lo stato interno del componente che è memorizzato nello store")],-1),M9={__name:"156",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[$9,z9,I9,C9,T9,E9,O9]),_:1},16))}},A9=T(M9,[["__file","/@slidev/slides/156.md"]]),P9="/TPSI/4/svelte/assets/svelte_081-496ce84f.gif",K9=o("h1",null,"SvelteKit",-1),L9=o("p",null,"Stores",-1),R9=o("img",{src:P9,class:"mx-auto",width:"600"},null,-1),H9={__name:"157",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[K9,L9,R9]),_:1},16))}},W9=T(H9,[["__file","/@slidev/slides/157.md"]]),N9=o("h1",null,"SvelteKit",-1),D9=o("p",null,"Stores: Esercitazione_15",-1),q9=o("ul",null,[o("li",null,[o("p",null,"Modificare il codice dell’applicazione in modo che nella pagina About venga visualizzato anche il valore del componente DoubleCounter")]),o("li",null,[o("p",null,"Consegnare su github il progetto modificato")])],-1),F9={__name:"158",setup(e){const t={};return $(I),(n,i)=>(g(),z(M,O(E(t)),{default:w(()=>[N9,D9,q9]),_:1},16))}},j9=T(F9,[["__file","/@slidev/slides/158.md"]]),V9=o("h1",null,"SvelteKit",-1),B9=o("p",null,"Conclusioni",-1),U9=o("ul",null,[o("li",null,"In queste lezioni abbiamo introdotto il modernissimo framework SvelteKit che si basa sul linguggio e compilatore Svelte"),o("li",null,"Svelte è uno strumento formidabile per lo sviluppo di applicazioni Web"),o("li",null,"Svelte rende immediate molte operazioni che in vanilla JS sarebbero alcuanto complesse"),o("li",null,"SvelteKit si distingue dagli altri framework per velocità, compattezza e modernità"),o("li",null,"In queste lezioni abbiamo trattato gli aspetti base di Svelte. Ci sono ovviamente altri aspetti più avamnzati che esulano dai nostri scopi")],-1),J9=o("br",null,null,-1),Q9={__name:"159",setup(e){const t={};return $(I),(n,i)=>{const s=xo;return g(),z(M,O(E(t)),{default:w(()=>[V9,B9,U9,J9,j(s,{fg:"yellow",bg:"green"},{default:w(()=>[c(" Svelte e SvelteKit sono strumenti utilissimi e potentissimi e sono la base per lo sviluppo FullStack di moderne applicazioni Web ")]),_:1})]),_:1},16)}}},Y9=T(Q9,[["__file","/@slidev/slides/159.md"]]),Z9=[{path:"1",name:"page-1",component:z$,meta:{theme:"default",background:"https://source.unsplash.com/collection/94734566/1920x1080",class:"text-center",lineNumbers:!1,aspectRatio:"16_/9",routerMode:"hash",as:"2023/2024",version:"1.2.0",title:"Svelte e SvelteKit",slide:{raw:`---
theme: default
...
- I framework consentono di:
  ...
  - evitare al programmatore di riscrivere codice già scritto in precedenza per compiti simili;
  - organizzare e trovare rapidamente i file necessari;
  - concentrarsi sul problema da risolvere, senza dover implementare funzionalità che qualcun altro ha già provveduto a creare.`,frontmatter:{},index:9,start:138,end:151,noteHTML:"",filepath:"/home/antonio/WORK/ITI_Agnelli/Materie/slidev/slides.md",id:9,no:10},__clicksElements:[],__preloaded:!1}},{path:"11",name:"page-11",component:Kz,meta:{slide:{raw:`
# Web Components
...
- Utilizzando specifici algoritmi, il framework decide come aggiornare l'interfaccia utente. 
- Ovviamente questo processo, non è efficiente e veloce
- Per raggiungere questo obiettivo, React introduce un overhead (la libreria), che verrà eseguito nel motore JS del browser per monitorare e aggiornare il DOM in base alle varie interazioni dell'utente.`,frontmatter:{},index:17,start:245,end:256,noteHTML:"",filepath:"/home/antonio/WORK/ITI_Agnelli/Materie/slidev/slides.md",id:17,no:18},__clicksElements:[],__preloaded:!1}},{path:"19",name:"page-19",component:EI,meta:{slide:{raw:`
# SvelteKit
...
<div style="background-color:green;color:yellow;padding: 10px; line-height:25px">
Questo raggruppamento (senza un ordine particolare) permette un modo efficiente di definire una parte dell'interfaccia utente perché non è necessario cercare gli elementi che influiscono sullo stesso elemento in vari file.
</div>`,frontmatter:{},index:25,start:352,end:369,noteHTML:"",filepath:"/home/antonio/WORK/ITI_Agnelli/Materie/slidev/slides.md",id:25,no:26},__clicksElements:[],__preloaded:!1}},{path:"27",name:"page-27",component:EC,meta:{slide:{raw:`
# SvelteKit
...
- Se un altro componente ha un tag h1, lo stile non sarà modificato. 
- Questo è molto utile quando riutilizzi componenti che hai già scritto per altre applicazioni o quando includi librerie Open Source pubblicate da altre persone.`,frontmatter:{},index:29,start:403,end:422,noteHTML:"",filepath:"/home/antonio/WORK/ITI_Agnelli/Materie/slidev/slides.md",id:29,no:30},__clicksElements:[],__preloaded:!1}},{path:"31",name:"page-31",component:vT,meta:{slide:{raw:`
# SvelteKit
...
- Questo è un componente Svelte valido
- Include solo la parte di contenuto
- Non ha nessuno stuile e nessuna logica di controllo`,frontmatter:{},index:30,start:423,end:437,noteHTML:"",filepath:"/home/antonio/WORK/ITI_Agnelli/Materie/slidev/slides.md",id:30,no:31},__clicksElements:[],__preloaded:!1}},{path:"32",name:"page-32",component:wT,meta:{slide:{raw:`
# SvelteKit
...
- Questo è un componente Svelte valido
- Include la parte di contenuto e di stile`,frontmatter:{},index:31,start:438,end:462,noteHTML:"",filepath:"/home/antonio/WORK/ITI_Agnelli/Materie/slidev/slides.md",id:31,no:32},__clicksElements:[],__preloaded:!1}},{path:"33",name:"page-33",component:ET,meta:{slide:{raw:`
# SvelteKit
...
Esempio: 
- un componente che fornisce accesso ad un DB nosql non ha nessuna parte di UI, ma è di grande utilità all'interno della mia applicazione.`,frontmatter:{},index:32,start:463,end:481,noteHTML:"",filepath:"/home/antonio/WORK/ITI_Agnelli/Materie/slidev/slides.md",id:32,no:33},__clicksElements:[],__preloaded:!1}},{path:"34",name:"page-34",component:LT,meta:{slide:{raw:`
# SvelteKit
...
***Questi link sono il riferimento per gli studenti e vi suggerisco di studiarli e di utilizzarli per tutto il tempo necessario ad apprendere Svlete e SvelteKit***`,frontmatter:{},index:33,start:482,end:500,noteHTML:"",filepath:"/home/antonio/WORK/ITI_Agnelli/Materie/slidev/slides.md",id:33,no:34},__clicksElements:[],__preloaded:!1}},{path:"35",name:"page-35",component:qT,meta:{slide:{raw:`
# SvelteKit
...
> git --version          
git version 2.34.1
\`\`\``,frontmatter:{},index:34,start:501,end:523,noteHTML:"",filepath:"/home/antonio/WORK/ITI_Agnelli/Materie/slidev/slides.md",id:34,no:35},__clicksElements:[],__preloaded:!1}},{path:"36",name:"page-36",component:JT,meta:{slide:{raw:`
# SvelteKit
...
│  ● No
└
\`\`\``,frontmatter:{},index:35,start:524,end:551,noteHTML:"",filepath:"/home/antonio/WORK/ITI_Agnelli/Materie/slidev/slides.md",id:35,no:36},__clicksElements:[],__preloaded:!1}},{path:"37",name:"page-37",component:XT,meta:{slide:{raw:`
# SvelteKit
...
To close the dev server, hit Ctrl-C
\`\`\``,frontmatter:{},index:36,start:552,end:579,noteHTML:"",filepath:"/home/antonio/WORK/ITI_Agnelli/Materie/slidev/slides.md",id:36,no:37},__clicksElements:[],__preloaded:!1}},{path:"38",name:"page-38",component:rE,meta:{slide:{raw:`
# SvelteKit
...
<img src="/media/svelte_0000.png" class="mx-auto" width="100" />`,frontmatter:{},index:37,start:580,end:605,noteHTML:"",filepath:"/home/antonio/WORK/ITI_Agnelli/Materie/slidev/slides.md",id:37,no:38},__clicksElements:[],__preloaded:!1}},{path:"39",name:"page-39",component:hE,meta:{slide:{raw:`
# SvelteKit
...
- Viene automaticamente aperta una fienstra del browser che punta al seguente indirizzo: [http://localhost:5173/](http://localhost:5173/)`,frontmatter:{},index:38,start:606,end:631,noteHTML:"",filepath:"/home/antonio/WORK/ITI_Agnelli/Materie/slidev/slides.md",id:38,no:39},__clicksElements:[],__preloaded:!1}},{path:"40",name:"page-40",component:SE,meta:{slide:{raw:`
# SvelteKit
...
<img src="/media/svelte_010.png" class="mx-auto" width="450" />`,frontmatter:{},index:40,start:640,end:647,noteHTML:"",filepath:"/home/antonio/WORK/ITI_Agnelli/Materie/slidev/slides.md",id:40,no:41},__clicksElements:[],__preloaded:!1}},{path:"42",name:"page-42",component:ME,meta:{slide:{raw:`
# SvelteKit
...
- Quest'applicazione ci permette di comprendere alcuni concetti molto importanti:
  ...
  3. **Ogni pagina è una directory all'interno di src/routes**
  4. **La home page è un componente Svelte all'interno di src/routes**
  5. **Una pagina(componente) può includere uno o più componenti esterni**`,frontmatter:{},index:41,start:648,end:660,noteHTML:"",filepath:"/home/antonio/WORK/ITI_Agnelli/Materie/slidev/slides.md",id:41,no:42},__clicksElements:[],__preloaded:!1}},{path:"43",name:"page-43",component:HE,meta:{slide:{raw:`
# SvelteKit
...
- **Segue ora un'analisi live a cura del professore (\`necessario prendere appunti\`)**`,frontmatter:{},index:43,start:687,end:701,noteHTML:"",filepath:"/home/antonio/WORK/ITI_Agnelli/Materie/slidev/slides.md",id:43,no:44},__clicksElements:[],__preloaded:!1}},{path:"45",name:"page-45",component:JE,meta:{slide:{raw:`
# SvelteKit
...
- Eseguire l'applicazione
- Consegnare su github il progetto appena creato
- IMPORTANTE: non fare il push della directory ***node_modules***`,frontmatter:{},index:44,start:702,end:713,noteHTML:"",filepath:"/home/antonio/WORK/ITI_Agnelli/Materie/slidev/slides.md",id:44,no:45},__clicksElements:[],__preloaded:!1}},{path:"46",name:"page-46",component:nO,meta:{slide:{raw:`
# SvelteKit
...
- Consegnare su github il progetto modificato`,frontmatter:{},index:45,start:714,end:726,noteHTML:"",filepath:"/home/antonio/WORK/ITI_Agnelli/Materie/slidev/slides.md",id:45,no:46},__clicksElements:[],__preloaded:!1}},{path:"47",name:"page-47",component:uO,meta:{slide:{raw:`
# SvelteKit
...
- Consegnare su github il progetto modificato`,frontmatter:{},index:46,start:727,end:740,noteHTML:"",filepath:"/home/antonio/WORK/ITI_Agnelli/Materie/slidev/slides.md",id:46,no:47},__clicksElements:[],__preloaded:!1}},{path:"48",name:"page-48",component:gO,meta:{slide:{raw:`
# SvelteKit
...
- Consegnare su github il progetto modificato`,frontmatter:{},index:47,start:741,end:753,noteHTML:"",filepath:"/home/antonio/WORK/ITI_Agnelli/Materie/slidev/slides.md",id:47,no:48},__clicksElements:[],__preloaded:!1}},{path:"49",name:"page-49",component:IO,meta:{slide:{raw:`
# SvelteKit
...
- Consegnare su github il progetto modificato`,frontmatter:{},index:48,start:754,end:767,noteHTML:"",filepath:"/home/antonio/WORK/ITI_Agnelli/Materie/slidev/slides.md",id:48,no:49},__clicksElements:[],__preloaded:!1}},{path:"50",name:"page-50",component:AO,meta:{slide:{raw:`
# SvelteKit
...
<img src="/media/svelte_015.png" class="mx-auto" width="450" />`,frontmatter:{},index:49,start:768,end:779,noteHTML:"",filepath:"/home/antonio/WORK/ITI_Agnelli/Materie/slidev/slides.md",id:49,no:50},__clicksElements:[],__preloaded:!1}},{path:"51",name:"page-51",component:NO,meta:{slide:{raw:`
# SvelteKit
...
- Ora editiamo il file banner.svelte ed utilizziamo il codice di slide #28`,frontmatter:{},index:50,start:780,end:805,noteHTML:"",filepath:"/home/antonio/WORK/ITI_Agnelli/Materie/slidev/slides.md",id:50,no:51},__clicksElements:[],__preloaded:!1}},{path:"52",name:"page-52",component:UO,meta:{slide:{raw:`
# SvelteKit
...
- Ora abbiamo a disposizione un nuovo tag HTML che si chiama **&lt;Banner&gt;**
- Questo è un componente Web e possiamo usarlo come qualsiasi altro tag html
- Come anticipato il paradigma dei web component offre infinite possibilità`,frontmatter:{},index:51,start:806,end:827,noteHTML:"",filepath:"/home/antonio/WORK/ITI_Agnelli/Materie/slidev/slides.md",id:51,no:52},__clicksElements:[],__preloaded:!1}},{path:"53",name:"page-53",component:XO,meta:{slide:{raw:`
# SvelteKit
...
\`\`\``,frontmatter:{},index:52,start:828,end:856,noteHTML:"",filepath:"/home/antonio/WORK/ITI_Agnelli/Materie/slidev/slides.md",id:52,no:53},__clicksElements:[],__preloaded:!1}},{path:"54",name:"page-54",component:a4,meta:{slide:{raw:`
# SvelteKit
...
<br>
<img src="/media/svelte_015.png" class="mx-auto" width="500" />`,frontmatter:{},index:53,start:857,end:867,noteHTML:"",filepath:"/home/antonio/WORK/ITI_Agnelli/Materie/slidev/slides.md",id:53,no:54},__clicksElements:[],__preloaded:!1}},{path:"55",name:"page-55",component:h4,meta:{slide:{raw:`
# SvelteKit
...
- Consegnare su github il progetto modificato`,frontmatter:{},index:54,start:868,end:881,noteHTML:"",filepath:"/home/antonio/WORK/ITI_Agnelli/Materie/slidev/slides.md",id:54,no:55},__clicksElements:[],__preloaded:!1}},{path:"56",name:"page-56",component:y4,meta:{slide:{raw:`
# SvelteKit
...
- Pertanto quando il componente sarà compilato ogni occorrenza di \`{< var name>}\` sarà sostituito con il valore attribuito alla variabile *var name*`,frontmatter:{},index:56,start:896,end:922,noteHTML:"",filepath:"/home/antonio/WORK/ITI_Agnelli/Materie/slidev/slides.md",id:56,no:57},__clicksElements:[],__preloaded:!1}},{path:"58",name:"page-58",component:H4,meta:{slide:{raw:`
# SvelteKit
...
- Consegnare su github il progetto modificato`,frontmatter:{},index:57,start:923,end:937,noteHTML:"",filepath:"/home/antonio/WORK/ITI_Agnelli/Materie/slidev/slides.md",id:57,no:58},__clicksElements:[],__preloaded:!1}},{path:"59",name:"page-59",component:V4,meta:{slide:{raw:`
# SvelteKit
...
- Quando questo codice viene compilato, viene prima richiamato il metodo *toUpperCase* sulla variabile(oggetto) name
- Successivamente il risultato di questa esecuzione viene sostitutito *verbatim* nel codice HTML`,frontmatter:{},index:58,start:938,end:959,noteHTML:"",filepath:"/home/antonio/WORK/ITI_Agnelli/Materie/slidev/slides.md",id:58,no:59},__clicksElements:[],__preloaded:!1}},{path:"60",name:"page-60",component:Z4,meta:{slide:{raw:`
# SvelteKit
...
<img src="/media/svelte_018.png" class="mx-auto" width="500" />`,frontmatter:{},index:59,start:960,end:968,noteHTML:"",filepath:"/home/antonio/WORK/ITI_Agnelli/Materie/slidev/slides.md",id:59,no:60},__clicksElements:[],__preloaded:!1}},{path:"61",name:"page-61",component:oM,meta:{slide:{raw:`
# SvelteKit
...
<h1>My name is {reverse_string(name)}!</h1>
\`\`\``,frontmatter:{},index:60,start:969,end:991,noteHTML:"",filepath:"/home/antonio/WORK/ITI_Agnelli/Materie/slidev/slides.md",id:60,no:61},__clicksElements:[],__preloaded:!1}},{path:"62",name:"page-62",component:dM,meta:{slide:{raw:`
# SvelteKit
...
<br>
<img src="/media/svelte_019.png" class="mx-auto" width="400" />`,frontmatter:{},index:61,start:992,end:1004,noteHTML:"",filepath:"/home/antonio/WORK/ITI_Agnelli/Materie/slidev/slides.md",id:61,no:62},__clicksElements:[],__preloaded:!1}},{path:"63",name:"page-63",component:hM,meta:{slide:{raw:`
# SvelteKit
...
- Ora vediamo come creare un progetto Svelte da zero, senza scaffolding
- Questo ci permetterà di comprendere altri meccanismi e come è realmente organizzata un'applicazione sveltekit`,frontmatter:{},index:62,start:1005,end:1017,noteHTML:"",filepath:"/home/antonio/WORK/ITI_Agnelli/Materie/slidev/slides.md",id:62,no:63},__clicksElements:[],__preloaded:!1}},{path:"64",name:"page-64",component:SM,meta:{slide:{raw:`
# SvelteKit
...
│
└  Your project is ready!
\`\`\``,frontmatter:{},index:63,start:1018,end:1046,noteHTML:"",filepath:"/home/antonio/WORK/ITI_Agnelli/Materie/slidev/slides.md",id:63,no:64},__clicksElements:[],__preloaded:!1}},{path:"65",name:"page-65",component:TM,meta:{slide:{raw:`
# SvelteKit
...
- Creeremo uno scheletro di una semplice Web App senza spendere troppo tempo sull'aspetto estetico (HTML e CSS sono dati per scontato in questa lezione)
- L'obiettivo è comprendere il funzionamento e l'organizzazione di un'app sveltekit`,frontmatter:{},index:64,start:1047,end:1060,noteHTML:"",filepath:"/home/antonio/WORK/ITI_Agnelli/Materie/slidev/slides.md",id:64,no:65},__clicksElements:[],__preloaded:!1}},{path:"66",name:"page-66",component:LM,meta:{slide:{raw:`
# SvelteKit
...
- Inseriamo il codice HTML e CSS`,frontmatter:{},index:65,start:1061,end:1083,noteHTML:"",filepath:"/home/antonio/WORK/ITI_Agnelli/Materie/slidev/slides.md",id:65,no:66},__clicksElements:[],__preloaded:!1}},{path:"67",name:"page-67",component:qM,meta:{slide:{raw:`
# SvelteKit
...
<img src="/media/svelte_021.png" class="mx-auto" width="400" />`,frontmatter:{},index:66,start:1084,end:1091,noteHTML:"",filepath:"/home/antonio/WORK/ITI_Agnelli/Materie/slidev/slides.md",id:66,no:67},__clicksElements:[],__preloaded:!1}},{path:"68",name:"page-68",component:YM,meta:{slide:{raw:`
# SvelteKit
...
<img src="/media/svelte_028.png" class="mx-auto" width="650" />`,frontmatter:{},index:78,start:1259,end:1267,noteHTML:"",filepath:"/home/antonio/WORK/ITI_Agnelli/Materie/slidev/slides.md",id:78,no:79},__clicksElements:[],__preloaded:!1}},{path:"80",name:"page-80",component:EA,meta:{slide:{raw:`
# SvelteKit
...
<Banner bg="green" fg="yellow">
Siccome non abbiamo modificato il chiamante, vengono utilizzati i valori di default per le props del componente
</Banner>`,frontmatter:{},index:85,start:1369,end:1381,noteHTML:"",filepath:"/home/antonio/WORK/ITI_Agnelli/Materie/slidev/slides.md",id:85,no:86},__clicksElements:[],__preloaded:!1}},{path:"87",name:"page-87",component:P5,meta:{slide:{raw:`
# SvelteKit
...
- Uno scenario classico è fare il binding della props di un input text ad una variabile del componente chiamante
- In questo modo sarà facilissimo ed immediato accedere al valore dell'input text (pensate quanto è macchinoso in vanilla JS)`,frontmatter:{},index:96,start:1515,end:1534,noteHTML:"",filepath:"/home/antonio/WORK/ITI_Agnelli/Materie/slidev/slides.md",id:96,no:97},__clicksElements:[],__preloaded:!1}},{path:"98",name:"page-98",component:lP,meta:{slide:{raw:`
# SvelteKit
...
- Consegnare su github il progetto modificato`,frontmatter:{},index:97,start:1535,end:1550,noteHTML:"",filepath:"/home/antonio/WORK/ITI_Agnelli/Materie/slidev/slides.md",id:97,no:98},__clicksElements:[],__preloaded:!1}},{path:"99",name:"page-99",component:hP,meta:{slide:{raw:`
# SvelteKit
...
<br>
<img src="/media/svelte_044.png" class="mx-auto" width="400" />`,frontmatter:{},index:98,start:1551,end:1561,noteHTML:"",filepath:"/home/antonio/WORK/ITI_Agnelli/Materie/slidev/slides.md",id:98,no:99},__clicksElements:[],__preloaded:!1}},{path:"100",name:"page-100",component:wP,meta:{slide:{raw:`
# SvelteKit
...
- Questo succede perchè abbiamo creato il binding tra il contenuto dei input text (undefined) e le variabili nome, cognome e eta
- Compilando i campi la pagina si aggiornerà in modo automatico e dinamico
- Anche in questo caso realizzare la stessa cosa in vanilla JS sarebbe molto più laborioso`,frontmatter:{},index:99,start:1562,end:1574,noteHTML:"",filepath:"/home/antonio/WORK/ITI_Agnelli/Materie/slidev/slides.md",id:99,no:100},__clicksElements:[],__preloaded:!1}},{path:"101",name:"page-101",component:CP,meta:{slide:{raw:`
# SvelteKit
...
<img src="/media/svelte_046.gif" class="mx-auto" width="700" />`,frontmatter:{},index:100,start:1575,end:1582,noteHTML:"",filepath:"/home/antonio/WORK/ITI_Agnelli/Materie/slidev/slides.md",id:100,no:101},__clicksElements:[],__preloaded:!1}},{path:"102",name:"page-102",component:KP,meta:{slide:{raw:`
# SvelteKit
...
<img src="/media/svelte_048.gif" class="mx-auto" width="700" />`,frontmatter:{},index:102,start:1602,end:1609,noteHTML:"",filepath:"/home/antonio/WORK/ITI_Agnelli/Materie/slidev/slides.md",id:102,no:103},__clicksElements:[],__preloaded:!1}},{path:"104",name:"page-104",component:YP,meta:{slide:{raw:`
# SvelteKit
...
- Consegnare su github il progetto modificato`,frontmatter:{},index:103,start:1610,end:1624,noteHTML:"",filepath:"/home/antonio/WORK/ITI_Agnelli/Materie/slidev/slides.md",id:103,no:104},__clicksElements:[],__preloaded:!1}},{path:"105",name:"page-105",component:iK,meta:{slide:{raw:`
# SvelteKit
...
<br>
<img src="/media/svelte_050.png" class="mx-auto" width="800" />`,frontmatter:{},index:104,start:1625,end:1636,noteHTML:"",filepath:"/home/antonio/WORK/ITI_Agnelli/Materie/slidev/slides.md",id:104,no:105},__clicksElements:[],__preloaded:!1}},{path:"106",name:"page-106",component:cK,meta:{slide:{raw:`
# Svelte
...
- Svelte risolve brillantemente questo problema permettendo di immagazzinare lo stato del componente direttamente all'interno del componente stesso
- Pertanto un componente Svelte è assimilabile a tutti gli effetti ad un oggetto in base alla definizione OOP
- Un componente svelte implementa il meccanismo del \`encapsulation\``,frontmatter:{},index:105,start:1637,end:1648,noteHTML:"",filepath:"/home/antonio/WORK/ITI_Agnelli/Materie/slidev/slides.md",id:105,no:106},__clicksElements:[],__preloaded:!1}},{path:"107",name:"page-107",component:hK,meta:{slide:{raw:`
# Svelte
...
<script>
	let counter = 0; // stato di un contatore
<\/script>
\`\`\``,frontmatter:{},index:106,start:1649,end:1667,noteHTML:"",filepath:"/home/antonio/WORK/ITI_Agnelli/Materie/slidev/slides.md",id:106,no:107},__clicksElements:[],__preloaded:!1}},{path:"108",name:"page-108",component:xK,meta:{slide:{raw:`
# Svelte
...
<br>
<img src="/media/svelte_051.png" class="mx-auto" width="500" />`,frontmatter:{},index:108,start:1692,end:1704,noteHTML:"",filepath:"/home/antonio/WORK/ITI_Agnelli/Materie/slidev/slides.md",id:108,no:109},__clicksElements:[],__preloaded:!1}},{path:"110",name:"page-110",component:RK,meta:{slide:{raw:`
# SvelteKit
...
<img src="/media/svelte_054.png" class="mx-auto" width="600" />`,frontmatter:{},index:109,start:1705,end:1713,noteHTML:"",filepath:"/home/antonio/WORK/ITI_Agnelli/Materie/slidev/slides.md",id:109,no:110},__clicksElements:[],__preloaded:!1}},{path:"111",name:"page-111",component:VK,meta:{slide:{raw:`
# SvelteKit
...
- Utilizziamo icone e font di google (sono molto utili)
- Da notare l'uso della sezione \`<svelte:head>\``,frontmatter:{},index:110,start:1714,end:1726,noteHTML:"",filepath:"/home/antonio/WORK/ITI_Agnelli/Materie/slidev/slides.md",id:110,no:111},__clicksElements:[],__preloaded:!1}},{path:"112",name:"page-112",component:GK,meta:{slide:{raw:`
# SvelteKit
...
<br>
<img src="/media/svelte_058.png" class="mx-auto" width="350" />`,frontmatter:{},index:115,start:1771,end:1784,noteHTML:"",filepath:"/home/antonio/WORK/ITI_Agnelli/Materie/slidev/slides.md",id:115,no:116},__clicksElements:[],__preloaded:!1}},{path:"117",name:"page-117",component:PL,meta:{slide:{raw:`
# SvelteKit
...
<img src="/media/svelte_071.png" class="mx-auto" width="700" />`,frontmatter:{},index:138,start:2120,end:2128,noteHTML:"",filepath:"/home/antonio/WORK/ITI_Agnelli/Materie/slidev/slides.md",id:138,no:139},__clicksElements:[],__preloaded:!1}},{path:"140",name:"page-140",component:EH,meta:{slide:{raw:`
# SvelteKit
